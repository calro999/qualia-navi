...
const NEW_VALHALLA_FEATURES = [
  // 特集①：【美肌クレンジングオイル＆毛穴黒ずみ溶解】濃いメイクも角栓も乳化して落とす「神クレンジングオイル」5選
  {
    featureId: 'feature-5-cleansing-oil-pore-clearing',
    title: '【2026年最新・楽天最安値】【美肌クレンジングオイル＆毛穴黒ずみ溶解】濃いメイクも角栓も乳化して落とす「神クレンジングオイル」5選',
    category: 'skincare',
    categoryLabel: '🫧 【神クレンジングオイル5選】角栓乳化＆素肌透明感特集',
    introText: '「ウォータープルーフのアイメイクも擦らず一瞬で浮かせたい」「オイル洗顔で毛穴の角栓ポロポロを実感したい」…高級植物オイル、ナノ乳化テクノロジー、美容液成分70%以上配合で楽天市場売上上位を独占する神クレンジングオイル5選を徹底検証！',
    items: [
      { id: 'art-oil-shu-uemura-ultime8', keyword: 'シュウウエムラ アルティム8 クレンジングオイル', label: '8つの植物オイル配合で洗うたびにカシミヤ肌へ導くデパコスクレンジングの最高峰' },
      { id: 'art-oil-fancl-mild-cleansing', keyword: 'ファンケル マイルドクレンジングオイル', label: '熟成ホップエキス配合で頑固な角栓をふやかしてするんと落とす国民的大定番' },
      { id: 'art-oil-attire-skin-clear-cleanse', keyword: 'アテニア スキンクリア クレンズ オイル', label: 'ロックローズオイルが肌のくすみの原因「肌ステイン」を洗い流す大ヒットオイル' },
      { id: 'art-oil-kose-softymo-deep', keyword: 'ソフティモ ディープ クレンジングオイル', label: '角栓クリア成分配合で驚きのプチプラ高コスパを誇るロングセラー' },
      { id: 'art-oil-muji-mild-oil', keyword: '無印良品 マイルドクレンジングオイル', label: 'オリーブオイル・アンズ果汁配合で低刺激かつ確かなクレンジング力を発揮' }
    ]
  },
  // 特集②：【神アイライナー＆落ちないリキッド】涙・皮脂・擦れに強い！極細美ラインを描ける「神アイライナー」5選
  {
    featureId: 'feature-5-eyeliner-waterproof-precision',
    title: '【2026年最新・楽天最安値】【神アイライナー＆落ちないリキッド】涙・皮脂・擦れに強い！極細美ラインを描ける「神アイライナー」5選',
    category: 'makeup',
    categoryLabel: '✨ 【神アイライナー5選】落ちない極細リキッド特集',
    introText: '「夕方になると目尻のラインが滲んでパンダ目になってしまう」「まつ毛の隙間を埋める極細ラインをブレずにスルスル描きたい」…速乾耐久フィルム、0.1mm極細筆、高発色ピグメントで一日中くっきり美ラインを維持する楽天大人気アイライナー5選を徹底解説！',
    items: [
      { id: 'art-liner-love-liner-liquid', keyword: 'ラブライナー リキッド アイライナー', label: 'アルミボトルの適度な重みと職人手揉み筆で手ブレしないリキッドの絶対女王' },
      { id: 'art-liner-uz-eye-opening-liner', keyword: 'UZU アイオープニングライナー', label: '大和匠筆×WP Filmで湿気や皮脂に強く鮮やかな発色が一日中続く' },
      { id: 'art-liner-heroine-make-smooth', keyword: 'ヒロインメイク スムースリキッドアイライナー', label: 'スーパーウォータープルーフで涙・汗・皮脂を鉄壁ガードする耐久ライナー' },
      { id: 'art-liner-canmake-creamy-touch', keyword: 'キャンメイク クリーミータッチライナー', label: 'とろけるような極上描き心地の1.5mm超極細ジェルアイライナー' },
      { id: 'art-liner-dejavu-lasting-fine', keyword: 'デジャヴュ 密着アイライナー', label: '極細クリームペンシルで目頭から目尻まで滑らかにフィット' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による「64大達成・最新5選まとめ特集記事」作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_VALHALLA_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに極上のメイク落ちやブレない美ラインの持続力を実感できる高機能設計`,
...
2. **目元や素肌への優しさと持続性**: デリケートな状態でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'クレンジングオイル＆アイライナーアナリスト',
        summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得による「64大達成・最新5選まとめ特集記事」および個別商品記事の完全追加が完了しました！`);
}
