...
const NEW_PARAGON_FEATURES = [
  // 特集①：【美髪オイル＆集中リペア】パサつき・アホ毛・枝毛をサロン級のツヤ髪へ導く「極上ヘアオイル＆セラム」5選
  {
    featureId: 'feature-5-hair-oil-repair-shine',
    title: '【2026年最新・楽天最安値】【美髪オイル＆集中リペア】パサつき・アホ毛・枝毛をサロン級のツヤ髪へ導く「極上ヘアオイル＆セラム」5選',
    category: 'haircare',
    categoryLabel: '💇‍♀️ 【美髪オイル5選】ツヤ髪集中リペア特集',
    introText: '「ドライヤー前の熱保護や外出前のスタイリングで髪に極上のツヤが欲しい」「うねり・広がり・ダメージ毛をしっとりまとめたい」…植物オイル、ケラチン、シルクプロテイン配合でサロン帰りのシルク髪を作る楽天大人気ヘアオイル5選を徹底検証！',
    items: [
      { id: 'art-oil-moroccanoil-treatment', keyword: 'モロッカンオイル トリートメント', label: 'アルガンオイル高配合で圧倒的なツヤと指通りを与える世界最高峰' },
      { id: 'art-oil-napla-n-polish', keyword: 'N. ポリッシュオイル', label: 'シアバター配合で濡れ髪束感とツヤを一日中キープする美容師愛用率1位' },
      { id: 'art-oil-milbon-elujuda-mo-oil', keyword: 'ミルボン エルジューダ MO', label: '硬い髪や太い髪をやわらかくしなやかに整えるバオバブオイル処方' },
      { id: 'art-oil-orbis-essence-hair-milk', keyword: 'オルビス エッセンスインヘアミルク', label: 'CMC類似成分配合でパサついた髪内部の保水バランスを立て直す神ミルク' },
      { id: 'art-oil-shiseido-fino-hair-oil', keyword: 'フィーノ プレミアムタッチ ヘアオイル', label: 'プチプラでサロン級！濃密Wオイルが傷んだ毛先を集中密着補修' }
    ]
  },
  // 特集②：【ニキビケア＆CICA鎮静】繰り返す大人ニキビ・赤み・肌荒れを速効で落ち着かせる「薬用ニキビケア＆CICA」5選
  {
    featureId: 'feature-5-acne-cica-soothing-care',
    title: '【2026年最新・楽天最安値】【ニキビケア＆CICA鎮静】繰り返す大人ニキビ・赤み・肌荒れを速効で落ち着かせる「薬用ニキビケア＆CICA」5選',
    category: 'skincare',
    categoryLabel: '🌿 【ニキビ＆CICA鎮静5選】薬用肌荒れケア特集',
    introText: '「フェイスラインや口元の繰り返す大人ニキビを治したい」「マスク摩擦や生理前の赤み・肌荒れをすばやく鎮静したい」…サリチル酸、グリチルリチン酸、ツボクサエキス（CICA）配合で健やかな透明素肌を取り戻す楽天売れ筋ニキビケア5選を徹底解説！',
    items: [
      { id: 'art-acne-pair-acne-cream', keyword: 'ペアアクネクリームW', label: 'イブプロフェンピコノール配合で赤ニキビの炎症をしずめる薬用クリーム' },
      { id: 'art-acne-orbis-clearful-lotion', keyword: 'オルビス クリアフル ローション', label: '紫根エキス×ナノVCカプセルが毛穴奥深くのニキビ原因へ浸透' },
      { id: 'art-acne-vt-cica-cream', keyword: 'VT CICA クリーム', label: 'シカヒアルロン配合でベタつかず水分補給しながら赤み肌を穏やかに鎮静' },
      { id: 'art-acne-lion-pair-wash', keyword: 'ペアアクネクリーミーフォーム', label: '殺菌＆消炎成分配合のキメ細かい濃密泡でニキビ肌をやさしく洗浄' },
      { id: 'art-acne-laroche-effaclar-k', keyword: 'ラロッシュポゼ エファクラ', label: 'サリチル酸配合で毛穴の詰まりとざらつきをなめらかに整える角質ケア' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による「32大達成記念・最新5選まとめ特集記事」作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PARAGON_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐにツヤ感や肌の鎮静効果を実感できる高機能設計`,
          `毎日のヘアケアやスキンケア習慣に無理なく組み込める快適な使用感・低刺激処方`,
...
2. **髪や肌への優しさと持続性**: デリケートな状態でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: '美髪オイル＆アクネケアスペシャリスト',
        summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得による「32大達成記念・最新5選まとめ特集記事」および個別商品記事の完全追加が完了しました！`);
}
