...
console.log('🚀 [楽天API 直接取得 Batch4] 超高需要ロングテール5テーマの商品データを取得開始...');
...
const themes = [
  {
    key: 'aegyo_concealer',
    searchKeywords: ['涙袋 コンシーラー ペンシル', '涙袋 スティック アイシャドウ', 'キャンメイク 涙袋 コンシーラー', 'シピシピ 涙袋']
  },
  {
    key: 'lash_perm_mascara',
    searchKeywords: ['まつげパーマ用 マスカラ', 'マツエク マスカラ お湯落ち', 'まつ毛パーマ マスカラ フィルム', 'まつパ コーティング マスカラ']
  },
  {
    key: 'lip_base_primer',
    searchKeywords: ['リップベース リップ下地 口紅下地', 'MAC リップベース プレッププライム', 'リッププライマー 縦ジワ', '口紅 落ちない 下地 リップ']
  },
  {
    key: 'foot_peeling_spray',
    searchKeywords: ['フットピーリングスプレー 足裏 角質', '足裏 角質 スプレー ピーリング', 'かかと 角質 ポロポロ スプレー', '足用 ピーリングミスト 角質除去']
  },
  {
    key: 'makeup_remover_stick',
    searchKeywords: ['クレンジングスティック メイク直し', 'メイク直し ペン リムーバー', 'アイメイク 修正ペン', 'ポイント メイク リムーバー スティック']
  }
];
...
async function main() {
  ...
  fs.writeFileSync('scratch_longtail_batch4_rakuten_items.json', JSON.stringify(results, null, 2), 'utf-8');
  console.log('\n🎉 全商品の取得が完了し、scratch_longtail_batch4_rakuten_items.json に保存しました！');
}
