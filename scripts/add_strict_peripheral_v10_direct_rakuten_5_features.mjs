...
// ① クエリ：まつ毛ホットビューラー 充電式 usb まつパ級, ホットアイラッシュカーラー 下まつげ（自まつ毛を痛めず数秒で根本から立ち上げる最新USB充電式ホットビューラー）
// ② クエリ：アイクリーム レチノール ナイアシンアミド 目の下のたるみ クマ シワ, 目元 美容液 アイクリーム（青クマ・黒クマ・ちりめんジワ・まぶたのたるみを集中リフトする濃厚アイセラム）
const NEW_PERIPHERAL_V10_FEATURES = [
  {
    featureId: 'feature-5-usb-heated-eyelash-curler',
    title: '【2026年最新・楽天最安値】【USB充電式ホットビューラー＆瞬間美立ち上げ】挟むビューラーで抜けるまつ毛を救う！サロン級カールを作る「神ホットビューラー」5選',
    category: 'device',
    categoryLabel: '👁️ 【神ホットビューラー5選】USB充電式＆まつパ級美カール特集',
    introText: '「普通のビューラーだとまつ毛が切れたり抜けたりしてしまう」「直毛・下向きまつ毛でも雨の日まで上向きカールを維持したい」…10秒急速予熱、目元のカーブに沿うシリコン電熱パッド、温度調節機能付きUSB充電式でまぶたを挟まず美カールを固定する楽天売れ筋ホットビューラー5選を徹底検証！',
    items: [
      { id: 'art-hotcurler-anlan-heated-curler', keyword: 'ANLAN ホットビューラー', label: '10秒速熱＆2段階温度調節！凹凸温熱コームで下まつ毛も綺麗にセパレートカール' },
      { id: 'art-hotcurler-panasonic-matsuge-kurun', keyword: 'パナソニック まつげくるん', label: 'ダブルヒーター搭載でまつ毛をしっかりカールアップする国民的ロングセラー' },
      { id: 'art-hotcurler-usb-rechargeable-curler', keyword: 'ホットビューラー 充電式 まつ毛', label: '電池交換不要のType-C急速充電！ポーチに入る軽量コンパクト設計' },
      { id: 'art-hotcurler-silicon-clip-curler', keyword: 'ホットビューラー クリップ式', label: '挟んで温めるWアクション！ビューラーが苦手な人でも一瞬で根元立ち上げ' },
      { id: 'art-hotcurler-eyelash-heat-curler-pro', keyword: 'ホットアイラッシュカーラー プロ仕様', label: 'やけど防止コーム設計で根元ギリギリから安全に立ち上げられる人気ギア' }
    ]
  },
  {
    featureId: 'feature-5-targeted-eye-cream-dark-circles',
    title: '【2026年最新・楽天最安値】【濃厚目元アイクリーム＆くま・ちりめんジワ消去】皮膚が薄い目元の乾燥小ジワ・青クマ・たるみをピンと張る「神アイセラム」5選',
    category: 'skincare',
    categoryLabel: '👁️ 【神濃厚アイクリーム5選】クマ・目元シワ改善＆たるみリフト特集',
    introText: '「夕方になると目の下のちりめんジワにファンデが溜まる」「スマホやPC作業による目元のクマ・くすみがコンシーラーで隠れない」…純粋レチノール、ナイアシンアミド、アイリスエキス、カフェイン配合で血行促進とハリ・弾力再生を同時に叶える楽天大人気目元集中アイクリーム5選を徹底解説！',
    items: [
      { id: 'art-eyecream-elixir-retinol-wrinkle-cream', keyword: 'エリクシール リンクルクリーム', label: '日本で初めてシワ改善効果が認められた純粋レチノール配合の目元シワ改善絶対女王' },
      { id: 'art-eyecream-sk2-skinpower-eye-cream', keyword: 'SK-II スキンパワー アイ クリーム', label: '濃縮ピテラと独自テクノロジーで目元にふっくらとした弾力とツヤを与えるデパコス最高峰' },
      { id: 'art-eyecream-ahc-youth-lasting-real-eye', keyword: 'AHC アイクリーム', label: '韓国オリーブヤング売上1位！顔全体にも使えるマイクロエマルジョン高浸透アイセラム' },
      { id: 'art-eyecream-pola-wrinkle-shot-serum', keyword: 'ポーラ リンクルショット メディカルセラム', label: '有効成分ニールワン配合で真皮のシワ改善を促す世界的評価を獲得した名品' },
      { id: 'art-eyecream-the-ordinary-caffeine-solution', keyword: 'アイクリーム 目元 クマ レチノール', label: '高濃度カフェインとEGCG配合で目元のむくみと頑固な青クマをすっきり引き締める' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第10弾）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V10_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐにまつ毛の上向き美立ち上げや目元のふっくらハリ感を実感できる高機能設計`,
          `毎日の朝メイクや夜のアイケアルーティンに無理なく組み込める快適な使用感・高い満足度`,
...
2. **目元の皮膚への優しさと持続性**: デリケートな部位でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第10弾特集記事および個別商品記事の完全追加が完了しました！`);
}
