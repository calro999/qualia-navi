...
export const INITIAL_BLOG_POSTS: BlogPost[] = [
  {
    ...
    content: `# 【薬用化粧水の最高峰】イプサ ザ・タイムR アクア 徹底検証｜大人ニキビ・インナードライ・テカリへの全効果とプロ直伝の重ね付け術
...
- **公式・認定ショップの利用**: 偽物を避け、確実に正規品を手に入れるために認証マークのあるショップを選びましょう。限定コットン付きセットなども販売されています。`,
  ...
  },
  {
    ...
    content: `# 【デパコス至高のアイシャドウ】SUQQU シグニチャー カラー アイズ 徹底レビュー｜全色パーソナルカラー分析・夕方までヨレない名品パレット
...
**楽天市場の信頼できるコスメショップ**を利用すれば、ポイント高還元（5倍〜10倍）でお得に購入可能です。「お買い物マラソン」などのイベント時にエントリーして購入するのが最安値への近道です。`,
  ...
  },
  {
    ...
    content: `# 【憧れの最高峰下地】クレ・ド・ポー ボーテ ヴォワールコレクチュール n 徹底検証｜塗った瞬間に美肌フィルターをかける伝説プレメイクアップ
