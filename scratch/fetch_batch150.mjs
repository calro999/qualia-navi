...
const queries = {
  t1: '姿勢サポーター 猫背 矯正 ベルト 背筋 巻き肩',
  t2: 'ヘアキャップ アルミ トリートメント 保温 スチーム',
  t3: '表情筋 トレーニング フェイス 口元 ほうれい線',
  t4: 'アイマスク 冷却 ジェル クール 目元 冷やす'
};
...
async function main() {
  ...
  fs.writeFileSync('scratch/batch150_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 150 products saved successfully to scratch/batch150_fetched.json!');
}
