...
// ① クエリ：涙袋ライナー 涙袋ペンシル 影色 涙袋メイク ぷっくり, 涙袋 コンシーラー（誰でも10秒で自然なぷっくり涙袋と影色ラインを描け、中顔面短縮＆デカ目効果を叶える涙袋専用ライナー）
// ② クエリ：リップバーム 保湿 唇 パック リップスリーピングマスク, 夜用 リップクリーム（寝ている間の極度の乾燥・皮剥け・縦ジワを集中的に密封補修し、翌朝ふっくらツヤ唇に蘇らせる高保湿リップバーム＆スリーピングマスク）
const NEW_PERIPHERAL_V38_FEATURES = [
  {
    featureId: 'feature-5-aegyo-sal-under-eye-plump-liner',
    title: '【2026年最新・楽天最安値】【涙袋ライナー＆ぷっくり中顔面短縮】初心者でも失敗ゼロ！自然な影と光を作る「神なみだ袋ペンシル」5選',
    category: 'makeup',
    categoryLabel: '👁️ 【神涙袋ライナー5選】ぷっくり立体感＆中顔面短縮デカ目特集',
    introText: '「涙袋を描くとクマっぽくなって不自然」「ペンシルが硬くて痛い・夕方になると消えてしまう」…なめらか極細クレヨン芯、絶妙な透け感影色グレージュ、ひと塗りでぷっくり立体感を生む微細パールハイライト設計の楽天売れ筋涙袋ライナー5選を徹底検証！',
    items: [
      { id: 'art-aegyosal-wonjungyo-metal-shower-pencil', keyword: 'ウォンジョンヨ メタルシャワーペンシル', label: '涙袋コスメの絶対王者！ひと塗りでアイドルのようなぷっくり涙袋が完成する大ヒット品' },
      { id: 'art-aegyosal-canmake-plump-lip-care-eye', keyword: 'キャンメイク 涙袋 ライナー', label: 'プチプラ界の神アイテム！影色ライナーとハイライトが1本になった高コスパ名品' },
      { id: 'art-aegyosal-bbia-last-auto-gel-liner-shadow', keyword: 'ピアー 涙袋 ライナー', label: 'スルスル描けて高密着！夕方まで絶対に消えないウォータープルーフペンシル' },
      { id: 'art-aegyosal-cezanne-drawing-double-eyelid-liner', keyword: 'セザンヌ 描くふたえアイライナー', label: '極薄ブラウンで自然な影！涙袋の影色ラインに最適な超ロングセラー' },
      { id: 'art-aegyosal-colorgram-all-in-one-aegyo-sal-maker', keyword: 'カラーグラム 涙袋', label: '韓国オリーブヤング1位！陰影とハイライトのデュアル設計で中顔面短縮を叶える' }
    ]
  },
  {
    featureId: 'feature-5-lip-sleeping-mask-intensive-balm',
    title: '【2026年最新・楽天最安値】【夜用リップスリーピングマスク＆濃密バーム】朝起きると縦ジワ消滅！ぷるんと潤う「神リップパック」5選',
    category: 'skincare',
    categoryLabel: '💋 【神リップスリーピングマスク5選】寝ている間に縦ジワ消滅＆集中保湿特集',
    introText: '「普通のリップクリームを塗って寝ても朝にはカサカサ」「唇の皮剥けがひどくて口紅が綺麗に乗らない」…ベリーエキス、シアバター、ヒアルロン酸、高密着モイスチャーラップ技術で睡眠中の唇を濃密密封する楽天売れ筋リップスリーピングバーム5選を徹底解説！',
    items: [
      { id: 'art-lipmask-laneige-lip-sleeping-mask-berry', keyword: 'ラネージュ リップスリーピングマスク', label: '世界中で大バズり！寝ている間に角質を優しく溶かし翌朝ぷるぷる唇にする絶対王者' },
      { id: 'art-lipmask-torriden-solid-in-ceramide-lip-essence', keyword: 'トリデン リップ エッセンス', label: '5重セラミド配合！ベタつかず唇のバリア機能を高める大人気エッセンス' },
      { id: 'art-lipmask-vaseline-lip-therapy-rosy-lips', keyword: 'ヴァセリン リップ モイストシャイン', label: '高い密封力と保湿持続力！カサカサ唇を瞬時にしっとり包み込む王道バーム' },
      { id: 'art-lipmask-curel-intensive-moisture-lip-care-cream', keyword: 'キュレル リップケアバーム', label: 'セラミド機能成分配合！ひび割れや荒れを繰り返すデリケートな唇のための医薬部外品' },
      { id: 'art-lipmask-dior-creme-de-rose-lip-balm', keyword: '夜用 リップバーム 高保湿', label: '体温でとろけて密着！翌朝のリップメイクのノリを劇的に変える集中トリートメント' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第38弾【純粋コスメ＆メイク・スキンケア限定】）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V38_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに自然なぷっくり涙袋の形成やリップスリーピングマスクによる翌朝の縦ジワ消滅・ぷるツヤ唇を実感できる高機能設計`,
          `毎日のアイメイクや就寝前のナイトリップケアに無理なく組み込める快適な使用感・高い満足度`,
...
2. **目元や唇への優しさと持続性**: デリケートな部位でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: '涙袋メイク＆ナイトリップケアアナリスト',
        summaryKeyPoints: [
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアアイメイク＆リップケアアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第38弾【純粋コスメ＆メイク・スキンケア限定】特集記事および個別商品記事の完全追加が完了しました！`);
}
