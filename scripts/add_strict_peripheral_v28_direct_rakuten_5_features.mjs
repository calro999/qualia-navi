...
// ① クエリ：アイプチ 二重 癖付け 夜用 夜用アイプチ, 二重のり ナイトアイボーテ（寝ている間にまぶたを固定し、本物の二重ラインを形状記憶して日中アイプチなしでパッチリ二重を作る夜用ふたえ美容液）
// ② クエリ：シルク 手袋 ナイト手袋 就寝用 ハンドケア 絹, 保湿 手袋 スマホ対応（ハンドクリームを塗った上から着用して寝るだけで、手の甲のシワ・カサつき・あかぎれを寝ている間に集中保湿パックするシルク100%おやすみ手袋）
const NEW_PERIPHERAL_V28_FEATURES = [
  {
    featureId: 'feature-5-night-double-eyelid-serum',
    title: '【2026年最新・楽天最安値】【夜用二重癖付け液＆寝ている間にふたえ育成】まぶたを伸ばさず自然な二重幅を定着させる「神ナイトアイプチ」5選',
    category: 'makeup',
    categoryLabel: '👁️ 【神夜用二重液5選】寝ている間に二重癖付け＆まぶたケア特集',
    introText: '「日中アイプチをするとメイクが崩れる・テープがバレる」「まぶたのたるみを防ぎながら自然な二重を手に入れたい」…高粘着アクリルポリマー、ヒアルロン酸、コラーゲン、植物性引き締めエキス配合で睡眠中にまぶたを固定し本物の二重ラインを形状記憶する楽天売れ筋夜用アイプチ5選を徹底検証！',
    items: [
      { id: 'art-nighteye-night-eye-beaute-ii', keyword: 'ナイトアイボーテ', label: '夜用二重液の絶対的代名詞！寝ている間にまぶたを固定して自然な二重を定着させる大人気コスメ' },
      { id: 'art-nighteye-mezaik-double-eyelid-glue', keyword: 'アイプチ 夜用 癖付け', label: '美容液成分贅沢配合！まぶたをいたわりながら強力キープする夜用ふたえグルー' },
      { id: 'art-nighteye-futaye-night-pack-essence', keyword: '二重 夜 癖付け 美容液', label: '塗って寝るだけの簡単パック！引き締め成分で重たいまぶたをスッキリ二重へ' },
      { id: 'art-nighteye-d-up-orishiki-eyelid-skin', keyword: '二重のり 癖付け 強力', label: '非接着皮膜タイプでまぶたに優しい！自然な折り込みふたえを作る名品' },
      { id: 'art-nighteye-led-night-eyelid-tape-pro', keyword: 'アイテープ 夜用 医療用テープ', label: '肌に優しい医療用粘着剤！寝返りを打っても剥がれない強力二重テープ' }
    ]
  },
  {
    featureId: 'feature-5-silk-night-gloves-hand-care',
    title: '【2026年最新・楽天最安値】【最高級シルク100%おやすみ手袋＆寝ている間ハンドエステ】朝起きるとふっくら白肌に蘇る「神保湿ナイトグローブ」5選',
    category: 'bodycare',
    categoryLabel: '🧤 【神シルクナイト手袋5選】就寝中ハンドケア＆手の乾燥シワ改善特集',
    introText: '「手荒れや手指のシワが目立って老けて見える」「ハンドクリームを塗って寝ても布団に付いてしまう」…天然生糸100%、スマホ対応指先スリット、蒸れずに呼吸する高通気編み設計でハンドクリームの密着保湿パック効果を最大化する楽天大人気シルクナイト手袋5選を徹底解説！',
    items: [
      { id: 'art-silkglove-sowan-silk-night-gloves', keyword: 'SOWAN シルク 手袋', label: '楽天1位独占！無縫製でチクチクせず手荒れを寝ている間に集中ケアする大ヒット手袋' },
      { id: 'art-silkglove-touchscreen-silk-moist-gloves', keyword: 'シルク 手袋 スマホ対応 就寝用', label: '着用したままスマホ操作OK！乾燥する指先を潤すスリット入り便利グローブ' },
      { id: 'art-silkglove-pure-silk-rib-hand-care', keyword: 'シルク100% 手袋 おやすみ用', label: '最高級シルク生糸100%！敏感肌でも安心のアミノ酸保湿で手のシワを予防' },
      { id: 'art-silkglove-long-wrist-silk-hand-cover', keyword: 'シルク 手袋 ロング ハンドケア', label: '手首までしっかりカバー！冷えやすい手首を温めながら手の甲を集中保湿' },
      { id: 'art-silkglove-organic-silk-night-treatment', keyword: '就寝用 手袋 シルク 保湿', label: 'ハンドクリームとの相乗効果抜群！翌朝の手のふっくら感が劇的に変わる' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第28弾）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V28_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに睡眠中の二重ライン癖付けやシルク手袋による翌朝の手のふっくら白肌を実感できる高機能設計`,
          `毎晩のナイトケアルーティンに無理なく組み込める快適な使用感・高い満足度`,
...
2. **まぶたや手肌への優しさと持続性**: デリケートな部位でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'ナイトふたえ＆ハンドスリープアナリスト',
        summaryKeyPoints: [
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアナイトケア＆ハンドケアアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第28弾特集記事および個別商品記事の完全追加が完了しました！`);
}
