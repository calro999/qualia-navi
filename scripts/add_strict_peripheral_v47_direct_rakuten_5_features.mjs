...
// ① クエリ：チークブラシ ふんわり ぼかし 熊野筆 チーク フェイスブラシ, 斜めチークブラシ（頬の毛穴落ちやムラづき・おてもやん化を防ぎ、高級極細毛でふんわり自然な血色グラデーションを作る専用チークブラシ）
// ② クエリ：リップブラシ 携帯用 繰り出し式 紅筆 リップライン 輪郭, 平筆 リップブラシ（口紅の直塗りでは難しい口角や唇の輪郭・山を正確に縁取り、ポーチに入れて清潔に持ち運べるキャップ付き繰り出し式リップブラシ）
const NEW_PERIPHERAL_V47_FEATURES = [
  {
    featureId: 'feature-5-blush-brush-natural-fluffy-glow',
    title: '【2026年最新・楽天最安値】【チークブラシ＆ふんわり血色グラデ】おてもやん化を防ぎ自然な透明感ツヤ頬を作る「神チーク筆」5選',
    category: 'makeup',
    categoryLabel: '🌸 【神チークブラシ5選】失敗ゼロ！ふんわり血色＆透明感ツヤ特集',
    introText: '「付属の小さいブラシだと色が濃くついておてもやんになる」「パウダーチークの境目がぼかせず不自然」…斜めアングルカット、超極細テーパード毛、空気を含ませるエアリー設計でひとはけで内側から上気したような美肌を叶える楽天売れ筋チークブラシ5選を徹底検証！',
    items: [
      { id: 'art-blushbr-sixplus-angled-blush-contour-brush', keyword: 'SIXPLUS チークブラシ', label: 'メイクブラシの王道！斜めカットで頬骨に沿って自然な血色と立体感を演出' },
      { id: 'art-blushbr-rosyrosa-powder-blush-brush', keyword: 'ロージーローザ チークブラシ', label: 'プチプラ界の神ツール！とろけるような肌触りで粉含み抜群のパウダーブラシ' },
      { id: 'art-blushbr-kumano-fude-round-cheek-brush', keyword: '熊野筆 チークブラシ', label: '伝統工芸の最高峰！職人手作りの丸平毛先で摩擦レス＆極上のふんわり発色' },
      { id: 'art-blushbr-fillimilli-point-blusher-brush', keyword: 'フィリミリ チークブラシ', label: '韓国オリーブヤング大ヒット！狙った位置にピンポイントで血色をのせる' },
      { id: 'art-blushbr-etude-fluffy-cheek-blender', keyword: 'チークブラシ 斜め', label: '初心者でも失敗しない！ぼかしやすさを追求した高密度ふんわりブラシ' }
    ]
  },
  {
    featureId: 'feature-5-retractable-lip-brush-portable-pocket',
    title: '【2026年最新・楽天最安値】【携帯用繰り出し式リップブラシ＆美唇輪郭】口角のキュッと上がった立体リップを作る「神ポータブル紅筆」5選',
    category: 'makeup',
    categoryLabel: '💄 【神リップブラシ5選】携帯用繰り出し式＆美しい唇輪郭特集',
    introText: '「口紅を直塗りすると口角がぼやけて清潔感が出ない」「外出先でリップラインを綺麗にお直ししたい」…キャップ連動ワンタッチ繰り出し機構、コシのある平筆・山型カット、ポーチを汚さないアルミボディ設計でプロ級のリップラインを描ける楽天売れ筋リップブラシ5選を徹底解説！',
    items: [
      { id: 'art-lipbrush-shiseido-retractable-lip-brush-407', keyword: '資生堂 リップブラシ 407', label: 'リップブラシの絶対的定番！適度なコシと丸みのある平筆で輪郭を完璧に描く' },
      { id: 'art-lipbrush-kumano-fude-portable-flat-lip-brush', keyword: '熊野筆 リップブラシ 携帯用', label: '伝統工芸の上質コリンスキー毛！口紅の含みが良くムラなく塗れる一生モノ' },
      { id: 'art-lipbrush-rosyrosa-auto-lip-brush-silver', keyword: 'ロージーローザ リップブラシ', label: 'プチプラ高機能！キャップを外すと自動で毛先が出る便利な繰り出し式' },
      { id: 'art-lipbrush-sixplus-portable-precision-lip-pen', keyword: 'リップブラシ 繰り出し式', label: '極細ラインも面塗りも自由自在！ポーチに入れてもかさばらないスリム設計' },
      { id: 'art-lipbrush-du-care-automatic-metal-lip-liner-brush', keyword: 'リップブラシ 携帯用', label: '口紅の持ちを格段に高める！高密度毛で唇の縦ジワの隙間まで均一塗布' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第47弾【純粋コスメ＆メイクツール特化】）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V47_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐにチークのふんわり自然な血色感や繰り出し式リップブラシによる口角のキュッと上がった立体リップラインを実感できる高機能設計`,
          `毎朝のメイクアップやお出かけ先のお直しルーティンに無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'チーク＆リップメイクツールアナリスト',
        summaryKeyPoints: [
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアメイクブラシ＆ツールアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第47弾【純粋コスメ＆メイクツール特化】特集記事および個別商品記事の完全追加が完了しました！`);
}
