...
async function main() {
  ...
  fs.writeFileSync('scratch/batch156_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 156 products saved successfully to scratch/batch156_fetched.json!');
}
