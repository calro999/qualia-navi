...
async function main() {
  ...
  fs.writeFileSync('scratch/batch163_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 163 products saved successfully to scratch/batch163_fetched.json!');
}
