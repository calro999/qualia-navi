...
// ① クエリ：角栓 スポット ポア クレンジングブラシ 小鼻専用, 小鼻 毛穴ブラシ 洗顔 極細毛（指では届かない小鼻の窪み・黒ずみ角栓を極細毛でかき出す小鼻専用洗顔ブラシ）
// ② クエリ：入浴剤 エプソムソルト マグネシウム 発汗 むくみ解消, 国産 エプソムソルト 無香料 浴用化粧料（高純度硫酸マグネシウムで芯から温め全身の巡りとむくみをスッキリ流すエプソムソルト）
const NEW_PERIPHERAL_V16_FEATURES = [
  {
    featureId: 'feature-5-nose-pore-cleansing-brush',
    title: '【2026年最新・楽天最安値】【小鼻専用毛穴クレンジングブラシ＆角栓かき出し】指が届かない窪みの黒ずみをミクロ極細毛で一掃する「神ポアブラシ」5選',
    category: 'device',
    categoryLabel: '👃 【神小鼻毛穴ブラシ5選】角栓かき出し＆小鼻黒ずみオフ特集',
    introText: '「クレンジングしても小鼻のキワに白い角栓や黒ずみが残る」「いちご鼻を擦らずにツルツルにしたい」…約0.05mmの超極細シルク毛、高密度植毛、小回りが利くドーム形状で毛穴の奥の皮脂汚れを優しくかき出す楽天売れ筋小鼻専用ブラシ5選を徹底検証！',
    items: [
      { id: 'art-porebrush-kumano-fude-nose-brush', keyword: '熊野筆 小鼻洗顔ブラシ', label: '伝統工芸の極み！極細毛先が毛穴の凹凸にフィットして角栓を優しくオフする最高峰ブラシ' },
      { id: 'art-porebrush-kai-micro-pore-brush', keyword: '小鼻 毛穴ブラシ 洗顔', label: '小回りが利くペン型設計！小鼻のキワやあごのザラつきをピンポイント洗浄' },
      { id: 'art-porebrush-silicone-pore-cleanser', keyword: 'シリコン 小鼻 ブラシ 毛穴', label: '衛生的なシリコン製！表裏の異なる突起で黒ずみ角栓をマッサージしながらオフ' },
      { id: 'art-porebrush-tsururi-nose-pore-brush', keyword: 'ツルリ 小鼻みがきブラシ', label: '小鼻専用の極細毛！洗顔料をしっかり泡立てて毛穴汚れを絡め取る人気品' },
      { id: 'art-porebrush-duo-pore-cleansing-brush', keyword: '毛穴 ブラシ 角栓 極細毛', label: '超極細毛が肌に負担をかけずツルツルの陶器肌へ洗い上げるプロ仕様' }
    ]
  },
  {
    featureId: 'feature-5-epsom-salt-magnesium-bath',
    title: '【2026年最新・楽天最安値】【高純度エプソムソルト＆発汗・むくみデトックス】硫酸マグネシウムの温浴効果で全身スッキリ整う「神バスソルト」5選',
    category: 'bodycare',
    categoryLabel: '🛁 【神高純度エプソムソルト5選】発汗・むくみ解消＆温活バス特集',
    introText: '「冷え性で手足が冷たくて夜眠れない」「夕方になると脚がパンパンにむくむ」…食品添加物基準の高純度硫酸マグネシウム100%、無香料・無着色、肌を滑らかにする浴用化粧品処方でお風呂上がりもポカポカが続く楽天大人気エプソムソルト5選を徹底解説！',
    items: [
      { id: 'art-epsom-seacrystals-epsom-salt-orig', keyword: 'シークリスタルス エプソムソルト', label: '楽天ランキング1位常連！食品添加物グレードの国産硫酸マグネシウム高純度バスソルト' },
      { id: 'art-epsom-amami-epsom-salt-pure', keyword: 'エプソムソルト 国産 10kg', label: '大容量で毎日惜しみなく使える！芯から発汗を促すコスパ最強エプソムソルト' },
      { id: 'art-epsom-neals-yard-magnesium-bath', keyword: 'エプソムソルト アロマ マグネシウム', label: '天然精油配合で極上のリラックス！心と体の疲れを解きほぐすアロマブレンド' },
      { id: 'art-epsom-drteals-epsom-salt-lavender', keyword: 'ティールズ エプソムソルト', label: '全米No.1バスケアブランド！ラベンダーの香りで深い眠りを誘うリラックスソルト' },
      { id: 'art-epsom-clay-bath-salt-detox', keyword: '入浴剤 エプソムソルト 発汗 むくみ', label: 'クレイとエプソムソルトのW配合！毛穴の汚れを吸着しながら発汗温活' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第16弾）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V16_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに小鼻のザラつき解消や入浴後のポカポカ発汗・むくみスッキリを実感できる高機能設計`,
          `毎日の洗顔ルーティンやバスタイム習慣に無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアポア＆バスセラピーアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第16弾特集記事および個別商品記事の完全追加が完了しました！`);
}
