...
const batch64 = [
  JSON.parse(fs.readFileSync('scratch/batch64_art1.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch64_art2.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch64_art3.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch64_art4.json', 'utf8'))
];

for (const art of batch64) {
