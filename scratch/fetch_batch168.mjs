...
const queries = {
  t1: 'セルフ まつげパーマ セット ロッド',
  t2: 'リップ スクラブ 角質ケア 唇',
  t3: 'ガードル 骨盤 補正下着 ヒップアップ',
  t4: 'タングルティーザー コンパクト 持ち運び'
};
...
async function main() {
  ...
  fs.writeFileSync('scratch/batch168_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 168 products saved successfully to scratch/batch168_fetched.json!');
}
