...
// ① クエリ：メイクキープミスト 化粧崩れ防止 スプレー メイク固定 マスク崩れ防止, フィックスミスト（ファンデの毛穴落ちやチーク・アイメイクの色移りを防ぎ、朝の仕上がりを24時間鉄壁ロックするメイクキープスプレー）
// ② クエリ：アイブロウコート 眉毛 消えない 汗 水 ウォータープルーフ 眉メイク保護, 眉コート（夏の汗や皮脂・前髪の摩擦で夕方に消えてしまう眉尻のラインをひと塗りで透明コーティングする眉毛専用トップコート）
const NEW_PERIPHERAL_V41_FEATURES = [
  {
    featureId: 'feature-5-makeup-setting-spray-fix-mist',
    title: '【2026年最新・楽天最安値】【メイクキープミスト＆化粧崩れ防止スプレー】マスク摩擦・皮脂崩れを24時間鉄壁ブロックする「神フィックスミスト」5選',
    category: 'makeup',
    categoryLabel: '✨ 【神メイクキープミスト5選】毛穴落ちゼロ＆24時間メイク固定特集',
    introText: '「ファンデーションがマスクに擦れてドロドロになる」「夕方になるとTゾーンのテカリと毛穴落ちが目立つ」…ミクロ微細ミスト、ウォータープルーフ皮膜形成ポリマー、高保湿ヒアルロン酸・シカエキス配合で朝のメイク仕上がりをそのままロックする楽天売れ筋フィックスミスト5選を徹底検証！',
    items: [
      { id: 'art-fixmist-kose-make-keep-mist-ex-cool', keyword: 'コーセー メイクキープミスト', label: 'メイクキープスプレーの絶対王者！微細ミストで皮脂テカリとマスク崩れを強力防止' },
      { id: 'art-fixmist-shiseido-dprogram-allerbarrier-mist', keyword: 'dプログラム アレルバリア ミスト', label: '敏感肌の救世主！花粉や大気汚染物質から肌を守りながらメイクを密着固定' },
      { id: 'art-fixmist-clarins-fix-make-up-rose', keyword: 'クラランス フィックス メイクアップ', label: 'デパコス界の最高峰！優雅なダマスクローズの香りと高いキープ力で美肌を保つ' },
      { id: 'art-fixmist-tirtir-mask-fit-make-up-fixer', keyword: 'TIRTIR メイクキープミスト', label: 'クッションファンデと相性抜群！崩れない韓国発の強力フィクサー' },
      { id: 'art-fixmist-canmake-make-keep-mist-fresh', keyword: 'メイク キープ スプレー プチプラ', label: '高コスパ＆うるおいキープ！微粒子ミストで日中の乾燥崩れを防ぐ' }
    ]
  },
  {
    featureId: 'feature-5-eyebrow-top-coat-waterproof-seal',
    title: '【2026年最新・楽天最安値】【アイブロウコート＆消えない美眉ロック】汗・皮脂・前髪の摩擦でも夕方まで眉尻を死守する「神眉トップコート」5選',
    category: 'makeup',
    categoryLabel: '👁️ 【神アイブロウコート5選】擦れ・汗に負けない美眉トップコート特集',
    introText: '「夕方になると眉尻が消えて麻呂眉になってしまう」「前髪が擦れたり夏の汗で眉メイクが落ちるのが不安」…速乾透明フィルム、強力ウォータープルーフ、テカらないマット仕上げ処方で描いた眉毛を完全密閉ガードする楽天売れ筋アイブロウコート5選を徹底解説！',
    items: [
      { id: 'art-browcoat-canmake-lasting-multi-brow-coat', keyword: 'キャンメイク ラスティングマルチブロウコート', label: 'プチプラ界の絶対定番！速乾透明で描きたて眉を水・汗・皮脂から鉄壁ガード' },
      { id: 'art-browcoat-cezanne-eyebrow-coat-clear', keyword: 'セザンヌ 眉コート', label: 'テカらず自然！眉メイクの上から塗っても色落ちしない高コスパ名品' },
      { id: 'art-browcoat-integrate-eyebrow-seal-topcoat', keyword: 'アイブロウコート ウォータープルーフ', label: 'プールやレジャーでも安心！擦れに強く一日中消えない耐久フィルム' },
      { id: 'art-browcoat-orbis-eyebrow-coat-essence', keyword: '眉毛 トップコート', label: '眉毛保護トリートメント成分配合！毛をいたわりながら眉尻をしっかりキープ' },
      { id: 'art-browcoat-sweets-sweets-brow-coating-liquid', keyword: 'アイブロウ コート', label: '極細平筆で眉尻もブレずに塗れる！白浮きしないクリアリキッド' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第41弾【純粋コスメ＆メイクキープ特化】）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V41_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐにメイク崩れ・テカリの24時間鉄壁防止やアイブロウコートによる夕方の眉尻消滅完全防止を実感できる高機能設計`,
          `毎朝のメイクフィニッシュルーティンに無理なく組み込める快適な使用感・高い満足度`,
...
2. **肌や眉への優しさと持続性**: デリケートな肌でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'メイクキープ＆アイブロウ持続アナリスト',
        summaryKeyPoints: [
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアメイクキープ＆フィックスアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第41弾【純粋コスメ＆メイクキープ特化】特集記事および個別商品記事の完全追加が完了しました！`);
}
