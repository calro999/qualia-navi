...
const queries = {
  t1: 'メイクキープミスト コーセー 仕上げ用',
  t2: '涙袋 ライナー 影 ペンシル',
  t3: 'LED 美顔マスク 光エステ 7色',
  t4: 'ヘアブラシ クリーナー 髪の毛 掃除'
};
...
async function main() {
  ...
  fs.writeFileSync('scratch/batch171_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 171 products saved successfully to scratch/batch171_fetched.json!');
}
