...
// ① クエリ：前髪 カーラー クリップ式 立ち上げ 根元, 前髪 巻き マジックカーラー ふんわり（ドライヤーやアイロンなしで挟むだけで根元の立ち上がりとふんわり韓国風シースルー前髪を作る前髪専用クリップカーラー）
// ② クエリ：あぶらとり紙 麻 麻和紙 皮脂 テカリ 崩れ防止, 金箔 あぶらとり紙 高級（ファンデを剥がさず酸化した余分な皮脂だけを吸着してメイク直後のサラサラ肌に戻す高級あぶらとり紙）
const NEW_PERIPHERAL_V19_FEATURES = [
  {
    featureId: 'feature-5-bangs-clip-curler-volume',
    title: '【2026年最新・楽天最安値】【前髪クリップカーラー＆根元ふんわり立ち上げ】アイロン不要で挟むだけ！韓国風シースルーバングを作る「神前髪カーラー」5選',
    category: 'device',
    categoryLabel: '💇‍♀️ 【神前髪クリップカーラー5選】挟むだけ根元立ち上げ＆ふんわり前髪特集',
    introText: '「朝アイロンで巻いても湿気ですぐ前髪がペタンコになる」「メイク中に挟んでおくだけで自然なふんわりカールを作りたい」…アルミ熱伝導芯、しっかり留まるクリップ一体型、髪に跡がつかないマジックテープ構造で忙しい朝のスタイリングを時短する楽天売れ筋前髪カーラー5選を徹底検証！',
    items: [
      { id: 'art-curler-nobleman-bangs-clip-curler', keyword: '前髪 クリップ カーラー', label: 'クリップで挟むだけ！ドライヤーの温風で熱が伝わり1分で理想のふんわり前髪が完成' },
      { id: 'art-curler-magic-curler-large-volume', keyword: 'マジックカーラー 前髪 太め', label: '直径太めで自然な立ち上がり！跡がつかずシースルー前髪のセットに最適な大定番' },
      { id: 'art-curler-korean-hair-root-volume-clip', keyword: 'ヘア クリップ 根元 立ち上げ', label: '韓国で大流行！トップや分け目のボリュームダウンを瞬時に解消するボリュームピン' },
      { id: 'art-curler-aluminum-heat-curler', keyword: 'アルミ カーラー 前髪 ふんわり', label: 'アルミニウムシート内蔵でドライヤーの熱を効率よくキープする時短カーラー' },
      { id: 'art-curler-portable-bangs-roller', keyword: '前髪 巻き カーラー 携帯用', label: 'ポーチにすっきり収まる！学校やオフィスのメイク直しで大活躍する人気ギア' }
    ]
  },
  {
    featureId: 'feature-5-premium-blotting-paper-oil-absorb',
    title: '【2026年最新・楽天最安値】【高級あぶらとり紙＆ファンデ剥がさず皮脂オフ】テカリと毛穴の脂浮きを一瞬でリセットする「神あぶらとり紙」5選',
    category: 'device',
    categoryLabel: '📜 【神高級あぶらとり紙5選】ファンデ崩さず皮脂吸着＆毛穴テカリオフ特集',
    introText: '「ティッシュオフだとファンデーションが剥げてムラになる」「Tゾーンや小鼻のテカリだけを優しく抑えたい」…天然麻100%、京都伝統の金箔打紙製法、パフ付きケース入り設計で必要な潤いを残し皮脂だけを瞬間吸収する楽天大人気あぶらとり紙5選を徹底解説！',
    items: [
      { id: 'art-blot-yojiya-aburatorigami-kyoto', keyword: 'よーじや あぶらとり紙', label: '京都の伝統！緻密な繊維が肌に吸い付くように余分な皮脂だけを瞬間吸収する絶対の最高峰' },
      { id: 'art-blot-shiseido-oil-blotting-paper', keyword: '資生堂 あぶらとり紙', label: 'プルポップ式で1枚ずつ取り出しやすい！肌触りなめらかな天然麻のロングセラー' },
      { id: 'art-blot-kanazawa-gold-leaf-paper', keyword: '金箔 あぶらとり紙 高級', label: '金沢伝統の金箔打ち技術！驚異の皮脂吸収力と肌当たりの優しさを極めた贅沢和紙' },
      { id: 'art-blot-puff-blotting-paper-case', keyword: 'あぶらとり紙 パフ付き ケース', label: 'パフでポンポン抑えるだけ！手を汚さずファンデを崩さずテカリをオフできる便利品' },
      { id: 'art-blot-charcoal-oil-blotting-sheets', keyword: 'あぶらとり紙 竹炭配合', label: '竹炭の吸着力で毛穴の酸化皮脂とニオイを同時にリセットするマットキープ紙' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第19弾）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V19_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに前髪のふんわり立ち上げやテカリ皮脂の瞬間クリア吸収を実感できる高機能設計`,
          `毎朝のヘアセットや日中のメイク直し習慣に無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'スタイリングギア＆ベースメイクアナリスト',
        summaryKeyPoints: [
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアスタイリング＆メイク直しアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第19弾特集記事および個別商品記事の完全追加が完了しました！`);
}
