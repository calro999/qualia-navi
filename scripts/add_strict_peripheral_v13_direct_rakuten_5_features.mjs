...
// ① クエリ：アイシャドウベース まぶた 発色 密着 ヨレ防止, アイシャドウ下地 ラメ飛び防止（アイシャドウの発色を劇的に高め二重幅の粉溜まりやラメ飛びを防ぐ目元下地）
// ② クエリ：ヘアミルク 洗い流さない 高保湿 パサつき補修, アウトバストリートメント ミルク 保湿（オイルでは重すぎる・パサつく細毛や乾燥毛を内部から水分補給する高浸透ヘアミルク）
const NEW_PERIPHERAL_V13_FEATURES = [
  {
    featureId: 'feature-5-eyeshadow-primer-base',
    title: '【2026年最新・楽天最安値】【アイシャドウベース＆発色・色持ち劇的アップ】二重幅の粉溜まり・ラメ落ちを防止する「神アイシャドウ下地」5選',
    category: 'makeup',
    categoryLabel: '👁️ 【神アイシャドウベース5選】発色・密着＆ラメ飛び防止特集',
    introText: '「せっかく塗ったアイシャドウが夕方になると二重幅に線になって溜まる」「大粒ラメが頬に落ちてしまう」…薄膜密着ヴェール、皮脂プルーフ、くすみを補正するトーンアップ効果で朝の仕上がりを夜までロックする楽天売れ筋アイシャドウプライマー5選を徹底検証！',
    items: [
      { id: 'art-eyebase-canmake-eyeshadow-base', keyword: 'キャンメイク ラスティングマルチアイベース', label: 'チューブタイプで衛生的！まぶたにピタッと密着して発色とモチを劇的アップ' },
      { id: 'art-eyebase-nars-smudge-proof-base', keyword: 'NARS スマッジプルーフ アイシャドーベース', label: '世界中のプロが絶賛！どんなに皮脂が出ても一切ヨレないアイベースの絶対最高峰' },
      { id: 'art-eyebase-excel-fit-eye-base', keyword: 'エクセル フィットアイベース', label: 'スキンケア成分贅沢配合！まぶたのくすみを飛ばしてアイシャドウを美しく発色' },
      { id: 'art-eyebase-mac-prep-prime-eye', keyword: 'アイシャドウ 下地 ヨレ防止', label: '発色鮮やか＆グラデーションが簡単になる高密着アイプライマー' },
      { id: 'art-eyebase-cezanne-eye-zone-base', keyword: 'アイシャドウベース ラメ飛び防止', label: 'プチプラなのに実力派！ラメ落ちを防ぎ目元の乾燥もカバー' }
    ]
  },
  {
    featureId: 'feature-5-hydrating-hair-milk-repair',
    title: '【2026年最新・楽天最安値】【高保湿ヘアミルク＆水分チャージ補修】オイルのベタつきが苦手な髪に！内側から毛先を潤す「神アウトバスミルク」5選',
    category: 'haircare',
    categoryLabel: '🥛 【神高保湿ヘアミルク5選】インナー保水＆パサつき補修特集',
    introText: '「オイルだと表面だけギトギトして内側が乾燥する」「細毛・軟毛でペタンとならずにしっとりまとまる洗い流さないトリートメントが欲しい」…セラミド、CMC補修成分、アミノ酸、シルクプロテイン配合で毛髪内部の水分量を爆上げする楽天大人気ヘアミルク5選を徹底解説！',
    items: [
      { id: 'art-hairmilk-orbis-essence-in-hair-milk', keyword: 'オルビス エッセンスインヘアミルク', label: 'SNSでバズり散らかした殿堂入り！無香料でどんな人でも毛先がぷるんと潤う神ミルク' },
      { id: 'art-hairmilk-milbon-elujuda-emulsion-plus', keyword: 'ミルボン エルジューダ エマルジョン', label: 'サロン専売品！バオバブエキスと加水分解コラーゲンで硬い髪も柔らかくまとまる' },
      { id: 'art-hairmilk-loretta-night-care-milk', keyword: 'ロレッタ ナイトケアクリーム', label: '夜つけて寝るだけで翌朝サラサラ！ベタつかず寝癖も防ぐトリートメント' },
      { id: 'art-hairmilk-botanist-botanical-hair-milk', keyword: 'ボタニスト ヘアミルク モイスト', label: '植物由来成分が毛先までしっかり浸透して乾燥による広がりを抑える' },
      { id: 'art-hairmilk-john-masters-hair-milk', keyword: 'ヘアミルク 洗い流さない 高保湿', label: 'オーガニック植物オイル配合でしっとり滑らかな指通りを叶える' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第13弾）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V13_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐにアイシャドウの夜までの密着キープやパサつく髪のぷるぷる水分保水を実感できる高機能設計`,
          `毎朝のポイントメイクや洗髪後のアウトバスケアルーティンに無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'アイメイク＆インナーヘアケアアナリスト',
        summaryKeyPoints: [
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアアイメイク＆ヘアケアアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第13弾特集記事および個別商品記事の完全追加が完了しました！`);
}
