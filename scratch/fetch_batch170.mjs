...
const queries = {
  t1: '足用 デオドラント クリーム 消臭',
  t2: 'ヘアオイル ミスト スプレー ツヤ',
  t3: '二重まぶた 夜用 アイプチ クセ付け',
  t4: 'メイクブラシ スタンド 収納 干す'
};
...
async function main() {
  ...
  fs.writeFileSync('scratch/batch170_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 170 products saved successfully to scratch/batch170_fetched.json!');
}
