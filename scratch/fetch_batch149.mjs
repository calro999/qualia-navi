...
const queries = {
  t1: 'バスタブラック 伸縮 お風呂 テーブル トレー 半身浴',
  t2: '頭皮 ロールオン 美容液 スカルプ マッサージ',
  t3: '爪磨き ブロック 4way バッファー 爪やすり',
  t4: '背中 シェーバー ムダ毛処理 ロング 届く'
};
...
async function main() {
  ...
  fs.writeFileSync('scratch/batch149_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 149 products saved successfully to scratch/batch149_fetched.json!');
}
