...
// ① クエリ：ハンドマッサージャー 手のひら 指先 温熱 エアー, ルルド ハンドケア（PC作業やスマホで酷使した手のひら・指先のコリを温熱ヒーターとエアバッグでほぐす電動ハンドマッサージャー）
// ② クエリ：シルク 枕カバー 髪 摩擦防止 美髪 保湿 25匁, シルク 枕カバー ファスナーなし（寝ている間の寝返り摩擦から髪と肌を守り、朝のパサつき・枝毛・寝癖を劇的に防ぐシルク100%枕カバー）
const NEW_PERIPHERAL_V21_FEATURES = [
  {
    featureId: 'feature-5-hand-massager-air-heat',
    title: '【2026年最新・楽天最安値】【電動ハンドマッサージャー＆手のひら指先ほぐし】PCスマホ疲れ・冷え手を温熱エアーで癒やす「神ハンドケア家電」5選',
    category: 'device',
    categoryLabel: '🧤 【神ハンドマッサージャー5選】手のひら指先温熱＆疲労回復特集',
    introText: '「毎日のパソコン作業やスマホ操作で手首や指の関節がパンパンに疲れる」「指先が冷えて血行が悪い」…指1本1本を包み込む独立エアバッグ、じんわり温める温熱ヒーター、選べる揉み心地モードで手のコリを芯からほぐす楽天売れ筋電動ハンドマッサージャー5選を徹底検証！',
    items: [
      { id: 'art-handmass-lourdes-hand-care-cordless', keyword: 'ルルド ハンドケア', label: 'ハンドマッサージャーの元祖！指先から手のひら全体を包み込んで揉みほぐす大人気モデル' },
      { id: 'art-handmass-doctor-air-hand-care', keyword: 'ドクターエア ハンドマッサージャー', label: 'パワフルなエアー圧力と温熱ヒーターで手のひらのツボを刺激する本格派' },
      { id: 'art-handmass-nicipo-hand-massager-heat', keyword: 'ハンドマッサージャー 温熱 コードレス', label: 'コードレス充電式でどこでも使える！手の冷えとこわばりを同時に解消する高評価品' },
      { id: 'art-handmass-breo-wow-hand-relax', keyword: '手首 指先 マッサージ機', label: '手首までしっかりカバー！デスクワークの疲れを徹底的にリフレッシュ' },
      { id: 'art-handmass-air-finger-press-care', keyword: '手のひら マッサージ器 エアー', label: '指先ごとの圧迫刺激が心地よい！毎日のハンドクリーム後の保湿ケアにも最適' }
    ]
  },
  {
    featureId: 'feature-5-silk-pillowcase-hair-care',
    title: '【2026年最新・楽天最安値】【最高級シルク100%枕カバー＆髪の摩擦ダメージゼロ】寝ている間にツヤ髪＆美肌へ導く「神シルクピローケース」5選',
    category: 'haircare',
    categoryLabel: '🛏️ 【神シルク枕カバー5選】髪の摩擦防止＆翌朝サラサラツヤ髪特集',
    introText: '「朝起きると髪がバサバサに広がって絡まる」「ナイトキャップだと寝ている間に脱げてしまう」…最高級6Aランク・25匁高密度生糸、天然シルクプロテインのアミノ酸保湿、静電気＆摩擦防止設計で寝ている間に髪と肌を摩擦から守る楽天大人気シルク枕カバー5選を徹底解説！',
    items: [
      { id: 'art-silkpillow-coco-silk-pillowcase-25momme', keyword: 'ココシルク 枕カバー シルク', label: '楽天ランキング1位独占！25匁の厚手シルクで朝の寝癖・パサつきを激減させる超人気作' },
      { id: 'art-silkpillow-silk-pillowcase-両面-6a', keyword: 'シルク 枕カバー 両面 25匁', label: '表も裏も贅沢シルク100%！吸湿・放湿性に優れ一年中快適な美髪睡眠' },
      { id: 'art-silkpillow-lillysilk-pure-mulberry', keyword: 'リリーシルク 枕カバー', label: '世界基準の最高品質マルベリーシルク採用！なめらかな肌触りで顔の摩擦ジワも予防' },
      { id: 'art-silkpillow-silk-pillow-cover-envelope', keyword: 'シルク 枕カバー 封筒式 ファスナーなし', label: '金具が肌に当たらない封筒式！洗濯機で洗えるウォッシャブル加工の便利品' },
      { id: 'art-silkpillow-organic-silk-hair-protection', keyword: '枕カバー シルク 100% 美髪', label: '敏感肌でも安心の無添加シルク！翌朝のまとまりとツヤ感が劇的に変わる' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第21弾）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V21_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに手のひらの疲労回復・温まりや朝の髪のサラサラツヤ・摩擦ダメージ軽減を実感できる高機能設計`,
          `毎晩のナイトルーティンや睡眠環境に無理なく組み込める快適な使用感・高い満足度`,
          `楽天市場のポイント高還元を活用することで実質最安値での継続が可能`
        ],
        cons: [
          `大人気アイテムのためセール期やキャンペーン時には一時的に欠品する場合がある`,
          `効果を最大化するために推奨された正しい使用手順やお手入れ方法を守ることが推奨される`
        ],
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'ハンドケア機器＆ナイトスリープアナリスト',
        summaryKeyPoints: [
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアハンドケア＆スリープギアアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第21弾特集記事および個別商品記事の完全追加が完了しました！`);
}
