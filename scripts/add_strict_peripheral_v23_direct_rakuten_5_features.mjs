...
// ① クエリ：まつげエクステ コーティング剤 マツエク長持ち 透明, まつげコーティング まつパ キープ（マツエクやまつ毛パーマの束感を綺麗に整え、汗や油分を弾いて持続期間を2倍に伸ばすクリアコーティング美容液）
// ② クエリ：頭皮かっさ 天然石 ローズクォーツ 頭皮マッサージ, カッサ スカルプ リンパ 流し（側頭筋や後頭部のコリを天然石や陶器の立体カーブでゴリゴリほぐしてフェイスラインのリフトアップを促す頭皮用かっさ）
const NEW_PERIPHERAL_V23_FEATURES = [
  {
    featureId: 'feature-5-eyelash-extension-coating-essence',
    title: '【2026年最新・楽天最安値】【マツエク＆まつパ専用コーティング美容液】綺麗な束感と持続力2倍！水・汗・油分を弾く「神クリアコート」5選',
    category: 'makeup',
    categoryLabel: '✨ 【神マツエクコーティング5選】束感キープ＆持続力2倍特集',
    introText: '「せっかくつけたマツエクが寝癖や洗顔ですぐバラつく」「まつ毛パーマのカールをサロン帰りのまま長く保ちたい」…高密着透明ポリマー、ケラチン補修成分、皮脂ブロック処方で自まつ毛とエクステをコーティングし綺麗な束感を作る楽天売れ筋マツエクコーティング剤5選を徹底検証！',
    items: [
      { id: 'art-lashcoat-omeme-multi-coating-mascara', keyword: 'Omeme まつ毛美容液 コーティング', label: 'サロン導入率No.1！ナチュラルな束感とカールキープを叶えるマルチコーティング美容液' },
      { id: 'art-lashcoat-phiten-lash-coating-essence', keyword: 'マツエク コーティング剤 透明', label: '皮脂や水分からエクステを鉄壁ガード！持続期間が劇的に伸びるクリアプロテクト' },
      { id: 'art-lashcoat-black-diamond-coating-serum', keyword: 'まつげパーマ コーティング 束感', label: 'SNSで話題の韓国風束感まつ毛が簡単に！トリートメント成分配合でまつ毛を保護' },
      { id: 'art-lashcoat-lash-essence-clear-coating', keyword: 'まつ毛 コーティング エッセンス', label: '速乾クリアタイプ！朝のメイク前にも夜のケアにも使える高密着処方' },
      { id: 'art-lashcoat-keratin-lash-lift-coating', keyword: 'ケラチン まつげパーマ コーティング', label: '傷んだまつ毛を補修しながらツヤやかな束感を一日中キープする人気作' }
    ]
  },
  {
    featureId: 'feature-5-scalp-kassa-massage-stone',
    title: '【2026年最新・楽天最安値】【頭皮用かっさプレート＆側頭筋ゴリゴリほぐし】頭のコリを流して顔のたるみを引き上げる「神スカルプカッサ」5選',
    category: 'device',
    categoryLabel: '💆‍♀️ 【神頭皮かっさ5選】側頭筋ほぐし＆フェイスライン引き上げ特集',
    introText: '「夕方になると側頭部がガチガチに凝って目がかすむ」「顔のたるみやほうれい線を頭皮から引き上げたい」…天然ローズクォーツ、深海陶器、滑らかな突起リブ設計で指では届かない筋膜の癒着をゴリゴリ流す楽天大人気頭皮かっさ5選を徹底解説！',
    items: [
      { id: 'art-kassa-rosequartz-scalp-kassa-comb', keyword: '頭皮 かっさ ローズクォーツ', label: '天然石のひんやり感と程よい重み！頭皮の筋膜を心地よくほぐす贅沢カッサコーム' },
      { id: 'art-kassa-ceramic-head-kassa-plate', keyword: '頭皮 かっさ 陶器 スカルプ', label: '職人手作りの陶磁器製！フィットする立体カーブで頭皮から首筋まで一気にリンパ流し' },
      { id: 'art-kassa-wooden-scalp-massage-comb', keyword: '木製 頭皮 かっさ マッサージ', label: '天然木の優しい肌当たり！静電気が起きず頭皮のツボをピンポイント刺激' },
      { id: 'art-kassa-metal-cooling-scalp-kassa', keyword: '頭皮 カッサ ステンレス', label: 'お風呂でそのまま使える！丸洗いできて清潔な高耐久スカルプカッサ' },
      { id: 'art-kassa-tera-herz-scalp-kassa-bar', keyword: 'テラヘルツ かっさ 頭皮', label: '1秒間に1兆回の高周波振動！巡りを促進して頭の重だるさをスッキリ解消' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第23弾）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V23_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐにマツエクやまつパの綺麗な束感キープや頭皮のガチガチコリ解消・すっきりリフト感を実感できる高機能設計`,
          `毎朝のアイメイク仕上げや夜のバスタイム・スキンケアルーティンに無理なく組み込める快適な使用感・高い満足度`,
...
2. **まつ毛や頭皮への優しさと持続性**: デリケートな部位でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'アイラッシュ＆スカルプカッサアナリスト',
        summaryKeyPoints: [
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアマツエク＆スカルプアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第23弾特集記事および個別商品記事の完全追加が完了しました！`);
}
