...
const queries = {
  t1: 'ホットアイマスク 充電式 目元エステ',
  t2: 'シルク ナイトキャップ ロングヘア',
  t3: 'シルク 枕カバー 25匁 洗える',
  t4: 'ホットビューラー 充電式 まつ毛'
};
...
async function main() {
  ...
  fs.writeFileSync('scratch/batch154_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 154 products saved successfully to scratch/batch154_fetched.json!');
}
