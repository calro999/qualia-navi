...
// ① クエリ：アイシャドウ チップ 使い捨て シリコン チップ, メイクスポンジ チップ アイメイク（指やブラシでは粉飛びしやすいラメやグリッター、クリームシャドウをピタッと高発色に密着させるシリコン＆スポンジアイシャドウチップ）
// ② クエリ：シルク 腹巻き レディース 温活 腸活 冷え性 薄手, シルク 腹巻 下着 絹100%（アウターに響かない極薄天然シルク100%で、お腹や腰回りの冷え・女性特有の巡りの不調を年中快適に温活サポートするインナーシルク腹巻）
const NEW_PERIPHERAL_V26_FEATURES = [
  {
    featureId: 'feature-5-silicone-sponge-eyeshadow-applicator',
    title: '【2026年最新・楽天最安値】【アイシャドウ用シリコンチップ＆高密着ラメのせ】大粒ラメの粉飛びゼロ！クリーム・グリッターを濡れツヤ密着させる「神アイチップ」5選',
    category: 'device',
    categoryLabel: '👁️ 【神アイシャドウチップ5選】ラメ粉飛び防止＆高密着シリコン特集',
    introText: '「大粒グリッターやラメシャドウを塗ると頬に粉飛びして汚れる」「クリームシャドウが二重幅に溜まってヨレる」…ぷにぷに高密着シリコンヘッド、極細両端デュアル設計、使い捨て可能な抗菌スポンジ構造で指よりも均一にメタリックな輝きを密着させる楽天売れ筋アイシャドウチップ5選を徹底検証！',
    items: [
      { id: 'art-eyetip-silicone-glitter-applicator', keyword: 'シリコン アイシャドウ チップ', label: 'ラメやグリッター専用！粉を吸い込まずにまぶたへ100%転写密着させる神ツール' },
      { id: 'art-eyetip-rosyrosa-sponge-applicator', keyword: 'ロージーローザ アイシャドウチップ', label: 'きめ細かな極上スポンジ！グラデーションも締め色ラインも思い通りに描ける大定番' },
      { id: 'art-eyetip-disposable-dual-eyeshadow-tips', keyword: 'アイシャドウ チップ 使い捨て 大容量', label: 'いつでも衛生的！コスメのカラー混ざりを防ぐコスパ最強マルチチップパック' },
      { id: 'art-eyetip-long-handle-makeup-applicator', keyword: 'アイシャドウ チップ ロング ロング軸', label: '持ち手が長くて手ブレしない！プロのメイク現場でも使われるロングハンドル' },
      { id: 'art-eyetip-pointed-crease-brush-tip', keyword: 'アイメイク チップ 極細 涙袋', label: '涙袋のハイライトや目尻の三角ゾーンに！ミリ単位でピンポイントに置ける極細チップ' }
    ]
  },
  {
    featureId: 'feature-5-silk-belly-warmer-body-care',
    title: '【2026年最新・楽天最安値】【極薄シルク100%腹巻き＆女性の冷え腸活温活】アウターに響かず夏も冬も蒸れない「神シルクハラマキ」5選',
    category: 'bodycare',
    categoryLabel: '🧣 【神シルク腹巻き5選】極薄温活＆腸活・冷え性改善特集',
    introText: '「冷房や冬の寒さでお腹や腰が冷えてツラい」「腹巻きをすると着膨れしてアウターに響くのが嫌」…最高級天然シルク100%、無縫製ホールガーメント立体編み、吸放湿性抜群の極薄ストレッチ設計で一年中快適に内臓を温める楽天大人気シルク腹巻き5選を徹底解説！',
    items: [
      { id: 'art-silkbelly-sowan-silk-belly-warmer', keyword: 'SOWAN シルク 腹巻', label: '楽天1位独占！無縫製でチクチクせず薄手なのに抜群に温かい大人気温活シルク腹巻' },
      { id: 'art-silkbelly-silk-cotton-seamless-warmer', keyword: 'シルク 腹巻き レディース 薄手', label: 'アウターに一切響かない極薄設計！夏場の冷房冷え対策にも最適なサラサラ質感' },
      { id: 'art-silkbelly-pure-silk-rib-belly-band', keyword: 'シルク100% 腹巻 絹', label: '贅沢な天然生糸100%！敏感肌でも安心してお腹・腰回りを優しく包み込む' },
      { id: 'art-silkbelly-long-silk-tube-body-warmer', keyword: 'シルク 腹巻 ロング丈', label: '胸下からお尻まですっぽりカバー！冷えやすい骨盤周りまで一括温活ケア' },
      { id: 'art-silkbelly-organic-maternity-silk-warmer', keyword: 'マタニティ 腹巻 シルク', label: '締め付け感ゼロの高伸縮編み！妊活中やプレママにも選ばれる優しいフィット感' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第26弾）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V26_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐにラメの粉飛びゼロ・高密着発色やシルク腹巻きによるお腹の芯からの温まり・冷え解消を実感できる高機能設計`,
          `毎日のメイクアップルーティンやオールシーズンのインナー温活習慣に無理なく組み込める快適な使用感・高い満足度`,
...
2. **目元や素肌への優しさと持続性**: デリケートな部位でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'アイメイクツール＆温活インナーアナリスト',
        summaryKeyPoints: [
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアアイメイク＆温活ケアアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第26弾特集記事および個別商品記事の完全追加が完了しました！`);
}
