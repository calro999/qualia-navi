...
// ① クエリ：アイライナーコート にじみ防止 パンダ目 ウォータープルーフ, アイライナー コーティング（引いたアイラインの上からサッと重ねるだけで涙・皮脂・汗による夕方のパンダ目崩れを鉄壁ガードするアイライナー専用トップコート）
// ② クエリ：シルク アイマスク 遮光 安眠 睡眠 25匁 絹, シルク アイマスク 大きめ（飛行機や新幹線、自宅の快眠のために、目元の皮膚を摩擦・乾燥から守りながら100%完全遮光する極上シルクアイマスク）
const NEW_PERIPHERAL_V29_FEATURES = [
  {
    featureId: 'feature-5-eyeliner-top-coat-panda-proof',
    title: '【2026年最新・楽天最安値】【アイライナーコート＆夕方のパンダ目完全遮断】涙・皮脂で消えない！描きたてラインを1日中固定する「神ライナーコート」5選',
    category: 'makeup',
    categoryLabel: '👁️ 【神アイライナーコート5選】パンダ目防止＆一日中ライン固定特集',
    introText: '「夕方になると目尻のラインが滲んでパンダ目になる」「笑いジワや目薬でアイラインが消えてしまう」…速乾透明シリコーン皮膜、耐水・耐皮脂ダブルプルーフ処方、極細平筆設計で描いたアイラインの上から塗るだけで朝の仕上がりを鉄壁キープする楽天売れ筋アイライナーコート5選を徹底検証！',
    items: [
      { id: 'art-eyecoat-cezanne-eyeliner-top-coat', keyword: 'セザンヌ アイライナーコート', label: 'プチプラ界の神アイテム！ひと塗りでどんなアイラインもウォータープルーフ化する大定番' },
      { id: 'art-eyecoat-canmake-eyeliner-top-coat', keyword: 'キャンメイク アイライナーコート', label: '透明速乾ポリマー採用！テカらず自然に密着して皮脂・こすれを完全ブロック' },
      { id: 'art-eyecoat-sweets-sweets-eyeliner-coat', keyword: 'アイライナー トップコート 透明', label: 'リキッドもペンシルもジェルもOK！目元に潤いを与える美容液成分配合コート' },
      { id: 'art-eyecoat-kissme-heroine-make-coat', keyword: 'ヒロインメイク アイライナーコート', label: '耐久メイクのヒロインメイク発！涙・擦れに圧倒的に強いウォータープルーフコート' },
      { id: 'art-eyecoat-professional-smudge-proof-coat', keyword: 'アイメイク にじみ防止 コート', label: 'メイク直しの手間を激減！一日中描きたてのくっきりアイラインを死守するプロ仕様' }
    ]
  },
  {
    featureId: 'feature-5-silk-sleep-eye-mask-blackout',
    title: '【2026年最新・楽天最安値】【最高級シルク100%遮光アイマスク＆目元保湿】寝返りでもズレず目元の小じわ・乾燥を防ぐ「神安眠アイマスク」5選',
    category: 'bodycare',
    categoryLabel: '😴 【神シルクアイマスク5選】完全遮光＆目元乾燥シワ予防特集',
    introText: '「朝の光や部屋の明かりで眠りが浅い」「アイマスクのゴムの締め付けで耳が痛くなる・肌が擦れる」…最高級6Aランク・25匁高密度マルベリーシルク、中綿入りふっくらクッション、耳が痛くならない幅広アジャスター設計で極上の眠りと目元の潤いを届ける楽天大人気シルクアイマスク5選を徹底解説！',
    items: [
      { id: 'art-silkmask-coco-silk-sleep-eye-mask', keyword: 'COCOSILK シルク アイマスク', label: '楽天ランキング1位！25匁シルクの極上肌触りと高い遮光性で朝までぐっすり熟睡' },
      { id: 'art-silkmask-pure-silk-blackout-mask-big', keyword: 'シルク アイマスク 遮光 大きめ', label: '目元から鼻筋までしっかり覆う大きめ設計！隙間からの光漏れをゼロにする完全遮光' },
      { id: 'art-silkmask-lillysilk-silk-eye-mask-strap', keyword: 'リリーシルク アイマスク', label: '世界基準の最高品質マルベリーシルク！目元の皮膚の摩擦を防ぎ小じわを予防' },
      { id: 'art-silkmask-warm-silk-eye-mask-pack', keyword: 'シルク アイマスク 温熱 アジャスター', label: '耳が痛くならないバックストラップ式！心地よいフィット感で長時間の移動にも最適' },
      { id: 'art-silkmask-reversible-silk-sleep-cover', keyword: 'アイマスク シルク 100% 安眠', label: '両面贅沢シルク100%！吸放湿性に優れ夏でも蒸れずに快適な美肌快眠' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第29弾）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V29_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに夕方のパンダ目完全防止やシルクアイマスクによる深睡眠・目元保湿を実感できる高機能設計`,
          `毎日のアイメイク仕上げや就寝前の快眠ルーティンに無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'アイメイクコート＆快眠スリープギアアナリスト',
        summaryKeyPoints: [
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアアイメイク＆快眠ケアアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第29弾特集記事および個別商品記事の完全追加が完了しました！`);
}
