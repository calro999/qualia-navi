...
const NEW_VALHALLA_V4_FEATURES = [
  // 特集①：【美髪スカルプトリートメント＆濃密頭皮パック】乾燥・フケ・毛先のパサつきを一挙解決する「神頭皮トリートメント」5選
  {
    featureId: 'feature-5-scalp-treatment-moisture-pack',
    title: '【2026年最新・楽天最安値】【美髪スカルプトリートメント＆濃密頭皮パック】乾燥・フケ・毛先のパサつきを一挙解決する「神頭皮トリートメント」5選',
    category: 'haircare',
    categoryLabel: '🫧 【神頭皮トリートメント5選】頭皮保湿＆美髪パック特集',
    introText: '「頭皮の乾燥によるかゆみやフケを防ぎたい」「頭皮にも直接塗れて毛先までトゥルトゥルになる濃厚トリートメントが欲しい」…天然クレイ、海洋深層水ミネラル、ボタニカルオイル配合で頭皮環境を保湿・柔軟化しながら髪を芯から補修する楽天売れ筋スカルプトリートメント5選を徹底検証！',
    items: [
      { id: 'art-treat-w-scalp-clay-treatment', keyword: 'クレージュ トリートメント クレイ', label: 'ナチュラルクレイ配合で地肌をじんわり引き締め毛先までうるツヤに導く' },
      { id: 'art-treat-scalpd-beaute-pack-treat', keyword: 'スカルプD ボーテ 薬用トリートメントパック', label: '頭皮に直塗りしてマッサージ！女性の頭皮環境を整える薬用パック' },
      { id: 'art-treat-le-ment-sparkling-treatment', keyword: 'ルメント リペア マスク', label: 'サロン専売クオリティの高濃度トリートメントで週1回の集中ダメージ補修' },
      { id: 'art-treat-john-masters-scalp-conditioner', keyword: 'ジョンマスター スカルプ コンディショナー', label: 'ミントやユーカリの清涼感で頭皮をリフレッシュし髪にコシを与える' },
      { id: 'art-treat-hoyu-promaster-scalp', keyword: 'プロマスター カラーケア スカルプ', label: 'カラー後のデリケートな頭皮と髪を優しく保護するサロン仕様' }
    ]
  },
  // 特集②：【極上カラーリップバーム＆透け感血色】すっぴんでも可愛く血色チャージ！高保湿＆UVカットを叶える「神色付きリップ」5選
  {
    featureId: 'feature-5-tinted-lip-balm-natural-glow',
    title: '【2026年最新・楽天最安値】【極上カラーリップバーム＆透け感血色】すっぴんでも可愛く血色チャージ！高保湿＆UVカットを叶える「神色付きリップ」5選',
    category: 'makeup',
    categoryLabel: '💋 【神色付きリップ5選】透け感血色＆高保湿UV特集',
    introText: '「ノーメイクやオンライン会議で血色感だけサッと足したい」「口紅だと唇が荒れてしまうので色付きリップでケアしたい」…高保湿オイル、透け感ティント発色、UVカットSPF値配合でひと塗りで多幸感溢れるピュア唇を作る楽天大人気カラーリップバーム5選を徹底解説！',
    items: [
      { id: 'art-colorlip-nivea-rich-care-color', keyword: 'ニベア リッチケア＆カラーリップ', label: '美容オイル配合でとろける塗り心地と透明感ある高発色を誇る国民的人気リップ' },
      { id: 'art-colorlip-kate-personal-lip-cream', keyword: 'KATE パーソナルリップクリーム', label: '自分に似合う血色感に出会える！UVカット＆密封保湿の殿堂入りリップ' },
      { id: 'art-colorlip-dior-lip-glow-balm', keyword: 'ディオール アディクト リップ グロウ', label: '97%自然由来成分で唇本来の美しさを引き出し24時間うるおいキープ' },
      { id: 'art-colorlip-opera-sheer-matte-lip', keyword: 'オペラ リップティント', label: 'オイル配合でスルスル伸びて透けるようなキレイ色が落ちずに続く' },
      { id: 'art-colorlip-shiseido-moist-lip-color', keyword: 'メンソレータム リップフォンデュ', label: 'まるでフォンデュのようにとろけて濃厚ラップ＆プランプツヤを与える' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による「82大達成・最新5選まとめ特集記事」作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_VALHALLA_V4_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに頭皮のしっとり潤い感や自然な透け感血色ツヤを実感できる高機能設計`,
          `毎日のバスタイムやデイリーリップケアに無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'スカルプトリートメント＆カラーリップアナリスト',
        summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得による「82大達成・最新5選まとめ特集記事」および個別商品記事の完全追加が完了しました！`);
}
