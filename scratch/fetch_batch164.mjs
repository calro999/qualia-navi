...
async function main() {
  ...
  fs.writeFileSync('scratch/batch164_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 164 products saved successfully to scratch/batch164_fetched.json!');
}
