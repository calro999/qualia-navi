...
// ① クエリ：アイシャドウスパチュラ シリコン メイクスパチュラ アイメイク, メイク用 スパチュラ（アイシャドウ・グリッターの粉飛びゼロ塗布や、リキッド・クリームファンデの極薄均一塗布を実現する専用ミニスパチュラ）
// ② クエリ：シルク インナー レディース 半袖 フレンチスリーブ 絹, シルク 肌着 汗取り（夏のワキ汗・背中の汗冷えを防ぎ、ブラウスやニットの下に快適に着られる極上天然シルク100%インナートップス）
const NEW_PERIPHERAL_V32_FEATURES = [
  {
    featureId: 'feature-5-mini-silicone-makeup-spatula',
    title: '【2026年最新・楽天最安値】【ミニシリコンスパチュラ＆ポイントメイク極薄密着】ラメ・コンシーラー・アイシャドウをムラなくのせる「神メイクヘラ」5選',
    category: 'device',
    categoryLabel: '✨ 【神ミニメイクスパチュラ5選】ポイント極薄密着＆ラメ粉飛びゼロ特集',
    introText: '「指で塗るとラメが飛び散る・コンシーラーが厚塗りになる」「細かな目元や小鼻の溝にベースメイクが綺麗にフィットしない」…極小シリコンヘッド、ステンレス製極薄エッジ、持ちやすいロング軸設計でクリームやグリッターを均一かつ薄膜密着させる楽天売れ筋ミニメイクスパチュラ5選を徹底検証！',
    items: [
      { id: 'art-spatula-piccasso-mini-makeup-spatula', keyword: 'ピカソ スパチュラ メイク', label: '韓国プロメイク現場の必需品！薄膜ベースとポイントメイクを完璧に仕上げる名品' },
      { id: 'art-spatula-silicone-lip-eyeshadow-brush', keyword: 'シリコン メイク ブラシ スパチュラ', label: 'ぷにぷにシリコンで肌当たり抜群！ラメやリップを無駄なく塗れるマルチツール' },
      { id: 'art-spatula-stainless-dual-cosmetic-spatula', keyword: 'メイク スパチュラ ステンレス', label: 'いつでもアルコール消毒できて超衛生的！ファンデやクリームをすくって伸ばす万能ヘラ' },
      { id: 'art-spatula-concealer-mini-blade-spatula', keyword: 'コンシーラー スパチュラ 極薄', label: '小鼻や目のキワのクマ消しに！ミリ単位で薄く均一に叩き込める極小ブレード' },
      { id: 'art-spatula-portable-cap-silicone-applicator', keyword: 'メイク用 スパチュラ キャップ付き', label: 'ポーチに入れて持ち運べる保護キャップ付き！外出先のお直しにも大活躍' }
    ]
  },
  {
    featureId: 'feature-5-silk-inner-undershirt-sweat-care',
    title: '【2026年最新・楽天最安値】【天然シルク100%フレンチ袖インナー＆汗取り消臭】アウターに響かず夏も冬も快適な「神シルクトップス」5選',
    category: 'bodycare',
    categoryLabel: '👚 【神シルクインナー5選】汗取り消臭＆年中快適温活肌着特集',
    introText: '「夏場のワキ汗ジミやエアコンの汗冷えが気になる」「化繊の肌着だと背中がチクチク痒くなる」…最高級マルベリーシルク100%、脇汗パッド内蔵、襟ぐり深めのシームレス設計でブラウスやTシャツの下に着ても一切透けず・響かない楽天大人気シルクインナートップス5選を徹底解説！',
    items: [
      { id: 'art-silkinner-sowan-silk-short-sleeve-inner', keyword: 'SOWAN シルク インナー 半袖', label: '楽天1位独占！無縫製でアウターに響かない極上シルクの汗取りフレンチ袖' },
      { id: 'art-silkinner-pure-silk-sweat-pad-camisole', keyword: 'シルク 汗取り インナー レディース', label: '脇汗ジミを完全ブロック！吸放湿性抜群で一日中ワキサラサラをキープ' },
      { id: 'art-silkinner-seamless-silk-tank-top-rib', keyword: 'シルク100% タンクトップ', label: '贅沢な生糸100%リブ編み！敏感肌でも安心のアミノ酸スキンケア感覚インナー' },
      { id: 'art-silkinner-deep-v-neck-silk-french-sleeve', keyword: 'シルク インナー フレンチ袖', label: '胸元・背中が大きく開いた服でも見えない深Vネック！オフィス服にも最適' },
      { id: 'art-silkinner-silk-cotton-double-comfort-top', keyword: 'シルク 肌着 レディース 夏', label: '家庭用洗濯機で洗えるウォッシャブル仕様！デイリー使いに最適な高耐久シルク' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第32弾）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V32_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐにポイントメイクの極薄密着やシルクインナーによるワキ汗ジミ・汗冷え完全防止を実感できる高機能設計`,
          `毎日のベースメイクやオフィスのインナー習慣に無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'メイクツール＆シルクインナーアナリスト',
        summaryKeyPoints: [
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアメイクアップツール＆シルク肌着アナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第32弾特集記事および個別商品記事の完全追加が完了しました！`);
}
