...
def main():
    ...
    for sq in SEARCH_QUERIES:
        ...
        params = {
            ...
            'format': 'json',
            'hits': 30, # Get top 30
            'sort': '-reviewCount' # Sort by review count descending to get popular real items
        }
        ...
        try:
            ...
            for item_data in items:
                ...
                # clean up product name somewhat if it's too long
                ...
                if 'item.rakuten.co.jp' not in urllib.parse.unquote(affiliate_url):
                    # enforce strict direct item link rule
                    continue
