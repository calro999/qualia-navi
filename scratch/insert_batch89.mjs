...
const art1 = JSON.parse(fs.readFileSync('scratch/batch89_art1.json', 'utf-8'));
const art2 = JSON.parse(fs.readFileSync('scratch/batch89_art2.json', 'utf-8'));
const art3 = JSON.parse(fs.readFileSync('scratch/batch89_art3.json', 'utf-8'));
const art4 = JSON.parse(fs.readFileSync('scratch/batch89_art4.json', 'utf-8'));

const batch89 = [art1, art2, art3, art4];

for (const art of batch89) {
...
console.log('Batch 89 insertion complete!');
