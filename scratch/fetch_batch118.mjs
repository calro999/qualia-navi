...
const groups = [
  {
    id: "g1",
    keyword: "飲む日焼け止め サプリ ニュートロックスサン UV",
    slug: "art-inner-sunscreen-uv-care-supplement-10sen-2026",
    outFile: "scratch/rakuten_batch118_g1_verified.json"
  },
  {
    id: "g2",
    keyword: "カフェイン アイセラム 目元 美容液 目袋 クマ",
    slug: "art-caffeine-eye-serum-puffiness-dark-circles-10sen-2026",
    outFile: "scratch/rakuten_batch118_g2_verified.json"
  },
  {
    id: "g3",
    keyword: "低分子 コラーゲンパウダー ペプチド 無味無臭",
    slug: "art-low-molecular-collagen-peptide-powder-10sen-2026",
    outFile: "scratch/rakuten_batch118_g3_verified.json"
  },
  {
    id: "g4",
    keyword: "かかと 保湿 靴下 かかとケア つるつる ソックス",
    slug: "art-heel-moisturizing-silicone-socks-10sen-2026",
    outFile: "scratch/rakuten_batch118_g4_verified.json"
  }
];
