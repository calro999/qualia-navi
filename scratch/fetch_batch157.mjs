...
const queries = {
  t1: 'フェイススチーマー 美顔器 ナノケア 保湿',
  t2: 'リッププランパー ボリューム リップ',
  t3: 'ネイルオイル ペンタイプ 甘皮ケア',
  t4: 'ガラス かかとやすり 角質除去'
};
...
async function main() {
  ...
  fs.writeFileSync('scratch/batch157_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 157 products saved successfully to scratch/batch157_fetched.json!');
}
