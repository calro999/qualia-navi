...
// 祝！【全50大「5選まとめ特集メガハブ」】の完全金字塔達成！
const NEW_HALF_CENTURY_FEATURES = [
  // 特集①：【美顔スチーマー＆温冷エステ】毛穴を開いて汚れを浮かせ、濃密保湿する「神フェイススチーマー」5選
  {
    featureId: 'feature-5-facial-steamer-deep-hydration',
    title: '【2026年最新・楽天最安値】【美顔スチーマー＆温冷エステ】毛穴を開いて汚れを浮かせ、濃密保湿する「神フェイススチーマー」5選',
    category: 'device',
    categoryLabel: '⚡ 【神フェイススチーマー5選】自宅温冷エステ特集',
    introText: '「クレンジング前に毛穴をしっかり開いて黒ずみを浮かしたい」「毎日のスキンケア前にナノサイズ温スチームで肌を柔らかく整えたい」…ナノ温スチーム、冷ミスト、化粧水噴霧機能でサロン級の透明素肌を作る楽天大人気フェイススチーマー5選を徹底検証！',
    items: [
      { id: 'art-steamer-panasonic-nanocare', keyword: 'パナソニック スチーマー ナノケア', label: 'ナノサイズ濃密スチームで肌の奥までうるおいを浸透させる最高峰名品' },
      { id: 'art-steamer-yaman-photo-steamer', keyword: 'ヤーマン スチーマー フォトシャイン', label: 'W温スチーム×冷ミスト×5色LED光エステを搭載したエイジングケアスチーマー' },
      { id: 'art-steamer-salonia-pure-steamer', keyword: 'サロニア ピュアブライトスチーマー', label: '微粒子スチームと温冷ギャップで毛穴を引き締める高コスパスチーマー' },
      { id: 'art-steamer-twinbird-face-steamer', keyword: 'ツインバード フェイススチーマー', label: 'シンプル操作で毎日のクレンジング前に手軽に使えるロングセラースチーマー' },
      { id: 'art-steamer-festino-facial-moist', keyword: 'フェスティノ フェイシャル モイスト ナノスチーマー', label: 'コンパクトでおしゃれ！ナノ微粒子スチームで角質層まで潤す神スチーマー' }
    ]
  },
  // 特集②：【極上リップティント＆落ちないリップ】コップにつかない・乾燥しない「神落ちないティント」5選
  {
    featureId: 'feature-5-lip-tint-long-lasting',
    title: '【2026年最新・楽天最安値】【極上リップティント＆落ちないリップ】コップにつかない・乾燥しない「神落ちないティント」5選',
    category: 'makeup',
    categoryLabel: '💋 【神リップティント5選】落ちない＆色持ち最強特集',
    introText: '「食事をしてもコップに色移りせず塗りたての発色をキープしたい」「ティント特有の唇の乾燥や蛍光発色を防ぎたい」…ジェル膜リップ、水膜ティント、高保湿オイル配合で一日中美しい唇を保つ楽天売れ筋リップティント5選を徹底解説！',
    items: [
      { id: 'art-tint-kate-lip-monster', keyword: 'KATE リップモンスター 03', label: '唇から蒸発する水分を活用して密着ジェル膜を形成する歴史的モンスター' },
      { id: 'art-tint-romand-juicy-lasting', keyword: 'ロムアンド ジューシーラスティングティント', label: 'フルーツのようなジューシーな果汁発色とぷるぷるツヤ膜が続く韓国No.1ティント' },
      { id: 'art-tint-amuse-jel-fit-tint', keyword: 'アミューズ ジェルフィットティント', label: '12時間持続する密着ジェリーフィット！ぷにっとしたゼリー唇を演出' },
      { id: 'art-tint-bbia-glow-lip-tint', keyword: 'ピアー ローティント', label: '水のように軽やかなのにしっかりと密着し色落ちしない水光ティント' },
      { id: 'art-tint-cezanne-watery-lip-tint', keyword: 'セザンヌ ウォータリーティントリップ', label: '濡れたようなツヤ感と色持ちを両立する驚異のワンコイン神ティント' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による【祝！全50大メガ特集・完全金字塔達成記事】作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_HALF_CENTURY_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに極上のスチーム潤いや圧倒的な色持ち・ツヤ感を実感できる高機能設計`,
...
2. **肌や唇への優しさと持続性**: デリケートな状態でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'スチーマー＆リップティントアナリスト',
        summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得による【祝！全50大メガ特集・完全金字塔達成記事】および個別商品記事の完全追加が完了しました！`);
}
