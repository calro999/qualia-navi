...
const queries = {
  t1: 'ヘアシャドウ ヘアラインパウダー 生え際 薄毛隠し',
  t2: '足用石鹸 薬用 殺菌 消臭 足のニオイ',
  t3: '脇汗パッド 貼るだけ 汗ジミ防止 使い捨て',
  t4: 'ドライシャンプーシート 頭皮 拭き取り スッキリ'
};
...
async function main() {
  ...
  fs.writeFileSync('scratch/batch137_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 137 products saved successfully to scratch/batch137_fetched.json!');
}
