...
const NEW_TRANSCENDENCE_FEATURES = [
  // 特集①：【美肌クレンジングバーム＆とろける毛穴洗浄】ウォータープルーフも角栓もするんと落ちる「極上クレンジングバーム」5選
  {
    featureId: 'feature-5-cleansing-balm-pore-melting',
    title: '【2026年最新・楽天最安値】【美肌クレンジングバーム＆とろける毛穴洗浄】ウォータープルーフも角栓もするんと落ちる「極上クレンジングバーム」5選',
    category: 'skincare',
    categoryLabel: '🫧 【神クレンジングバーム5選】毛穴とろけ落ち特集',
    introText: '「頑固なマスカラやティントも摩擦レスでするんと落としたい」「洗い上がりのつっぱり感をなくして潤い美肌を守りたい」…体温でとろける濃厚バーム、植物オイル、角栓クリア成分配合で楽天市場売上上位を独占するクレンジングバーム5選を徹底検証！',
    items: [
      { id: 'art-balm-duo-cleansing-balm', keyword: 'DUO クレンジングバーム 黒', label: '薬用炭×発酵エキスで頑固な毛穴黒ずみを吸着洗浄する大ヒットバーム' },
      { id: 'art-balm-banila-co-clean-it', keyword: 'バニラコ クレンジングバーム', label: 'シャーベット状バームがオイルに変化し濃いメイクも瞬時に溶かす世界的大定番' },
      { id: 'art-balm-lu-lu-lun-cleansing-balm', keyword: 'ルルルン クレンジングバーム', label: 'エモリエントヴェール処方で洗い流した後もしっとり潤いが続く高保湿バーム' },
      { id: 'art-balm-ink-cleansing-balm', keyword: 'ink. クレンジングバーム', label: 'サロン技術から生まれた無添加＆高コスパな高純度クレンジングバーム' },
      { id: 'art-balm-shu-uemura-balm', keyword: 'クレンジングバーム 毛穴', label: '毛穴の奥深くに詰まった皮脂汚れをやさしく乳化して落とす極上バーム' }
    ]
  },
  // 特集②：【神コンシーラー＆トラブル消去】シミ・くま・ニキビ跡を厚塗り感ゼロでカバーする「魔法のコンシーラー」5選
  {
    featureId: 'feature-5-concealer-flawless-camouflage',
    title: '【2026年最新・楽天最安値】【神コンシーラー＆トラブル消去】シミ・くま・ニキビ跡を厚塗り感ゼロでカバーする「魔法のコンシーラー」5選',
    category: 'makeup',
    categoryLabel: '✨ 【神コンシーラー5選】シミ・くま完全消去特集',
    introText: '「頑固な青くまや濃いシミを自然に隠したい」「時間が経ってもシワに溜まらず乾燥崩れしないコンシーラーが欲しい」…3色ブレンドパレット、高密着リキッド、超微細ピグメントで素肌になりすます楽天大人気コンシーラー5選を徹底解説！',
    items: [
      { id: 'art-conceal-ipsa-creative-concealer', keyword: 'イプサ クリエイティブコンシーラーe', label: '光の反射で肌トラブルを同化させる！3色カスタムパレットの金字塔' },
      { id: 'art-conceal-the-saem-cover-perfection', keyword: 'ザセム チップコンシーラー', label: 'プチプラ最強のカバー力！ひと塗りでシミやニキビ跡を消し去る' },
      { id: 'art-conceal-dior-forever-skin-correct', keyword: 'ディオールスキン フォーエヴァー スキン コレクト コンシーラー', label: '美容液成分配合で一日中乾かずシワに入り込まない至高のリキッド' },
      { id: 'art-conceal-luna-long-lasting', keyword: 'LUNA コンシーラー', label: 'ウォーターラッピング処方でピタッと薄膜密着する韓国実力派' },
      { id: 'art-conceal-excel-silent-cover', keyword: 'エクセル サイレントカバー コンシーラー', label: '硬めのテクスチャーで狙ったトラブルをピタッと高密着カバー' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による「52大達成・最新5選まとめ特集記事」作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_TRANSCENDENCE_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに極上のメイク落ちや厚塗り感ゼロの完璧カバーを実感できる高機能設計`,
          `毎日のスキンケアやメイク習慣に無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'クレンジング＆ベースメイクアナリスト',
        summaryKeyPoints: [
    ...
    fetchedItems.forEach((it, idx) => {
      ...
      reviewBodyContent += `- **楽天実売価格**: ${it.rakuten.itemPrice}（星評価: ★${it.rakuten.reviewAverage} / 口口コミ: ${it.rakuten.reviewCount}件）\n\n`;
  ...
  console.log(`\n🎉 楽天API直接取得による「52大達成・最新5選まとめ特集記事」および個別商品記事の完全追加が完了しました！`);
}
