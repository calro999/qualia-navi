...
// ① クエリ：リップスクライナー リップペンシル 唇 輪郭 オーバーリップ, リップライナー 落ちない（唇の輪郭を1mmオーバーに縁取って中顔面短縮＆ぽってり立体リップを作るウォータープルーフリップライナー）
// ② クエリ：シルク 靴下 5本指 重ね履き 冷えとり かかとケア, 5本指 ソックス シルク（足指の間の汗やムレを吸収し、水虫やニオイを防ぎながら末端の冷えを芯から温める天然シルク5本指ソックス）
const NEW_PERIPHERAL_V30_FEATURES = [
  {
    featureId: 'feature-5-overlip-liner-plump-contour',
    title: '【2026年最新・楽天最安値】【オーバーリップライナー＆中顔面短縮・ぽってり輪郭】唇の薄さを解消して人中短縮を叶える「神リップペンシル」5選',
    category: 'makeup',
    categoryLabel: '💋 【神オーバーリップライナー5選】人中短縮＆ぽってり輪郭形成特集',
    introText: '「唇が薄くて幸薄そうに見える」「中顔面を短く見せてトレンドのぽってりリップを作りたい」…なめらかな極細クレヨン芯、自然な影色・粘膜拡張カラー、擦っても落ちないウォータープルーフ処方で素の唇を自然にボリュームアップする楽天売れ筋リップライナー5選を徹底検証！',
    items: [
      { id: 'art-lipliner-heart-percent-doute-pencil', keyword: 'ハートパーセント リップライナー', label: '韓国オーバーリップブームの火付け役！絶妙な粘膜カラーで人中短縮リップが簡単に完成' },
      { id: 'art-lipliner-colorgram-all-in-one-overlip', keyword: 'カラーグラム オーバーリップ', label: 'オリーブヤング大ヒット！シェーディングとベースカラーが1本になった神ペンシル' },
      { id: 'art-lipliner-kate-lip-monster-liner', keyword: 'ケイト リップシェイプライナー', label: '落ちにくさ最強！唇の輪郭を補正してぷっくり立体感を持続させる定番' },
      { id: 'art-lipliner-cezanne-lip-pencil-waterproof', keyword: 'セザンヌ リップライナー', label: 'スルスル描ける高発色！にじまず輪郭をキープする高コスパ名品' },
      { id: 'art-lipliner-bbia-last-auto-gel-eyeliner-lip', keyword: 'ピアー リップライナー', label: '驚きの密着力！飲食しても消えない強力ウォータープルーフリップライナー' }
    ]
  },
  {
    featureId: 'feature-5-silk-five-toe-socks-cold-care',
    title: '【2026年最新・楽天最安値】【最高級シルク100% 5本指ソックス＆足指冷えとり・ムレ防止】足先の冷えとニオイを根本から撃退する「神シルク靴下」5選',
    category: 'bodycare',
    categoryLabel: '🧦 【神シルク5本指靴下5選】足指ムレ防止＆冷えとり温活特集',
    introText: '「冬だけでなく夏も足指が汗で冷えて冷たい」「ブーツやパンプスを脱いだ時の足のニオイが気になる」…天然生糸100%、吸湿性・放湿性抜群の5本指立体編み、重ね履きインナーソックス設計で指の間の汗を瞬間吸収し一日中サラサラ温活を保つ楽天大人気シルク5本指ソックス5選を徹底解説！',
    items: [
      { id: 'art-silksock-sowan-silk-five-toe-inner', keyword: 'SOWAN シルク 5本指 ソックス', label: '楽天1位独占！靴下の中に履くだけでムレと冷えを完全防止する大ヒットインナー靴下' },
      { id: 'art-silksock-pure-silk-heel-care-5toe', keyword: 'シルク 5本指 靴下 かかとケア', label: 'かかと保湿シート内蔵！足指のムレを防ぎながらガサガサかかとも同時にケア' },
      { id: 'art-silksock-silk-cotton-stack-cold-cure', keyword: '冷え取り靴下 シルク 5本指', label: '天然シルク×コットンの冷えとり重ね履き！足先からポカポカ温まる本格温活' },
      { id: 'art-silksock-invisible-silk-five-toe-ped', keyword: 'シルク 5本指 カバーソックス 浅履き', label: 'パンプスから見えない極浅設計！靴擦れ防止＆足汗ブロック' },
      { id: 'art-silksock-ribbed-ankle-silk-warm-sock', keyword: '5本指 ソックス シルク 100%', label: '足首までゆったり包み込む！締め付け感ゼロで血行を妨げない快適設計' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第30弾）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V30_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに人中短縮ぽってり唇の形成やシルク5本指靴下による足指サラサラ温活・ニオイ解消を実感できる高機能設計`,
          `毎日のリップメイクや日常の足元フットケアルーティンに無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'リップメイク＆フット温活アナリスト',
        summaryKeyPoints: [
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアリップメイク＆フットケアアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第30弾特集記事および個別商品記事の完全追加が完了しました！`);
}
