...
const NEW_ASGARD_FEATURES = [
  // 特集①：【美髪ヒートブラシ＆寝癖直しアイロン】とかすだけでサラツヤストレート！忙しい朝の「神ヒートブラシ」5選
  {
    featureId: 'feature-5-straightening-hair-brush',
    title: '【2026年最新・楽天最安値】【美髪ヒートブラシ＆寝癖直しアイロン】とかすだけでサラツヤストレート！忙しい朝の「神ヒートブラシ」5選',
    category: 'device',
    categoryLabel: '💇‍♀️ 【神ヒートブラシ5選】とかすだけ寝癖直し特集',
    introText: '「朝起きたときの頑固な寝癖や爆発したうねりを60秒で直したい」「アイロンで火傷するのが怖くてブラッシング感覚でストレートにしたい」…マイナスイオン噴射、セラミックコーティングピン、急速加熱でとかすだけでサロン級のツヤストレートを作る楽天売れ筋ヒートブラシ5選を徹底検証！',
    items: [
      { id: 'art-brush-salonia-straight-heat-brush', keyword: 'サロニア ストレートヒートブラシ', label: '2分でサラツヤ髪へ！ブラッシング感覚で寝癖とうねりを瞬時に整える爆売れ機' },
      { id: 'art-brush-lement-deep-straight-brush', keyword: 'ルメント ストレートヒートブラシ', label: '遠赤外線×マイナスイオンで髪の潤いを閉じ込めながらシルクストレート' },
      { id: 'art-brush-daga-hair-straightener-brush', keyword: 'ヒートブラシ ヘアアイロン マイナスイオン', label: '高濃度マイナスイオンと火傷防止ダブルピン設計で安全にまとまり髪へ' },
      { id: 'art-brush-areti-straight-brush-iron', keyword: 'アレティ ストレート ブラシアイロン', label: '最高温度200℃まで急速加熱！ショートヘアでも前髪でも使いやすいミニ設計' },
      { id: 'art-brush-koizumi-cordless-heat-brush', keyword: 'コイズミ コードレス ヒートブラシ', label: '充電式コードレスで雨の日の外出先やオフィスでもサッと美髪リセット' }
    ]
  },
  // 特集②：【極上リップバーム＆高保湿ナイトケア】ガサガサ皮むけを一晩でぷるぷるに集中リペアする「神リップバーム」5選
  {
    featureId: 'feature-5-intensive-moisture-lip-balm',
    title: '【2026年最新・楽天最安値】【極上リップバーム＆高保湿ナイトケア】ガサガサ皮むけを一晩でぷるぷるに集中リペアする「神リップバーム」5選',
    category: 'skincare',
    categoryLabel: '💋 【神リップバーム5選】高保湿集中リペア特集',
    introText: '「リップクリームを何度塗ってもすぐに乾燥して皮がむけてしまう」「寝る前の濃厚ラップで翌朝ふっくら柔らかい唇にしたい」…天然ミツロウ、高純度ワセリン、シアバター、ヒト型セラミド配合でひび割れや皮むけを根底から救う楽天大人気リップバーム5選を徹底解説！',
    items: [
      { id: 'art-balm-nivea-deep-moisture-night', keyword: 'ニベア ディープモイスチャー ナイトプロテクト', label: '濃厚バームが唇を密封し一晩中うるおいを閉じ込める国民的ナイトリップ' },
      { id: 'art-balm-locobase-repair-lip-cream', keyword: 'ロコベースリペア リップクリーム', label: '防腐剤無添加！皮膚バリア機能をサポートする硬め高密着リップ' },
      { id: 'art-balm-dior-lip-glow-oil', keyword: 'ディオール アディクト リップ グロウ オイル', label: 'チェリーオイル配合で唇を贅沢に保護しながら極上のツヤと血色を与える' },
      { id: 'art-balm-kiehls-lip-balm-number1', keyword: 'キールズ リップバーム No.1', label: 'スクワランやアロエベラエキス配合で乾燥した唇をしっとり柔らかく保つ名品' },
      { id: 'art-balm-shiseido-moilip-medicated', keyword: 'モアリップ 薬用 リップ', label: 'アラントイン・ビタミンE配合で唇のひび割れ・皮むけ・口角炎を治療する医薬品' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による「66大達成・最新5選まとめ特集記事」作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_ASGARD_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに極上のブラッシングストレートや一晩でふっくらプルプルの唇を実感できる高機能設計`,
          `毎日の朝のスタイリングやナイトリップ習慣に無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'ヒートブラシ＆リップケアアナリスト',
        summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得による「66大達成・最新5選まとめ特集記事」および個別商品記事の完全追加が完了しました！`);
}
