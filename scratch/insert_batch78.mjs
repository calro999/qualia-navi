...
const art1 = JSON.parse(fs.readFileSync('scratch/batch78_art1.json', 'utf-8'));
const art2 = JSON.parse(fs.readFileSync('scratch/batch78_art2.json', 'utf-8'));
const art3 = JSON.parse(fs.readFileSync('scratch/batch78_art3.json', 'utf-8'));
const art4 = JSON.parse(fs.readFileSync('scratch/batch78_art4.json', 'utf-8'));

const batch78 = [art1, art2, art3, art4];

for (const art of batch78) {
...
console.log('Batch 78 insertion complete!');
