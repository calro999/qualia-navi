...
const queries = {
  t1: 'ハンドマスク 手袋 手肌 パック',
  t2: 'ハンドマッサージャー 手 温熱',
  t3: 'ファンデーションブラシ 歯ブラシ型 密着',
  t4: '足裏 樹液シート むくみ デトックス'
};
...
async function main() {
  ...
  fs.writeFileSync('scratch/batch165_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 165 products saved successfully to scratch/batch165_fetched.json!');
}
