...
console.log('🚀 [楽天API 直接取得 Batch7] 超高需要ロングテール5テーマの商品データを取得開始...');
...
const themes = [
  {
    key: 'lip_coat_gel',
    searchKeywords: ['リップコート 口紅 落ちない', 'リップ ジェル マジック コーセー', '口紅 コート マスクにつかない', 'リップ シールド トップコート']
  },
  {
    key: 'double_eyelid_shadow_liner',
    searchKeywords: ['セザンヌ 描くふたえアイライナー', '二重強調 ライナー 影色', '涙袋 影 ライナー ケイト', 'ダブルライン エキスパート KATE']
  },
  {
    key: 'face_wash_foaming_net',
    searchKeywords: ['バルクオム 泡立てネット', '洗顔 泡立てネット 4重構造', '濃密泡 洗顔ネット モコモコ', '泡立てネット 洗顔 無印']
  },
  {
    key: 'heel_care_socks',
    searchKeywords: ['かかと 保湿 靴下 ガサガサ', 'かかとケア ソックス シルク', 'かかと つるつる 靴下 角質', 'かかと ひび割れ シリコン 靴下']
  },
  {
    key: 'micro_brow_mascara',
    searchKeywords: ['デジャヴュ フィルム眉カラー', '極細 眉マスカラ ロムアンド', '眉マスカラ 極細ブラシ アッシュ', 'ヘビーローテーション 眉マスカラ']
  }
];
...
async function main() {
  ...
  fs.writeFileSync('scratch_longtail_batch7_rakuten_items.json', JSON.stringify(results, null, 2), 'utf-8');
  console.log('\n🎉 全商品の取得が完了し、scratch_longtail_batch7_rakuten_items.json に保存しました！');
}
