...
async function main() {
  const keyword = "目元 美容液 ロールオン アイセラム クマ";
  ...
  fs.writeFileSync("scratch/rakuten_batch118_g2_verified.json", JSON.stringify(items, null, 2));
  console.log(`Saved ${items.length} items to scratch/rakuten_batch118_g2_verified.json`);
}
