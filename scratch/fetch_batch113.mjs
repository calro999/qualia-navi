...
const groups = [
  {
    id: "g1",
    keyword: "グルタチオン トラネキサム酸 美容液",
    slug: "art-glutathione-tranexamic-acid-whitening-serum-10sen-2026",
    outFile: "scratch/rakuten_batch113_g1_verified.json"
  },
  {
    id: "g2",
    keyword: "RF美顔器 ラジオ波 エレクトロポレーション たるみ",
    slug: "art-rf-electroporation-lift-device-10sen-2026",
    outFile: "scratch/rakuten_batch113_g2_verified.json"
  },
  {
    id: "g3",
    keyword: "ヘマチン ケラチン シャンプー ハリコシ",
    slug: "art-hematin-keratin-scalp-repair-shampoo-10sen-2026",
    outFile: "scratch/rakuten_batch113_g3_verified.json"
  },
  {
    id: "g4",
    keyword: "テラコッタ アイシャドウ リップ イエベ秋",
    slug: "art-warm-autumn-wave-terracotta-cinnamon-makeup-10sen-2026",
    outFile: "scratch/rakuten_batch113_g4_verified.json"
  }
];
