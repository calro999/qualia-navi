...
async function main() {
  await fetchG("g3", "ヘアミルク トリートメント 洗い流さない 美容液", "scratch/rakuten_batch112_g3_verified.json");
  await sleep(1500);
  await fetchG("g4", "モーブ アイシャドウ ブルベ ローズ リップ", "scratch/rakuten_batch112_g4_verified.json");
}
