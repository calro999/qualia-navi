...
// ① クエリ：夜用 リップスリーピングマスク 縦ジワ 唇荒れ ぷるぷる, 唇 パック 保湿（寝ている間にカサカサ唇の皮剥け・縦ジワを角質集中ケアする濃厚リップスリーピングマスク）
// ② クエリ：ヘアウォーター 寝癖直し ミスト さらさら 保湿, ブローローション 熱保護（朝の頑固なハネや寝癖を瞬時にリセットしドライヤーの熱から髪を守るヘアミストウォーター）
const NEW_PERIPHERAL_V14_FEATURES = [
  {
    featureId: 'feature-5-lip-sleeping-mask-overnight',
    title: '【2026年最新・楽天最安値】【夜用リップスリーピングマスク＆縦ジワ・皮剥け消滅】寝ている間にぷるぷる赤ちゃん唇へ導く「神リップパック」5選',
    category: 'skincare',
    categoryLabel: '👄 【神リップスリーピングマスク5選】唇荒れ・縦ジワ＆夜用保湿特集',
    introText: '「冬だけでなく一年中唇が乾燥して皮がめくれる」「リップクリームを何度塗り直しても縦ジワが目立つ」…ベリーフルーツコンプレックス、高純度シアバター、セラミド、ビタミンC誘導体配合で寝ている間に古い角質を溶かしふっくら濃密保湿する楽天売れ筋リップマスク5選を徹底検証！',
    items: [
      { id: 'art-lipmask-laneige-lip-sleeping-mask', keyword: 'ラネージュ リップスリーピングマスク', label: '世界中で1秒に1個売れる大定番！翌朝ぷるんとした赤ちゃん唇に生まれ変わる絶対王者' },
      { id: 'art-lipmask-tatcha-kissu-lip-mask', keyword: 'リップスリーピングマスク 保湿', label: '濃厚なテクスチャーが一晩中密着！カサカサの唇の皮剥けをリセットする高機能マスク' },
      { id: 'art-lipmask-choosy-night-lip-pack', keyword: 'チューシー リップパック', label: '唇専用ハイドロゲルパック！ピタッと密着してプルプルの弾力唇を即効チャージ' },
      { id: 'art-lipmask-vaseline-lip-therapy-rosy', keyword: 'ヴァセリン リップ モイストシャイン', label: 'ピュアスキンゼリー高純度ワセリン配合！プチプラで惜しみなく使える夜用定番' },
      { id: 'art-lipmask-klavuu-nourishing-care-lip', keyword: 'リップ 美容液 夜用 唇 パック', label: '植物性オイルと高保湿成分が寝ている間に密着浸透して縦ジワをふっくら押し上げる' }
    ]
  },
  {
    featureId: 'feature-5-hair-mist-bedhead-reset-heat-protect',
    title: '【2026年最新・楽天最安値】【寝癖直しヘアミスト＆ヒートプロテクト】頑固な寝癖を10秒リセット！アイロンの熱ダメージを防ぐ「神ヘアウォーター」5選',
    category: 'haircare',
    categoryLabel: '💧 【神寝癖直しヘアミスト5選】瞬間リセット＆熱ダメージ保護特集',
    introText: '「朝起きると髪が爆発して水では直らない」「毎朝ヘアアイロンを使うので熱による毛先のチリつきが怖い」…浸透補修ウォーター、熱を味方にするヒートリペア成分、アミノ酸・加水分解シルク配合で瞬時に素直なストレート美髪へ整える楽天大人気ヘアミスト5選を徹底解説！',
    items: [
      { id: 'art-hairmist-repa-heat-protect-mist', keyword: 'リファ ロックオイル ライト ミスト', label: 'アイロン前の新常識！熱に反応してカールやストレートを崩さずツヤ髪をキープ' },
      { id: 'art-hairmist-ma-cherie-perfect-shower', keyword: 'マシェリ パーフェクトシャワー', label: '濃密パールハニージュレ配合！頑固な寝癖を素早く直して一日中いい香りが続く' },
      { id: 'art-hairmist-orbis-hair-water', keyword: 'オルビス トリートメントヘアウォーター', label: '無香料で使いやすい！ひと吹きでパサつく髪をサラサラの指通りに整える実力派' },
      { id: 'art-hairmist-lebel-trie-juicy-spray', keyword: '寝癖直し ウォーター スプレー 保湿', label: '微粒子ミストが髪の奥まで素早く浸透し、ブロー時間を劇的に短縮するサロン品質' },
      { id: 'art-hairmist-botanist-botanical-hair-water', keyword: 'ヘアミスト 洗い流さない さらさら', label: 'ボタニカル成分配合で静電気を防ぎ、ドライヤーの熱からキューティクルをガード' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第14弾）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V14_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに唇のぷるぷる感や朝の寝癖瞬時リセット＆熱ガードを実感できる高機能設計`,
          `毎晩のナイトケアや朝のスタイリングルーティンに無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'リップケア＆ヘアスタイリングアナリスト',
        summaryKeyPoints: [
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアリップ＆スタイリングアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第14弾特集記事および個別商品記事の完全追加が完了しました！`);
}
