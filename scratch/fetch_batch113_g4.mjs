...
async function main() {
  const keyword = "テラコッタ アイシャドウ パレット";
  ...
  fs.writeFileSync("scratch/rakuten_batch113_g4_verified.json", JSON.stringify(items, null, 2));
  console.log(`Saved ${items.length} items to scratch/rakuten_batch113_g4_verified.json`);
}
