...
// ① クエリ：リップスクラブ シュガー 角質ケア 唇 縦ジワ, 唇の皮剥け スクラブ スティック（不要な古い角質をやさしくオフして血色感とぷるぷるツヤを取り戻すリップスクラブ）
// ② クエリ：頭皮用 日焼け止め パウダー 髪のテカリ防止, ポンポン スカルプパウダー 前髪（頭皮の日焼けを防ぎながら汗・皮脂でペタンコになった前髪をサラサラに復活させるパウダー）
const NEW_PERIPHERAL_V15_FEATURES = [
  {
    featureId: 'feature-5-sugar-lip-scrub-exfoliator',
    title: '【2026年最新・楽天最安値】【シュガーリップスクラブ＆唇の角質・縦ジワオフ】洗い流し不要！ひと塗りでぷるんと血色感が蘇る「神リップスクラブ」5選',
    category: 'skincare',
    categoryLabel: '👄 【神リップスクラブ5選】シュガー角質ケア＆唇くすみオフ特集',
    introText: '「リップを塗ると唇の皮がめくれてムラになる」「くすんだ唇の血色感を明るくしたい」…砂糖の微粒子スクラブ、高保湿フルーツオイル、洗い流し不要のスティックタイプで角質ケアとプランパー効果を両立する楽天売れ筋リップスクラブ5選を徹底検証！',
    items: [
      { id: 'art-lipscrub-revlon-kiss-sugar-scrub', keyword: 'レブロン キス シュガー スクラブ', label: '国民的バズりコスメ！塗るだけで角質ケアと保湿が完了する洗い流し不要の神スティック' },
      { id: 'art-lipscrub-canmake-plump-lip-care', keyword: 'キャンメイク プランプリップケアスクラブ', label: 'プランパー効果で唇ふっくら！いつでも手軽に使える高コスパ殿堂入りアイテム' },
      { id: 'art-lipscrub-lush-bubblegum-lip-scrub', keyword: 'ラッシュ リップスクラブ', label: '甘い香りとお砂糖の粒で至福のリップケア！古い角質を落としてやわらか唇へ' },
      { id: 'art-lipscrub-dior-lip-sugar-scrub', keyword: 'リップスクラブ スティック', label: '体温でとろけるシュガー粒子！ほんのりピンクに発色する贅沢ケア' },
      { id: 'art-lipscrub-innisfree-lip-scrub', keyword: '唇 角質ケア スクラブ', label: '天然由来のスクラブ成分でデリケートな唇をやさしく磨き上げる人気品' }
    ]
  },
  {
    featureId: 'feature-5-scalp-powder-oil-control-bangs',
    title: '【2026年最新・楽天最安値】【スカルプパウダー＆前髪ペタンコ・頭皮テカリ瞬時リセット】汗・皮脂のベタつきを消してふんわり立ち上げる「神前髪ポンポンパウダー」5選',
    category: 'haircare',
    categoryLabel: '✨ 【神前髪ポンポンパウダー5選】頭皮テカリ防止＆ふんわり復活特集',
    introText: '「夕方になると汗や皮脂でおでこに前髪が張り付く」「頭皮のニオイやベタつきを外出先でサッと直したい」…皮脂吸着ミネラルパウダー、頭皮ケアエキス、ポンポンするだけの簡単パフ一体型容器で一瞬で朝のふんわりサラサラ前髪を取り戻す楽天大人気スカルプパウダー5選を徹底解説！',
    items: [
      { id: 'art-scalppowder-fujiko-fpp-oil-block', keyword: 'フジコ FPPパウダー', label: '元祖ポンポンパウダー！頭皮と前髪の油分を吸収して一瞬でサラふわ髪にする大ヒット' },
      { id: 'art-scalppowder-innisfree-no-sebum-powder', keyword: 'イニスフリー ノーセバム ミネラルパウダー', label: '顔だけでなく前髪にも使える！皮脂をコントロールする韓国コスメの超定番' },
      { id: 'art-scalppowder-canmake-oil-block-powder', keyword: 'キャンメイク オイルブロックパウダー', label: 'サラサラ肌と前髪キープを同時に叶えるプチプラ最強の皮脂吸着パウダー' },
      { id: 'art-scalppowder-shiseido-scalp-oil-reset', keyword: '前髪 パウダー ポンポン サラサラ', label: '微粒子パウダーが汗や皮脂を吸着してふんわりエアリーな立ち上がりをキープ' },
      { id: 'art-scalppowder-dian-hair-oil-block', keyword: '頭皮 パウダー 皮脂 テカリ防止', label: '気になる頭皮のニオイとベタつきを同時にカバーする持ち歩きスカルプパウダー' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第15弾）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V15_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに唇のぷるぷる角質ケアや前髪のふんわりサラサラ復活を実感できる高機能設計`,
          `毎日の持ち歩きやメイク直しの瞬間に無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'リップ＆スカルプパウダーアナリスト',
        summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第15弾特集記事および個別商品記事の完全追加が完了しました！`);
}
