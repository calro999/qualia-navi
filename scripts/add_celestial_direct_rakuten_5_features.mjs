...
const NEW_CELESTIAL_FEATURES = [
  // 特集①：【美髪速乾＆大風量ヘアドライヤー】熱ダメージを抑えて驚きの速乾・美ツヤを叶える「神ヘアドライヤー」5選
  {
    featureId: 'feature-5-hair-dryer-fast-drying-shine',
    title: '【2026年最新・楽天最安値】【美髪速乾＆大風量ヘアドライヤー】熱ダメージを抑えて驚きの速乾・美ツヤを叶える「神ヘアドライヤー」5選',
    category: 'device',
    categoryLabel: '💇‍♀️ 【神ヘアドライヤー5選】大風量速乾＆美髪ツヤ特集',
    introText: '「ロングヘアを5分以内で乾かしたい」「熱風で髪がパサパサに傷むのを防ぎサロン帰りのツヤとしっとり感を手に入れたい」…ナノイー、高浸透イオン、大風量インテリジェントモーター搭載で楽天市場売上上位を独占する神ヘアドライヤー5選を徹底検証！',
    items: [
      { id: 'art-dryer-panasonic-nanocare-moist', keyword: 'パナソニック ヘアードライヤー ナノケア', label: '高浸透ナノイー＆ミネラルで髪の内側まで潤いを届ける国民的最高峰ドライヤー' },
      { id: 'art-dryer-dyson-supersonic', keyword: 'ダイソン ドライヤー Supersonic', label: '圧倒的な超大風量とインテリジェントヒートコントロールで速乾とツヤを両立' },
      { id: 'art-dryer-refa-beautech-dryer-smart', keyword: 'リファ ビューテック ドライヤースマート', label: 'プロセンシング機能で頭皮と毛先の温度を自動制御しレア髪を作る' },
      { id: 'art-dryer-kinujo-hair-dryer', keyword: 'KINUJO ヘアドライヤー', label: '超軽量363g＆超遠赤外線テクノロジーで速乾とシルクのような指通りを実現' },
      { id: 'art-dryer-salonia-speedy-ion', keyword: 'サロニア スピーディーイオンドライヤー', label: '大風量2.3m³/分＆マイナスイオン搭載の驚異的高コスパ大人気ドライヤー' }
    ]
  },
  // 特集②：【極上リッププランパー＆縦ジワ消去】ピリピリ刺激で唇ふっくら！ボリュームと血色感を底上げする「神リッププランパー」5選
  {
    featureId: 'feature-5-lip-plumper-volume-boost',
    title: '【2026年最新・楽天最安値】【極上リッププランパー＆縦ジワ消去】ピリピリ刺激で唇ふっくら！ボリュームと血色感を底上げする「神リッププランパー」5選',
    category: 'makeup',
    categoryLabel: '💋 【神リッププランパー5選】ふっくら唇ボリュームアップ特集',
    introText: '「薄い唇を自然にふっくらボリュームアップさせたい」「唇の気になる縦ジワを消してプルプルのガラスツヤを作りたい」…カプサイシン、生コラーゲン、ヒアルロン酸配合で魅惑的なぷっくり唇を作る楽天大人気リッププランパー5選を徹底解説！',
    items: [
      { id: 'art-plump-dior-maximizer', keyword: 'ディオール アディクト リップ マキシマイザー', label: 'ヒアルロン酸と海洋性コラーゲン配合で唇をふっくら整えるプランパーの代名詞' },
      { id: 'art-plump-keybo-grand-master', keyword: 'キボ リッププランパー', label: '強烈なピリピリ感で瞬時に驚きのメガボリューム唇を作る韓国バズプランパー' },
      { id: 'art-plump-borica-lip-plumper', keyword: 'ボリカ リッププランパー エクストラセラム', label: '美容液成分贅沢配合で縦ジワを瞬時にカバーしぷるぷるの潤いを持続' },
      { id: 'art-plump-tirtir-my-glow-lip-oil', keyword: 'TIRTIR マイグロウ リップオイル', label: '高保湿オイル膜でぷっくりボリュームと自然な血色感を与えるプランパー' },
      { id: 'art-plump-cezanne-lip-collagen', keyword: 'プランパー リップ コラーゲン', label: '日常使いに心地よい清涼感とふっくらハリ感を与える高コスパプランパー' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による「62大達成・最新5選まとめ特集記事」作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_CELESTIAL_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに驚きの速乾ツヤや唇のふっくら立体ボリュームを実感できる高機能設計`,
          `毎日のドライヤータイムやメイク習慣に無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'ヘアドライヤー＆リッププランパーアナリスト',
        summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得による「62大達成・最新5選まとめ特集記事」および個別商品記事の完全追加が完了しました！`);
}
