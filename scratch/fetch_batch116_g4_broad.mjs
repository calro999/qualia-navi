...
async function main() {
  ...
  fs.writeFileSync("scratch/rakuten_batch116_g4_verified.json", JSON.stringify(items, null, 2));
  console.log(`Saved ${items.length} items to scratch/rakuten_batch116_g4_verified.json`);
}
