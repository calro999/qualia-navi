...
const NEW_APEX_FEATURES = [
  // 特集①：【美髪ストレート＆ヘアアイロン】熱ダメージを抑えてツヤサラ絹髪を作る「神ストレートアイロン」5選
  {
    featureId: 'feature-5-hair-straightener-silk-shine',
    title: '【2026年最新・楽天最安値】【美髪ストレート＆ヘアアイロン】熱ダメージを抑えてツヤサラ絹髪を作る「神ストレートアイロン」5選',
    category: 'device',
    categoryLabel: '💇‍♀️ 【神ヘアアイロン5選】美髪ストレート＆ツヤ特集',
    introText: '「くせ毛やうねりを一瞬でサラサラのストレートに伸ばしたい」「毎日のアイロンによる熱ダメージや髪のパサつきを極限まで抑えたい」…シルクプレート、水分保持カーボンレイヤー、バイオプログラミングでサロン帰りの絹ツヤ髪を作る楽天売れ筋ヘアアイロン5選を徹底検証！',
    items: [
      { id: 'art-iron-refa-straight-iron-pro', keyword: 'リファ ストレートアイロン プロ', label: 'カーボンレイヤープレートで水・熱・圧のダメージを抑えてレア髪ストレートへ' },
      { id: 'art-iron-kinujo-silk-plate', keyword: 'KINUJO ストレートヘアアイロン', label: '220℃でも水分が蒸発しない特殊シルクプレートで極上のツヤと潤いをキープ' },
      { id: 'art-iron-salonia-smooth-shine', keyword: 'サロニア ストレートヘアアイロン', label: '立ち上がり30秒！圧倒的コスパと使いやすさで爆売れし続ける国民的大定番' },
      { id: 'art-iron-panasonic-nanocare-iron', keyword: 'パナソニック ストレートアイロン ナノケア', label: 'ナノイーが髪に水分を与えながらキューティクルを引き締めしっとりまとまる' },
      { id: 'art-iron-hairbeauron-4d-plus', keyword: 'ヘアビューロン 4D Plus ストレート', label: '使えば使うほど髪が美しくなると話題のバイオプログラミング最高峰アイロン' }
    ]
  },
  // 特集②：【極上酵素洗顔パウダー＆角栓溶かし】週1〜2回のスペシャルケアで黒ずみ・ザラつきを消し去る「神酵素洗顔」5選
  {
    featureId: 'feature-5-enzyme-face-wash-powder',
    title: '【2026年最新・楽天最安値】【極上酵素洗顔パウダー＆角栓溶かし】週1〜2回のスペシャルケアで黒ずみ・ザラつきを消し去る「神酵素洗顔」5選',
    category: 'skincare',
    categoryLabel: '🫧 【神酵素洗顔5選】角栓分解＆つるすべ肌特集',
    introText: '「通常の洗顔では落としきれない頑固な角栓やザラつきを解消したい」「小鼻やあご下の毛穴の黒ずみを酵素の力で優しく分解したい」…タンパク分解酵素、皮脂分解酵素、炭・クレイ配合で洗うたびに透明感あふれるつるすべ陶器肌を叶える楽天大人気酵素洗顔パウダー5選を徹底解説！',
    items: [
      { id: 'art-enzyme-obagi-c-powder-wash', keyword: 'オバジC 酵素洗顔パウダー', label: 'ピュアビタミンC×2つの酵素で毛穴の黒ずみ・角栓・ザラつきを一網打尽' },
      { id: 'art-enzyme-suisai-beauty-clear', keyword: 'スイサイ ビューティクリア パウダーウォッシュ', label: 'アミノ酸系洗浄成分と2つの酵素でつっぱり感なく毛穴汚れをごっそり落とす' },
      { id: 'art-enzyme-fancl-deep-clear-powder', keyword: 'ファンケル ディープクリア 洗顔パウダー', label: '酵素×炭×吸着泥の真っ黒な濃密もっちり泡で毛穴をごっそり大掃除' },
      { id: 'art-enzyme-kanebo-scrubbing-wash', keyword: 'カネボウ クラリファイング パウダー ウォッシュ', label: '2種のパウダーが肌の上で混ざり合い磨き上げたようなクリアな肌へ導く' },
      { id: 'art-enzyme-minon-clear-wash-powder', keyword: 'ミノン クリアウォッシュ パウダー', label: '敏感肌でも安心！肌のバリア機能を守りながら不要な角質だけを優しくオフ' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による「58大達成・最新5選まとめ特集記事」作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_APEX_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐにサロン級のツヤサラ感や毛穴のつるつる感を実感できる高機能設計`,
          `毎日のヘアセットや週数回のスペシャル洗顔習慣に無理なく組み込める快適な使用感・高い満足度`,
...
2. **髪や素肌への優しさと持続性**: デリケートな状態でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
  ...
  console.log(`\n🎉 楽天API直接取得による「58大達成・最新5選まとめ特集記事」および個別商品記事の完全追加が完了しました！`);
}
