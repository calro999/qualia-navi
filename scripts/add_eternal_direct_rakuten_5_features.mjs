...
const NEW_ETERNAL_FEATURES = [
  // 特集①：【毛穴クレイ＆泥パック】頑固な黒ずみ・角栓・ザラつきを一網打尽にする「極上クレイパック」5選
  {
    featureId: 'feature-5-clay-mask-pore-purifying',
    title: '【2026年最新・楽天最安値】【毛穴クレイ＆泥パック】頑固な黒ずみ・角栓・ザラつきを一網打尽にする「極上クレイパック」5選',
    category: 'skincare',
    categoryLabel: '🫧 【毛穴クレイ5選】泥パック＆角栓大掃除特集',
    introText: '「鼻やあごのザラつき・黒ずみ角栓を一度でスッキリ大掃除したい」「お肌をつっぱらせずに毛穴を引き締めたい」…海泥（タナクラクレイ）、モロッコ溶岩クレイ、沖縄マリンシルト配合で透明ツルスベ肌を作る楽天売れ筋クレイマスク5選を徹底検証！',
    items: [
      { id: 'art-clay-argital-green-clay-paste', keyword: 'アルジタル グリーンクレイペースト', label: 'シチリア島海泥のミネラルで古い角質と毛穴汚れを吸着する世界的名品' },
      { id: 'art-clay-ghassoul-clay-powder', keyword: 'ナイアード ガスール 粉末', label: 'モロッコ溶岩クレイ100%！顔も髪も全身ツルスベに洗い上げる天然泥' },
      { id: 'art-clay-ipsa-luminizing-clay', keyword: 'イプサ クレイ エクスペリエンス', label: '乾いた肌にも濡れた肌にも使える吸着洗浄＆マッサージクレイ' },
      { id: 'art-clay-kanebo-scrubbing-mud', keyword: 'カネボウ スクラビング マッド ウォッシュ', label: '3段階の質感変化で毛穴汚れを崩壊吸着するバズり洗顔泥ペースト' },
      { id: 'art-clay-mud-soap-marine-silt', keyword: 'どろあわわ 洗顔', label: '沖縄マリンシルト×国産ベントナイトの濃密弾力泡で毛穴を密着洗浄' }
    ]
  },
  // 特集②：【神チーク＆多幸感血色】くすみを飛ばして内側からジュワッと発光する「落ちない血色チーク」5選
  {
    featureId: 'feature-5-blush-radiant-cheeks',
    title: '【2026年最新・楽天最安値】【神チーク＆多幸感血色】くすみを飛ばして内側からジュワッと発光する「落ちない血色チーク」5選',
    category: 'makeup',
    categoryLabel: '🌸 【多幸感神チーク5選】血色感＆ツヤ肌特集',
    introText: '「夕方になると顔色が悪く見える」「マスクを外しても落ちずに内側からにじみ出るような多幸感フェイスを作りたい」…微細パールパウダー、密着リキッド、ジュワッと発色の神チーク5選を徹底解説！',
    items: [
      { id: 'art-blush-suqqu-pure-color', keyword: 'SUQQU ピュア カラー ブラッシュ', label: 'グラデーションの美しい発色と極上パウダーで大人の透明感を演出' },
      { id: 'art-blush-nars-blush-orgasm', keyword: 'NARS ブラッシュ オーガズム', label: 'ゴールドシマーとピンクが織りなす世界中で最も愛されるアイコニックチーク' },
      { id: 'art-blush-cezanne-natural-cheek', keyword: 'セザンヌ ナチュラル チークN', label: 'ワンコインでプロ級の自然な血色感！圧倒的コスパの国民的チーク' },
      { id: 'art-blush-focallure-liquid-blush', keyword: 'リキッドチーク チーク', label: '肌に溶け込むリキッド処方で落ちずに一日中ツヤめく血色感をキープ' },
      { id: 'art-blush-clinique-cheek-pop', keyword: 'クリニーク チーク ポップ', label: 'ガーベラ型が可愛く粉っぽさゼロで肌に密着する独自ベイクド処方' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による「40大金字塔達成・最新5選まとめ特集記事」作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_ETERNAL_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに毛穴のツルスベ感や多幸感あふれる血色感を実感できる高機能設計`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
  ...
  console.log(`\n🎉 楽天API直接取得による「40大金字塔達成・最新5選まとめ特集記事」および個別商品記事の完全追加が完了しました！`);
}
