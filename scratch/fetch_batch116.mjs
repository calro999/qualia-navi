...
const groups = [
  {
    id: "g1",
    keyword: "デリケートゾーン ソープ 弱酸性 泡 臭い",
    slug: "art-delicate-zone-feminine-wash-foam-soap-10sen-2026",
    outFile: "scratch/rakuten_batch116_g1_verified.json"
  },
  {
    id: "g2",
    keyword: "モデリングマスク モデリングパック 珪藻土",
    slug: "art-korean-modeling-pack-alginate-rubber-mask-10sen-2026",
    outFile: "scratch/rakuten_batch116_g2_verified.json"
  },
  {
    id: "g3",
    keyword: "マグネシウムオイル スプレー 塩化マグネシウム",
    slug: "art-transdermal-magnesium-oil-spray-10sen-2026",
    outFile: "scratch/rakuten_batch116_g3_verified.json"
  },
  {
    id: "g4",
    keyword: "前髪 パウダー ポンポン 頭皮 ヘアパウダー",
    slug: "art-scalp-bangs-oil-control-hair-powder-10sen-2026",
    outFile: "scratch/rakuten_batch116_g4_verified.json"
  }
];
