...
const batch66 = [
  JSON.parse(fs.readFileSync('scratch/batch66_art1.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch66_art2.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch66_art3.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch66_art4.json', 'utf8'))
];

for (const art of batch66) {
