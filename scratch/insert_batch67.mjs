...
const batch67 = [
  JSON.parse(fs.readFileSync('scratch/batch67_art1.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch67_art2.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch67_art3.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch67_art4.json', 'utf8'))
];

for (const art of batch67) {
