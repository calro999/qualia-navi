...
const batch62 = [
  JSON.parse(fs.readFileSync('scratch/batch62_art1.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch62_art2.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch62_art3.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch62_art4.json', 'utf8'))
];

for (const art of batch62) {
