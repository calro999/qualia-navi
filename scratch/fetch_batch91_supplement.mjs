...
async function main() {
  // for g2, need 3 more
  await fetchMore("RF 美顔器 ラジオ波 EMS", "scratch/rakuten_batch91_g2_verified.json", 4000);
  await sleep(1500);
  // for g4, need 7 more
  await fetchMore("アイシャドウ パレット ブルベ ピンク モーブ", "scratch/rakuten_batch91_g4_verified.json", 1000);
