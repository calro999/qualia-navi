...
const art1 = JSON.parse(fs.readFileSync('scratch/batch85_art1.json', 'utf-8'));
const art2 = JSON.parse(fs.readFileSync('scratch/batch85_art2.json', 'utf-8'));
const art3 = JSON.parse(fs.readFileSync('scratch/batch85_art3.json', 'utf-8'));
const art4 = JSON.parse(fs.readFileSync('scratch/batch85_art4.json', 'utf-8'));

const batch85 = [art1, art2, art3, art4];

for (const art of batch85) {
...
console.log('Batch 85 insertion complete!');
