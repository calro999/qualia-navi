...
// ① クエリ：ヘアオイル スティック アホ毛, まとめ髪スティック 前髪キープ, アホ毛 ポイントリペア（アホ毛・後れ毛・前髪乱れ専用ポイントリペアスティック）
// ② クエリ：炭酸洗顔 泡 洗顔料, 濃密炭酸泡洗顔 毛穴 くすみ, 炭酸ガス 洗顔パック（擦らず炭酸泡で浮かせてくすみを払う濃密炭酸洗顔フォーム）
const NEW_PERIPHERAL_V4_FEATURES = [
  {
    featureId: 'feature-5-point-hair-stick-repair',
    title: '【2026年最新・楽天最安値】【アホ毛・前髪乱れ＆まとめ髪スティック】ひと塗りでピンピン立つアホ毛を瞬間リセットする「神ポイントヘアスティック」5選',
    category: 'haircare',
    categoryLabel: '💇‍♀️ 【神アホ毛スティック5選】前髪キープ＆ポイントリペア特集',
    introText: '「湿度や乾燥で頭頂部のアホ毛がピンピン立ってしまう」「前髪やおくれ毛の束感を外出先でも手を汚さずに直したい」…マスカラ型ブラシ、植物性バーム、キープポリマー、アルガンオイル配合で固めず自然にまとめ上げる楽天売れ筋ポイントリペアスティック5選を徹底検証！',
    items: [
      { id: 'art-stick-plus-eau-point-repair', keyword: 'プリュスオー ポイントリペア', label: 'ひと塗りでアホ毛が消える！ベタつかずサラサラのままキープするSNS爆発的人気の火付け役' },
      { id: 'art-stick-matomage-hair-styling-stick', keyword: 'まとめ髪 スティック マトメージュ', label: '手が汚れない直塗りコンパクト！あほ毛・おくれ毛をしっかり抑える国民的ロングセラー' },
      { id: 'art-stick-diane-maegami-stick', keyword: 'ダイアン 前髪スティック', label: '極細ブラシで前髪の束感や生え際のアホ毛をピンポイントで長時間ロック' },
      { id: 'art-stick-fujiko-iroashi-stick', keyword: 'ヘアスティック アホ毛', label: '天然由来オイル配合で髪をトリートメントしながらツヤとまとまりを与えるスティック' },
      { id: 'art-stick-john-masters-hair-mascara', keyword: 'ヘアマスカラ アホ毛 オーガニック', label: 'オーガニック植物エキス配合で頭皮や髪に優しくナチュラルに整えるサロン仕様' }
    ]
  },
  {
    featureId: 'feature-5-carbonated-foam-face-wash',
    title: '【2026年最新・楽天最安値】【濃密炭酸泡洗顔＆血行促進くすみオフ】擦らず毛穴奥の皮脂を浮かせて発光美肌へ導く「神炭酸泡洗顔フォーム」5選',
    category: 'skincare',
    categoryLabel: '🫧 【神炭酸洗顔5選】濃密炭酸泡パック＆血行促進くすみオフ特集',
    introText: '「朝起きたときの顔のくすみやどんより感を瞬時にリセットしたい」「擦らずに毛穴の奥の皮脂や角栓を浮かせたい」…ワンプッシュで出てくる高濃度炭酸微細泡、アミノ酸系洗浄成分、ヒアルロン酸配合で洗顔しながら血行促進泡パックまで叶える楽天大人気炭酸泡洗顔5選を徹底解説！',
    items: [
      { id: 'art-wash-bior-carbonated-foam-wash', keyword: 'ビフェスタ 炭酸泡洗顔', label: '手では作れない濃密炭酸泡が毛穴の奥まで入り込みくすみをすっきりオフする殿堂入り洗顔' },
      { id: 'art-wash-est-clarifying-cleansing-foam', keyword: 'エスト クラリファイイング クレンジング', label: '炭酸マイクロ泡が古い角質をやわらげて透明感あふれる明るい肌へ導くデパコス最高峰' },
      { id: 'art-wash-hadalabo-carbonated-wash', keyword: '炭酸洗顔 泡 濃密 毛穴', label: 'マイクロ炭酸泡が肌に吸い付いて摩擦レスに汚れを浮かす濃密泡フォーム' },
      { id: 'art-wash-obagi-c-carbonated-foam', keyword: '炭酸 洗顔 ビタミンC 泡', label: 'ビタミンCと炭酸のWアプローチで毛穴の引き締めとくすみ除去を同時に叶える' },
      { id: 'art-wash-duo-the-bright-foam', keyword: '炭酸 泡洗顔 パック 保湿', label: '洗顔・マッサージ・パックがこれ1本！うるおいを守りながら洗い上げる濃密泡' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第4弾）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V4_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐにアホ毛の落ち着きや炭酸泡による顔の血色トーンアップを実感できる高機能設計`,
          `忙しい朝のスタイリングやスキンケア習慣に無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        faqs: [
          {
            ...
            answer: `はい、毎日のスタイリングやお肌の洗顔習慣として安心してお使いいただける安全性の高い設計となっております。`
          }
        ]
      };
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアスタイリング＆スキンケアアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第4弾特集記事および個別商品記事の完全追加が完了しました！`);
}
