...
// ① クエリ：眉マスカラ アッシュ 極細ブラシ 垢抜け, 眉マスカラ 脱色風 ふんわり（自眉の黒さをふんわり脱色したようにトーンアップし地肌につかない極細ブラシ眉マスカラ）
// ② クエリ：パドルブラシ 頭皮マッサージ クッションブラシ 豚毛, ヘアブラシ 絡まない サラサラ（クッション圧で頭皮の血行を促しながら摩擦レスに絡まりを解くパドルブラシ）
const NEW_PERIPHERAL_V12_FEATURES = [
  {
    featureId: 'feature-5-micro-brush-eyebrow-mascara',
    title: '【2026年最新・楽天最安値】【極細ブラシ眉マスカラ＆ふんわり垢抜け脱色風】地肌につかず1本1本カラーチェンジする「神眉マスカラ」5選',
    category: 'makeup',
    categoryLabel: '👁️ 【神眉マスカラ5選】極細ブラシ＆脱色風ふんわり垢抜け特集',
    introText: '「眉マスカラを塗ると地肌にベタッとついて失敗する」「黒々とした自眉をふんわり柔らかいトレンド眉にトーンアップしたい」…極小マイクロブラシ、パリパリに固まらないフィルム処方、汗・皮脂・擦れに強いウォータープルーフで一瞬で垢抜け顔を作る楽天売れ筋眉マスカラ5選を徹底検証！',
    items: [
      { id: 'art-browmascara-dejavu-eyebrow-color', keyword: 'デジャヴュ 眉マスカラ アイブロウカラー', label: '極小ブラシで地肌につかない！ふんわり柔らかい毛並みを作る国民的ベストセラー' },
      { id: 'art-browmascara-romand-han-all-brow', keyword: 'ロムアンド 眉マスカラ ハンオールブロウ', label: 'まるで脱色したような絶妙ニュアンスカラー！韓国コスメ発の自眉消去マスカラ' },
      { id: 'art-browmascara-kate-3d-eyebrow-color', keyword: 'KATE 3Dアイブロウカラー', label: '自眉の黒さをしっかり隠して高発色キープ！高密着ワックス配合の立体眉メイク' },
      { id: 'art-browmascara-heavy-rotation-coloring', keyword: 'ヘビーローテーション カラーリングアイブロウ', label: 'ひと塗りでしっかり発色！お湯で簡単にオフできるコスパ最強の定番品' },
      { id: 'art-browmascara-cezanne-eyebrow-mascara', keyword: 'セザンヌ 極細 眉マスカラ', label: 'コンパクトな極細ブラシが小回りを利かせ、眉頭から眉尻まで繊細にカラーリング' }
    ]
  },
  {
    featureId: 'feature-5-scalp-massage-paddle-brush',
    title: '【2026年最新・楽天最安値】【パドルブラシ＆頭皮マッサージ美髪】ブラッシングだけで血行促進＆サラサラ美髪！頭皮をほぐす「神ヘアブラシ」5選',
    category: 'haircare',
    categoryLabel: '🪮 【神パドルブラシ5選】頭皮マッサージ＆摩擦レス美髪特集',
    introText: '「ブラッシングすると髪が引っかかって痛い・切れる」「シャンプー前や就寝前の頭皮マッサージでリフトアップとツヤ髪を手に入れたい」…空気穴クッション構造、頭皮を傷つけない丸型ピン、天然木＆豚毛配合で静電気を防ぎツヤを最大化する楽天大人気パドルブラシ5選を徹底解説！',
    items: [
      { id: 'art-paddlebrush-aveda-wooden-paddle', keyword: 'アヴェダ パドルブラシ', label: 'クッション性と頭皮マッサージ効果が圧倒的！世界中で愛されるパドルブラシの金字塔' },
      { id: 'art-paddlebrush-tangle-teezer-wet-detangler', keyword: 'タングルティーザー 公式', label: '濡れ髪でも引っかからずスルスル解ける！特許取得の長短2段構造ブラシ' },
      { id: 'art-paddlebrush-refa-heart-brush', keyword: 'リファ ハートブラシ', label: '見た目も可愛い！「ほぐし」と「みがき」を同時に叶えてツヤを取り戻す大ヒットギフト' },
      { id: 'art-paddlebrush-la-casta-head-spa-brush', keyword: 'ラカスタ ヘッドスパブラシ', label: '豚毛とナイロンピンのミックス！頭皮の皮脂を落としながら髪に自然なツヤを与える' },
      { id: 'art-paddlebrush-wooden-scalp-massage-brush', keyword: 'パドルブラシ 木製 頭皮マッサージ', label: '天然木ハンドルとクッションピンで毎日のブラッシングが極上ヘッドスパに変わる' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第12弾）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V12_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに垢抜けふんわり眉やブラッシングによる頭皮スッキリ＆サラサラ美髪を実感できる高機能設計`,
          `毎朝のメイクや入浴前後のヘアケアルーティンに無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'アイブロウ＆スカルプツールアナリスト',
        summaryKeyPoints: [
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアアイブロウ＆ヘアツールアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第12弾特集記事および個別商品記事の完全追加が完了しました！`);
}
