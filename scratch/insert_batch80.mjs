...
const art1 = JSON.parse(fs.readFileSync('scratch/batch80_art1.json', 'utf-8'));
const art2 = JSON.parse(fs.readFileSync('scratch/batch80_art2.json', 'utf-8'));
const art3 = JSON.parse(fs.readFileSync('scratch/batch80_art3.json', 'utf-8'));
const art4 = JSON.parse(fs.readFileSync('scratch/batch80_art4.json', 'utf-8'));

const batch80 = [art1, art2, art3, art4];

for (const art of batch80) {
...
console.log('Batch 80 insertion complete!');
