...
// 祝！【全70大メガ特集・不滅の神話級マイルストーン達成記念】
const NEW_PLATINUM_FEATURES = [
  // 特集①：【美肌クレンジングジェル＆摩擦レス毛穴洗浄】みずみずしいジェルで肌荒れを防ぎながら毛穴オフする「神クレンジングジェル」5選
  {
    featureId: 'feature-5-cleansing-gel-pore-unclogging',
    title: '【2026年最新・楽天最安値】【美肌クレンジングジェル＆摩擦レス毛穴洗浄】みずみずしいジェルで肌荒れを防ぎながら毛穴オフする「神クレンジングジェル」5選',
    category: 'skincare',
    categoryLabel: '🫧 【神クレンジングジェル5選】摩擦レス毛穴オフ特集',
    introText: '「オイルのヌルつきやバームの油膜感が苦手」「摩擦レスなクッションジェルで肌に負担をかけずに毛穴汚れを落としたい」…温感ジェル、薬用消炎成分、美容液成分90%配合で肌荒れを防ぎながらつるんと洗い上げる楽天売れ筋クレンジングジェル5選を徹底検証！',
    items: [
      { id: 'art-gel-manara-hot-cleansing', keyword: 'マナラ ホットクレンジングゲル', label: '温感ゲルが毛穴をじんわり広げて黒ずみを吸着する大人気温感クレンジング' },
      { id: 'art-gel-curel-makeup-cleansing', keyword: 'キュレル ジェルメイク落とし', label: 'セラミドを守りながら肌荒れを防ぐ消炎剤配合の敏感肌用神ジェル' },
      { id: 'art-gel-duo-the-cleansing-gel', keyword: 'クレンジング ジェル 毛穴', label: 'みずみずしいテクスチャーで角栓と余分な皮脂汚れを優しく包み込んでオフ' },
      { id: 'art-gel-santa-marche-deep-cleanse', keyword: 'サンタマルシェ ディープクレンジング', label: '京都宇治抹茶エキス配合の重曹ジェルで毛穴の奥までディープ洗浄' },
      { id: 'art-gel-muji-cleansing-gel', keyword: '無印良品 マイルドジェルクレンジング', label: 'アンズ果汁・モモ葉エキス配合ですっきり素早く洗い流せる高コスパジェル' }
    ]
  },
  // 特集②：【極上まつ毛美容液＆高濃度まつ育】抜け毛・スカスカ・傷んだまつ毛を根本からハリコシ再生する「神まつ毛美容液」5選
  {
    featureId: 'feature-5-eyelash-growth-serum-intense',
    title: '【2026年最新・楽天最安値】【極上まつ毛美容液＆高濃度まつ育】抜け毛・スカスカ・傷んだまつ毛を根本からハリコシ再生する「神まつ毛美容液」5選',
    category: 'skincare',
    categoryLabel: '👁️ 【神まつ毛美容液5選】濃密まつ育＆ハリコシ特集',
    introText: '「マツエクやまつパで自まつ毛がスカスカになってしまった」「毎日のアイメイク映えする長く濃い自まつ毛を育てたい」…高濃度ペプチド、キャピキシル、ワイドラッシュ配合で根本から力強いボリュームを与える楽天大人気まつ毛美容液5選を徹底解説！',
    items: [
      { id: 'art-lash-lashaddict-eyelash-conditioning', keyword: 'ラッシュアディクト アイラッシュ コンディショニング セラム', label: 'ナノペプチド複合体配合でサロン専売品から爆発的ヒットとなった最強まつ育液' },
      { id: 'art-lash-scalpd-beaute-pure-free', keyword: 'スカルプD まつ毛美容液 プレミアム', label: 'まつ毛ケア成分2倍配合で根本からハリ・コシ・密度を高める国民的育毛セラム' },
      { id: 'art-lash-ema-ked-eyelash-serum', keyword: 'エマーキット まつ毛美容液', label: '濃密な保湿・補修成分で寝ている間に目ヂカラを底上げする超濃厚まつ毛美容液' },
      { id: 'art-lash-majolica-majorca-rush-jelly', keyword: 'マジョリカマジョルカ ラッシュジェリードロップ', label: '赤いまつ毛美容液！うぶ毛までくっきり際立たせる神コスパプチプラセラム' },
      { id: 'art-lash-revitalash-advanced-japan', keyword: 'リバイタラッシュ アドバンス ジャパン', label: '世界的ドクターズコスメ！植物エキスとペプチドでドラマティックな自まつ毛へ' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による【祝！全70大メガ特集・不滅の神話級マイルストーン達成記事】作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PLATINUM_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに摩擦レスな毛穴落ち感や自まつ毛の力強いハリコシを実感できる高機能設計`,
          `毎日のスキンケアやまつ育習慣に無理なく組み込める快適な使用感・高い満足度`,
...
2. **肌や目元への優しさと持続性**: デリケートな状態でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'クレンジングジェル＆まつ育アナリスト',
        summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得による【祝！全70大メガ特集・不滅の神話級マイルストーン達成記事】および個別商品記事の完全追加が完了しました！`);
}
