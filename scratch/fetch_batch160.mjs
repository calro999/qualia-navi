...
const queries = {
  t1: '首 イボ 杏仁オイル ハトムギ',
  t2: 'ホワイトニングパウダー 歯 アパタイト',
  t3: '泥リップ マット INTOU',
  t4: 'タングルティーザー ヘアブラシ 濡れ髪'
};
...
async function main() {
  ...
  fs.writeFileSync('scratch/batch160_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 160 products saved successfully to scratch/batch160_fetched.json!');
}
