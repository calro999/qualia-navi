...
const NEW_ZENITH_FEATURES = [
  // 特集①：【頭皮クレンジング＆スカルプケア】頭皮のニオイ・ベタつき・抜け毛を予防する「極上スカルプブラシ＆炭酸シャンプー」5選
  {
    featureId: 'feature-5-scalp-care-carbonated-shampoo',
    title: '【2026年最新・楽天最安値】【頭皮クレンジング＆スカルプケア】頭皮のニオイ・ベタつき・抜け毛を予防する「極上スカルプブラシ＆炭酸シャンプー」5選',
    category: 'haircare',
    categoryLabel: '🫧 【頭皮＆スカルプ5選】毛穴炭酸クレンジング特集',
    introText: '「夕方の頭皮のニオイや皮脂ベタつきが気になる」「根本から立ち上がるふんわり美髪と将来の抜け毛予防をしたい」…高濃度炭酸泡、頭皮血行促進スカルプブラシ、薬用育毛エッセンスでサロン級ヘッドスパを叶える楽天売れ筋スカルプケア5選を徹底検証！',
    items: [
      { id: 'art-scalp-uka-kenzan-brush', keyword: 'uka スカルプブラシ ケンザン', label: '美容師・インフルエンサー絶賛！頭皮のコリをほぐす神ブラシ' },
      { id: 'art-scalp-milbon-carbonated', keyword: 'ミルボン プラーミア クリアスパフォーム', label: '高濃度炭酸泡が頭皮の皮脂汚れとニオイをディープクレンジング' },
      { id: 'art-scalp-brio-carbonated-shampoo', keyword: '炭酸シャンプー オーガニック', label: '濃密ミクロ泡で頭皮環境を健やかに整えるスカルプ炭酸シャンプー' },
      { id: 'art-scalp-haru-kurokami-shampoo', keyword: 'haru kurokami スカルプ', label: '100%天然由来成分でリンス不要！頭皮エイジングケアシャンプー' },
      { id: 'art-scalp-chap-up-hair-lotion', keyword: 'チャップアップ 薬用育毛剤', label: '有効成分配合で頭皮の血行を促進し抜け毛を防ぐロングセラー育毛ローション' }
    ]
  },
  // 特集②：【極上リップケア＆ナイトリップ】皮むけ・くすみ・縦ジワを一晩でふっくらプルプルにする「濃厚リップトリートメント」5選
  {
    featureId: 'feature-5-lip-plumper-night-mask',
    title: '【2026年最新・楽天最安値】【極上リップケア＆ナイトリップ】皮むけ・くすみ・縦ジワを一晩でふっくらプルプルにする「濃厚リップトリートメント」5選',
    category: 'skincare',
    categoryLabel: '💋 【極上リップケア5選】ぷるぷる唇集中トリートメント特集',
    introText: '「口紅を塗ると皮むけや縦ジワが目立つ」「翌朝までしっとり潤う高保湿ナイトリップを探している」…ペプチド、セラミド、ヒアルロン酸配合で一晩中唇を濃密密着ラップする楽天大人気リップケア5選を徹底解説！',
    items: [
      { id: 'art-lip-laneige-lip-sleeping-mask', keyword: 'ラネージュ リップスリーピングマスク', label: '寝ている間に角質をやわらげ翌朝ぷるぷるにする世界的大ヒット' },
      { id: 'art-lip-dior-addict-lip-glow', keyword: 'ディオール アディクト リップ グロウ', label: '自然な血色感と97%自然由来の潤いで満たす王道リップバーム' },
      { id: 'art-lip-obagi-derma-power-lip', keyword: 'オバジ ダーマパワーX リップエッセンス', label: 'コラーゲン×エラスチン配合で縦ジワをふっくら押し上げる美容液' },
      { id: 'art-lip-torriden-solid-in-lip', keyword: 'トリデン ソリッドイン セラミド リップ', label: '5重セラミド配合でひび割れた唇をしっとり落ち着かせる神バーム' },
      { id: 'art-lip-curel-moisture-lip-care', keyword: 'キュレル リップケアバーム', label: 'セラミド機能成分配合で唇の荒れ・ひび割れを防ぐ低刺激ナイトバーム' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による「34大達成記念・最新5選まとめ特集記事」作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_ZENITH_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに頭皮の爽快感や唇のふっくら感を実感できる高機能設計`,
          `毎日のヘアケアやリップケア習慣に無理なく組み込める快適な使用感・低刺激処方`,
...
2. **頭皮や唇への優しさと持続性**: デリケートな部位でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: '頭皮スカルプ＆リップケアアナリスト',
        summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得による「34大達成記念・最新5選まとめ特集記事」および個別商品記事の完全追加が完了しました！`);
}
