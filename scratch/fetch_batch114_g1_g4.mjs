...
async function main() {
  await fetchG("g1", "ペプチド 美容液 エイジングケア ハリ", "scratch/rakuten_batch114_g1_verified.json");
  await sleep(1500);
  await fetchG("g4", "トナーパッド 拭き取り 化粧水 パッド", "scratch/rakuten_batch114_g4_verified.json");
}
