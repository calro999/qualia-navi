...
// ① クエリ：メイクブラシ クリーナー 速乾 スプレー 水洗い不要, ブラシ クレンジング 洗浄（水を使わずティッシュに吹きかけてサッと拭くだけで瞬間除菌＆乾く速乾メイクブラシクリーナー）
// ② クエリ：足指 セパレーター 広げる 外反母趾 リフレッシュ フットケア, 足指 パッド シリコン むくみ（ヒールやパンプスで縮こまった足指をグーンと広げて血行を促しむくみを解消するフットセパレーター）
const NEW_PERIPHERAL_V17_FEATURES = [
  {
    featureId: 'feature-5-quick-dry-makeup-brush-cleaner',
    title: '【2026年最新・楽天最安値】【速乾メイクブラシクリーナー＆水洗い不要】ティッシュで拭くだけ10秒で乾く！ブラシを清潔に保つ「神ブラシドライクレンザー」5選',
    category: 'device',
    categoryLabel: '🖌️ 【神速乾ブラシクリーナー5選】水洗い不要＆10秒ドライ特集',
    introText: '「メイクブラシを洗うと乾くまでに1日かかって毛が痛む」「毎日使うファンデーションブラシやアイシャドウブラシを清潔に保ちたい」…植物由来の速乾エタノール、天然保湿オイル、抗菌消炎成分配合でティッシュの上を撫でるだけで瞬時に汚れを落としてすぐに使える楽天売れ筋ブラシクリーナー5選を徹底検証！',
    items: [
      { id: 'art-brushclean-shiseido-sponge-cleaner', keyword: '資生堂 スポンジクリーナー', label: '皮脂やファンデーション汚れを一瞬で落とす！泡切れ抜群の国民的ロングセラー' },
      { id: 'art-brushclean-cinema-secrets-cleaner', keyword: 'シネマシークレット ブラシクリーナー', label: 'ハリウッドのメイクアップアーティスト御用達！拭いた瞬間乾く驚異の速乾ドライクレンザー' },
      { id: 'art-brushclean-mac-brush-cleanser', keyword: 'MAC ブラシクレンザー', label: '毛を傷めずしなやかに保ちながら除菌！デパコス派に愛されるベストセラー' },
      { id: 'art-brushclean-make-up-for-ever-instant', keyword: 'メイクブラシ クリーナー スプレー 速乾', label: 'スプレーして拭くだけ！アイシャドウのカラーチェンジがその場でできるプロ仕様' },
      { id: 'art-brushclean-sponge-brush-wash-puff', keyword: 'パフ クリーナー 洗浄 洗剤', label: '頑固なパフの汚れもスッキリ除菌！肌荒れの原因菌を防ぐ高コスパ洗浄液' }
    ]
  },
  {
    featureId: 'feature-5-toe-separator-foot-reliever',
    title: '【2026年最新・楽天最安値】【足指セパレーター＆外反母趾・むくみリセット】ヒールで縮こまった足指を広げて巡りを改善する「神フットセパレーター」5選',
    category: 'bodycare',
    categoryLabel: '🦶 【神足指セパレーター5選】足指ストレッチ＆むくみ解消特集',
    introText: '「一日中パンプスや立ち仕事で足の裏や指先がパンパンに痛い」「外反母趾や縮こまった足指を解放してリフレッシュしたい」…ぷにぷに高弾力医療用シリコン、お風呂で使える防水設計、就寝中も痛くない広がり角度設計で足裏のアーチを整える楽天大人気足指セパレーター5選を徹底解説！',
    items: [
      { id: 'art-toesep-medical-silicone-separator', keyword: '足指 セパレーター シリコン', label: 'ぷにぷにシリコンが足指を自然に広げる！外反母趾や立ち仕事の疲れをリセットする定番' },
      { id: 'art-toesep-foot-arch-support-pad', keyword: '足指 広げる グッズ', label: '足指セパレーターと足裏アーチサポートを一体化！歩行バランスを整える高機能パッド' },
      { id: 'art-toesep-pedicure-sponge-separator', keyword: 'ペディキュア 足指 セパレーター', label: 'フットネイルが塗りやすい！お風呂上がりのストレッチにも使える柔らかクッション' },
      { id: 'art-toesep-hallux-valgus-toe-corrector', keyword: '外反母趾 足指 サポーター', label: '親指と人差し指の重なりを優しく補正！靴を履きながらでも使える薄型サポーター' },
      { id: 'art-toesep-night-foot-relaxation-pad', keyword: '足指 パッド むくみ リフレッシュ', label: '就寝中につけて寝るだけ！翌朝の足の軽さが劇的に変わるフットケアアイテム' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第17弾）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V17_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐにメイクブラシの清潔な速乾ケアや足指の開放感・むくみスッキリを実感できる高機能設計`,
          `毎日のメイク道具のお手入れや帰宅後のフットケアルーティンに無理なく組み込める快適な使用感・高い満足度`,
...
2. **肌やメイク道具への優しさと持続性**: デリケートな部位でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'メイクツール＆フットケアアナリスト',
        summaryKeyPoints: [
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアツール＆フットケアアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第17弾特集記事および個別商品記事の完全追加が完了しました！`);
}
