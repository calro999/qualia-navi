...
const queries = {
  t1: '部分用 つけまつげ 束感 アイドル',
  t2: '超極細 アイブロウペンシル',
  t3: '爪 美容液 ネイルトリートメント 補修',
  t4: '背中ニキビ ボディソープ 薬用 殺菌'
};
...
async function main() {
  ...
  fs.writeFileSync('scratch/batch169_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 169 products saved successfully to scratch/batch169_fetched.json!');
}
