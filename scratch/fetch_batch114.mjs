...
const groups = [
  {
    id: "g1",
    keyword: "銅ペプチド 美容液 青ペプチド",
    slug: "art-copper-tripeptide-ghk-cu-skin-repair-serum-10sen-2026",
    outFile: "scratch/rakuten_batch114_g1_verified.json"
  },
  {
    id: "g2",
    keyword: "赤色LED スカルプ 美顔器 頭皮",
    slug: "art-red-led-near-infrared-lllt-scalp-brush-10sen-2026",
    outFile: "scratch/rakuten_batch114_g2_verified.json"
  },
  {
    id: "g3",
    keyword: "針ファンデーション スピキュール クッションファンデ",
    slug: "art-spicule-micro-needle-cushion-foundation-10sen-2026",
    outFile: "scratch/rakuten_batch114_g3_verified.json"
  },
  {
    id: "g4",
    keyword: "トナーパッド 拭き取りパッド 毛穴 CICA ドクダミ",
    slug: "art-cica-heartleaf-exfoliating-toner-pad-10sen-2026",
    outFile: "scratch/rakuten_batch114_g4_verified.json"
  }
];
