...
async function fetchG4More() {
  const targetFile = "scratch/rakuten_batch98_g4_verified.json";
  ...
  url.searchParams.append("keyword", "アイシャドウ テラコッタ オレンジ ブラウン");
...
fetchG4More().catch(console.error);
