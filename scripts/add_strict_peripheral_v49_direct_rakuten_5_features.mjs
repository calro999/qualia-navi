...
// ① クエリ：マスカラコーム 金属 まつ毛コーム ダマ取り 折りたたみ セパレート, まつ毛 金属コーム（マスカラ塗布後のまつ毛のダマや束付きを一瞬で解消し、1本1本が扇状に広がる極上セパレートまつ毛を作る専用金属コーム）
// ② クエリ：リップスクラブ 唇 角質ケア 唇 ピーリング 縦ジワ プランプ, レブロン キスシュガースクラブ（古い角質によるガサガサや黒ずみを微粒子シュガーで優しくオフし、生まれたてのようなぷるぷる血色リップに整えるリップ専用スクラブ）
const NEW_PERIPHERAL_V49_FEATURES = [
  {
    featureId: 'feature-5-metal-mascara-comb-lash-separator',
    title: '【2026年最新・楽天最安値】【金属製マスカラコーム＆極上セパレート】マスカラのダマを一瞬で消し去る「神まつ毛コーム」5選',
    category: 'makeup',
    categoryLabel: '👁️ 【神マスカラコーム5選】ダマ取り＆極上扇状セパレート特集',
    introText: '「ボリュームマスカラを塗るとダマになってひじきまつ毛になる」「プラスチックのコームだと目が粗くて綺麗に梳かせない」…超極細0.5ミリ金属ピン、折りたたみ携帯設計、まぶたのカーブに沿うアーチ構造で毛先までスッと通る楽天売れ筋マスカラコーム5選を徹底検証！',
    items: [
      { id: 'art-lashcomb-chasty-folding-mascara-comb-metal', keyword: 'チャスティ マスカラコーム', label: 'マスカラコームの絶対的代名詞！職人級金属ピンで美しいセパレートまつ毛' },
      { id: 'art-lashcomb-canmake-lash-care-comb-folding', keyword: 'キャンメイク マスカラコーム', label: 'プチプラ界の超人気！コンパクトにたためてポーチでも汚れない' },
      { id: 'art-lashcomb-sixplus-metal-eyelash-comb-pro', keyword: 'マスカラコーム 金属', label: '高耐久ステンレス製！目頭から目尻まで一度に梳かせるロングワイド設計' },
      { id: 'art-lashcomb-rosyrosa-metal-lash-comb-pink', keyword: 'まつ毛コーム 金属', label: '繊細な0.7ミリピッチ！マスカラの余分な液だけをしっかり除去' },
      { id: 'art-lashcomb-du-care-folding-stainless-lash-separator', keyword: 'アイラッシュコーム 折りたたみ', label: '人間工学カーブハンドル！初心者でもまつ毛を根元からしっかりキャッチ' }
    ]
  },
  {
    featureId: 'feature-5-sugar-lip-scrub-exfoliator-peeling',
    title: '【2026年最新・楽天最安値】【シュガーリップスクラブ＆唇角質つるん】ガサガサ皮剥けをリセットする「神リップピーリング」5選',
    category: 'skincare',
    categoryLabel: '💋 【神リップスクラブ5選】角質ケア＆ぷるぷる赤ちゃん唇特集',
    introText: '「リップを塗っても皮剥けで粉をふいてしまう」「唇のくすみや血色の悪さが気になる」…洗い流し不要の微粒子シュガー、フルーツ酸、濃密植物性エモリエントオイル配合で古い角質を溶かしながら濃密保湿する楽天売れ筋リップスクラブ5選を徹底解説！',
    items: [
      { id: 'art-lipscrub-revlon-kiss-sugar-scrub-mint', keyword: 'レブロン キス シュガー スクラブ', label: 'リップスクラブの金字塔！塗るだけで角質ケアとプランプ保湿が同時に完了' },
      { id: 'art-lipscrub-lush-bubblegum-lip-scrub-sweet', keyword: 'リップスクラブ 唇 角質ケア', label: '甘い香りとシュガーの優しさ！唇の古い角質を落としてワントーン明るい唇へ' },
      { id: 'art-lipscrub-dior-addict-lip-sugar-scrub-self-melting', keyword: 'ディオール リップスクラブ', label: 'デパコス最高峰！唇の上でとろけるバーム変化で極上のなめらかさを実感' },
      { id: 'art-lipscrub-innisfree-green-tea-lip-scrub-moist', keyword: 'リップスクラブ 保湿', label: '自然派チェジュ島グリーンティーエキス！刺激を与えずしっとり角質オフ' },
      { id: 'art-lipscrub-canmake-plump-lip-care-scrub-sugar', keyword: 'キャンメイク リップスクラブ', label: 'プチプラ界の大ヒット！いつでもどこでも手軽に使えるスティックタイプ' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第49弾【純粋コスメ＆まつ毛コーム・リップスクラブ特化】）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V49_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐにマスカラのダマ解消・美しいセパレートまつ毛やリップスクラブによる唇のガサガサ皮剥けリセットを実感できる高機能設計`,
          `毎日のアイメイク仕上げや週に数回のリップ集中ケアに無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'アイラッシュツール＆リップケアアナリスト',
        summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第49弾【純粋コスメ＆まつ毛コーム・リップスクラブ特化】特集記事および個別商品記事の完全追加が完了しました！`);
}
