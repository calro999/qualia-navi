...
async function main() {
  await fetchG("g3", "ボディスクラブ お尻 黒ずみ 角質", "scratch/rakuten_batch119_g3_verified.json");
  await sleep(1500);
  await fetchG("g4", "ナイトキャップ シルク 筒型 ロング", "scratch/rakuten_batch119_g4_verified.json");
}
