...
// ① クエリ：ネイルオイル ペンタイプ 持ち歩き ささくれ, 甘皮ケア オイル ロールオン（外出先でもベタつかず爪先・ささくれ・甘皮を瞬間保湿するペン型ネイルオイル）
// ② クエリ：デリケートゾーン ソープ 泡 弱酸性 医薬部外品, フェミニンウォッシュ 臭い かゆみ（生理中やムレ・デリケートな肌を擦らず優しく洗う弱酸性濃密泡フェミニンソープ）
const NEW_PERIPHERAL_V8_FEATURES = [
  {
    featureId: 'feature-5-pen-type-nail-cuticle-oil',
    title: '【2026年最新・楽天最安値】【ペン型ネイルオイル＆ささくれ瞬間リセット】ポーチに入れていつでも潤いチャージ！ベタつかない「神キューティクルオイル」5選',
    category: 'bodycare',
    categoryLabel: '💅 【神ペン型ネイルオイル5選】ささくれ・甘皮保湿＆持ち歩き特集',
    introText: '「スマホやパソコン作業で指先の乾燥・ささくれが目立って痛い」「外出先でも手を汚さずに甘皮ケアをしたい」…天然ホホバオイル、アーモンド油、ビタミンE、上品なアロマ精油配合でダイヤルを回すだけで適量が出せる楽天売れ筋ペン型ネイルオイル5選を徹底検証！',
    items: [
      { id: 'art-nailpen-uka-nail-oil-basic', keyword: 'uka ネイルオイル', label: 'ロールオンで塗りやすい！天然由来原料の心地よい香りと高保湿を両立するサロン発大定番' },
      { id: 'art-nailpen-squse-me-glossy-oil-pen', keyword: 'ネイルオイル ペンタイプ', label: '筆ペンタイプで甘皮のキワまでしっかり浸透！ポーチに常備したい高コスパ名品' },
      { id: 'art-nailpen-d-up-aroma-cuticle-oil', keyword: 'キューティクルオイル ペン', label: '爪と自爪のハイポニキウム（爪の裏側）までしっかり保湿して美爪を育てるスティック' },
      { id: 'art-nailpen-opi-pro-spa-nail-pen', keyword: 'OPI プロスパ ネイルオイル', label: '世界最高峰ネイルブランド！アボカドオイル配合のプロ仕様キューティクルケア' },
      { id: 'art-nailpen-country-stream-nail-treatment', keyword: 'ネイル トリートメント ペン 保湿', label: 'ハチミツ・ローヤルゼリーエキス配合で乾燥した指先をしっとり包み込む' }
    ]
  },
  {
    featureId: 'feature-5-feminine-foam-wash-delicate',
    title: '【2026年最新・楽天最安値】【デリケートゾーン泡ソープ＆弱酸性低刺激ケア】気になるニオイ・ムレ・かゆみを擦らずリセットする「神フェミニンウォッシュ」5選',
    category: 'bodycare',
    categoryLabel: '🌸 【神デリケートゾーン泡ソープ5選】弱酸性・ニオイかゆみケア特集',
    introText: '「生理中や長時間のデスクワークでデリケートゾーンのムレやニオイが気になる」「普通のボディソープだとヒリヒリしみる」…デリケートゾーンと同じ弱酸性（pH4〜5）、乳酸菌・CICA・ティーツリー・薬用殺菌消炎成分配合で自浄作用を守りながら洗える楽天大人気泡フェミニンソープ5選を徹底解説！',
    items: [
      { id: 'art-femwash-iroha-intimate-wash-foam', keyword: 'iroha インティメートウォッシュ フォーム', label: 'きめ細やかな弱酸性泡が摩擦を防ぎながら気になるくすみ・ニオイのもとをやさしくオフ' },
      { id: 'art-femwash-collagen-ladies-foam-soap', keyword: 'コラージュフルフル 泡石鹸 デリケートゾーン', label: '抗真菌（抗カビ）成分ミコナゾール配合でデリケートゾーンの菌・ニオイを元から防ぐ医薬部外品' },
      { id: 'art-femwash-femcharme-medicated-foam', keyword: 'デリケートゾーン ソープ 泡 医薬部外品', label: '有効成分配合でニオイ菌を殺菌！植物由来の美容保湿成分でしっとり洗い上げる' },
      { id: 'art-femwash-summer-eve-feminine-wash', keyword: 'サマーズイブ フェミニンウォッシュ 泡', label: 'アメリカ売上No.1！毎日のバスタイムで安心して使える弱酸性低刺激フォーミングウォッシュ' },
      { id: 'art-femwash-intima-feminine-wash', keyword: 'デリケートゾーン ソープ 弱酸性', label: 'ヨーロッパ発の老舗！タンポポエキスや乳酸配合でデリケートゾーンのpHバランスをキープ' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第8弾）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V8_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに指先の潤いやデリケートゾーンの快適な清潔感を実感できる高機能設計`,
          `毎日の持ち歩きやバスタイム習慣に無理なく組み込める快適な使用感・高い満足度`,
...
2. **肌や爪先への優しさと持続性**: デリケートな状態でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアパーツ＆フェミニンアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第8弾特集記事および個別商品記事の完全追加が完了しました！`);
}
