...
// ① クエリ：メイクブラシクリーナー スポンジクリーナー パフ 洗浄剤 除菌, 資生堂 スポンジクリーナー（雑菌繁殖や肌荒れの原因となるファンデ・皮脂汚れを繊維を傷めず一瞬でリセットする専用ブラシ＆パフクリーナー）
// ② クエリ：シルク ナイトキャップ 摩擦防止 枝毛 切れ毛 シルク100 美髪 保湿, ナイトキャップ シルク（就寝中の枕との摩擦や乾燥によるパサつき・アホ毛・切れ毛を防ぎ、翌朝サロン帰りのまとまりツヤ髪へ導くシルク100%ナイトキャップ）
const NEW_PERIPHERAL_V51_FEATURES = [
  {
    featureId: 'feature-5-makeup-brush-sponge-cleaner-sanitizer',
    title: '【2026年最新・楽天最安値】【メイクブラシ＆スポンジ専用クリーナー】肌荒れ原因の雑菌・ファンデ汚れを瞬時に落とす「神パフ洗浄液」5選',
    category: 'makeup',
    categoryLabel: '🧼 【神ブラシ＆スポンジクリーナー5選】除菌・速乾＆パフ長持ち特集',
    introText: '「ファンデーションを塗るパフやブラシを洗わず使って肌荒れやニキビができる」「水洗いしても奥の皮脂汚れが落ちない」…高生分解性アミノ酸洗浄成分、速乾除菌処方、ブラシの天然毛・人工毛を痛めずふわふわに復元する楽天売れ筋メイクツールクリーナー5選を徹底検証！',
    items: [
      { id: 'art-cleaner-shiseido-sponge-cleaner-198', keyword: '資生堂 スポンジクリーナー 198', label: 'パフ専用洗剤の絶対王者！一滴で頑固なリキッドファンデも瞬時に乳化' },
      { id: 'art-cleaner-sixplus-brush-cleaner-soap', keyword: 'SIXPLUS ブラシクリーナー', label: '固形天然オイルソープ！ブラシの毛並みを整えながらしっかりディープクレンジング' },
      { id: 'art-cleaner-rosyrosa-sponge-brush-wash', keyword: 'ロージーローザ クリーナー', label: 'プチプラ大容量！泡切れ抜群でパフを痛めず毎日清潔に保てる' },
      { id: 'art-cleaner-shiseido-brush-cleanser-spray', keyword: 'ブラシクリーナー 速乾', label: 'ティッシュオフですぐ乾く！水洗い不要で毎日のメイク直後にお手入れ完了' },
      { id: 'art-cleaner-du-care-brush-cleaning-mat', keyword: 'メイクブラシ クリーナー', label: '洗浄液と専用シリコンマットセット！ブラシの奥に入り込んだ汚れまで掻き出す' }
    ]
  },
  {
    featureId: 'feature-5-silk-nightcap-friction-damage-haircare',
    title: '【2026年最新・楽天最安値】【シルク100%ナイトキャップ＆摩擦ダメージ防止】翌朝つるんとまとまる美髪へ導く「神ナイトヘアケア」5選',
    category: 'haircare',
    categoryLabel: '✨ 【神シルクナイトキャップ5選】摩擦ゼロ！翌朝まとまるツヤ美髪特集',
    introText: '「朝起きると髪がボサボサに広がって寝ぐせやアホ毛がひどい」「枕との摩擦で毛先がパサついて枝毛ができる」…天然最高級6Aランクシルク100%、ゴム跡がつかない筒型ロング設計、頭皮の乾燥を防ぐ楽天売れ筋シルクナイトキャップ5選を徹底解説！',
    items: [
      { id: 'art-nightcap-utukushi-silk-nightcap-6a-grade', keyword: 'シルク ナイトキャップ', label: 'ナイトキャップの絶対的人気！天然シルク100%で翌朝の髪のツヤとまとまりが激変' },
      { id: 'art-nightcap-silk-long-hair-tube-cap', keyword: 'ナイトキャップ ロングヘア シルク', label: 'ロングヘア専用筒型！寝返りを打っても髪が折れず朝のアイロン時間がゼロに' },
      { id: 'art-nightcap-silk-pillowcase-envelope-type', keyword: 'シルク 枕カバー', label: 'かぶるのが苦手な人へ！枕にかぶせるだけで全方位の髪摩擦を完全ブロック' },
      { id: 'art-nightcap-lillly-silk-ribbon-adjustable-nightcap', keyword: 'ナイトキャップ シルク 100', label: 'リボン結びでサイズ調整自在！おでこにゴム跡を残さない美髪設計' },
      { id: 'art-nightcap-cocoon-silk-hair-wrap-care', keyword: 'シルク ナイトキャップ 渡辺直美', label: '芸能人・美容賢者愛用！寝ている間の水分蒸発を防ぎしっとりうるツヤ髪へ' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第51弾【純粋コスメ＆メイクツール洗浄・シルク美髪ケア特化】）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V51_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐにパフ・ブラシの新品のような清潔復元やシルクナイトキャップによる翌朝のまとまりツヤ髪・摩擦ダメージゼロを実感できる高機能設計`,
          `週末のメイク道具お手入れや毎晩の就寝前ヘアケアルーティンに無理なく組み込める快適な使用感・高い満足度`,
...
2. **肌や毛髪への優しさと持続性**: デリケートな肌やキューティクルでも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'ツールメンテナンス＆ヘアケアアナリスト',
        summaryKeyPoints: [
        ...
        faqs: [
          {
            ...
            answer: `はい、毎日の習慣または定期的なお手入れとして安心してお使いいただける安全性の高い設計となっております。`
          }
        ]
      };
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアメイクツール＆ヘアケアアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第51弾【純粋コスメ＆メイクツール洗浄・シルク美髪特化】特集記事および個別商品記事の完全追加が完了しました！`);
}
