...
console.log('🚀 [楽天API 直接取得 Batch2] 超高需要ロングテール5テーマの商品データを取得開始...');
...
const themes = [
  {
    key: 'scalp_uv_spray',
    searchKeywords: ['髪 日焼け止め スプレー ミーファ', '頭皮 UVスプレー', '紫外線予報 髪 日焼け止め', 'アノアイ UVスプレー 髪']
  },
  {
    key: 'cushion_puff',
    searchKeywords: ['クッションファンデ パフ 替え', 'ルビーセル パフ メイクスポンジ', 'ファンデーション パフ 洗い替え', 'エアパフ クッション']
  },
  {
    key: 'bangs_reset_sheet',
    searchKeywords: ['前髪 リセットシート', '前髪 あぶらとり紙', '前髪 さらさら シート パウダー', 'Fujiko 前髪 あぶらとり']
  },
  {
    key: 'hip_scrub',
    searchKeywords: ['お尻 スクラブ 黒ずみ', 'ヒップ スクラブ ざらつき', '恋するおしり 石鹸 スクラブ', '薬用 ヒップ 美白 ジェル']
  },
  {
    key: 'delicate_soap',
    searchKeywords: ['デリケートゾーン ソープ 泡', 'フェミニンウォッシュ 弱酸性', 'デリケートゾーン 石鹸 薬用', 'ロリエ デリケート 泡ウォッシュ']
  }
];
...
async function main() {
  ...
  fs.writeFileSync('scratch_longtail_batch2_rakuten_items.json', JSON.stringify(results, null, 2), 'utf-8');
  console.log('\n🎉 全商品の取得が完了し、scratch_longtail_batch2_rakuten_items.json に保存しました！');
}
