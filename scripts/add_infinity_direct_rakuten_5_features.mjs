...
const NEW_INFINITY_FEATURES = [
  // 特集①：【美顔ローラー＆かっさリフト】フェイスラインのたるみ・二重あご・むくみを流す「神美顔ローラー＆かっさ」5選
  {
    featureId: 'feature-5-facial-roller-lymph-drainage',
    title: '【2026年最新・楽天最安値】【美顔ローラー＆かっさリフト】フェイスラインのたるみ・二重あご・むくみを流す「神美顔ローラー＆かっさ」5選',
    category: 'device',
    categoryLabel: '⚡ 【美顔ローラー5選】小顔リンパ流し特集',
    introText: '「朝起きた時の顔のパンパンなむくみを速攻で流したい」「エステティシャンの手技のようなドレナージュでシャープなフェイスラインを作りたい」…マイクロカレント、テラヘルツ鉱石、人間工学設計でプロ級のリフトケアを叶える楽天売れ筋美顔ローラー5選を徹底検証！',
    items: [
      { id: 'art-roller-refa-motion-carat', keyword: 'リファ モーションカラット', label: 'ヘッドが可動して深層筋肉まで深くつまみ流すReFaの最高峰ローラー' },
      { id: 'art-roller-terahertz-kassa', keyword: 'テラヘルツ かっさ', label: '高純度テラヘルツ鉱石の超微細振動で血行とリンパを促す神かっさ' },
      { id: 'art-roller-refa-s-carat-ray', keyword: 'リファ エスカラットレイ', label: '目元や口元の細かい起伏にフィットするポイントケア専用ローラー' },
      { id: 'art-roller-nion-beauty-roller', keyword: '美顔ローラー マイクロカレント', label: '微弱電流マイクロカレントとY字型構造でフェイスラインを強力引き締め' },
      { id: 'art-roller-ayura-bikassa-plate', keyword: 'アユーラ ビカッサ プレート', label: '陶磁器のなめらかな肌あたりで立体的なコリ感を心地よくほぐす' }
    ]
  },
  // 特集②：【極上ナイトパック＆スリーピングマスク】塗って寝るだけ！翌朝ぷるんと発光する「濃密オーバーナイトマスク」5選
  {
    featureId: 'feature-5-night-pack-sleeping-mask',
    title: '【2026年最新・楽天最安値】【極上ナイトパック＆スリーピングマスク】塗って寝るだけ！翌朝ぷるんと発光する「濃密オーバーナイトマスク」5選',
    category: 'skincare',
    categoryLabel: '🌙 【極上ナイトマスク5選】塗って寝るだけ美肌特集',
    introText: '「シートマスクを貼る時間がないほど疲れた夜でも美肌を諦めたくない」「寝ている間のエアコン乾燥から肌を完璧に守りたい」…濃密セラミド、レチノール、シカ成分配合で朝まで潤い密閉ラップする楽天大人気ナイトパック5選を徹底解説！',
    items: [
      { id: 'art-night-elixir-sleeping-gel-pack', keyword: 'エリクシール スリーピングジェルパック', label: 'ぷるぷるジェルが一晩中潤いを密着させ翌朝つや玉輝く肌へ導く' },
      { id: 'art-night-laneige-water-sleeping-mask', keyword: 'ラネージュ ウォータースリーピングマスク', label: 'プロバイオティクス複合体配合で睡眠中の肌バリアを集中補修' },
      { id: 'art-night-vt-cica-sleeping-mask', keyword: 'VT CICA スリーピングマスク', label: '1包使い切りで衛生的！寝ている間に赤みや肌荒れを穏やかに鎮静' },
      { id: 'art-night-innisfree-green-tea-mask', keyword: 'イニスフリー スリーピングマスク', label: '緑茶生エキス配合で日中に受けた紫外線ダメージと乾燥を集中ケア' },
      { id: 'art-night-lu-lu-lun-precious-cream', keyword: 'ルルルン プレシャスクリーム', label: '超濃厚エモリエントクリームが一晩中角層の潤いを逃さず閉じ込める' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による「48大達成記念・最新5選まとめ特集記事」作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_INFINITY_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐにフェイスラインの引き締まりや翌朝のぷるぷる感を実感できる高機能設計`,
          `毎日のセルフケアやナイトルーティンに無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
  ...
  console.log(`\n🎉 楽天API直接取得による「48大達成記念・最新5選まとめ特集記事」および個別商品記事の完全追加が完了しました！`);
}
