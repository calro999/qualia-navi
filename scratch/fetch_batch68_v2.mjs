...
const groups = [
  { group: 1, keywords: ["ネッククリーム レチノール", "首元 クリーム", "デコルテ 美容液", "ネックケア クリーム"] },
  { group: 2, keywords: ["毛穴吸引器", "ウォーターピーリング 毛穴", "美顔器 ピーリング 毛穴", "超音波ピーリング"] },
  { group: 3, keywords: ["ヘマチン ヘアトリートメント", "ケラチン ヘアオイル", "ヘマチン 原液", "ケラチン トリートメント 美容液"] },
  { group: 4, keywords: ["コーラル リップ", "コーラルピンク チーク", "コーラル リップティント", "イエベ春 リップ"] }
];
...
async function run() {
  for (const g of groups) {
    ...
    fs.writeFileSync(`scratch/rakuten_batch68_g${g.group}_verified.json`, JSON.stringify(valid, null, 2));
  }
  console.log("Finished fetching all 4 groups!");
}
