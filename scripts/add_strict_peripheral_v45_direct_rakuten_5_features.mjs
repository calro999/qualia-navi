...
// ① クエリ：ファンデーションブラシ 崩れない リキッドブラシ 毛穴消し 筋ムラなし, フラットトップブラシ（手やスポンジの摩擦・塗りムラを防ぎ、極細高密度毛でファンデーションを極薄均一に伸ばして毛穴レス美肌を作る専用ファンデブラシ）
// ② クエリ：頭皮クレンジング スカルプブラシ シリコン シャンプーブラシ 頭皮マッサージ, uka スカルプブラシ ケンザン（シャンプー時に指先では届かない毛穴の皮脂詰まりをスッキリ掻き出し、血行促進・顔のたるみ予防まで叶える人気シリコンスカルプブラシ）
const NEW_PERIPHERAL_V45_FEATURES = [
  {
    featureId: 'feature-5-foundation-brush-poreless-streak-free',
    title: '【2026年最新・楽天最安値】【ファンデーションブラシ＆毛穴レス極薄密着】筋ムラゼロで陶器肌を叶える「神ベースメイクブラシ」5選',
    category: 'makeup',
    categoryLabel: '✨ 【神ファンデーションブラシ5選】毛穴消去＆筋ムラゼロ陶器肌特集',
    introText: '「手やスポンジでファンデを塗ると厚塗りになったり毛穴落ちする」「ブラシの筋ムラが残って均一に塗れない」…超高密度極細フラット毛、オーバル型立体設計、リキッド・クッション・パウダリー全対応設計でプロ級の極薄ツヤ肌を作る楽天売れ筋ファンデーションブラシ5選を徹底検証！',
    items: [
      { id: 'art-fndbrush-shiseido-foundation-brush-131', keyword: '資生堂 ファンデーションブラシ 131', label: 'ベースメイクブラシの伝説的名品！斜めフラットヘッドで毛穴を完璧にカバー' },
      { id: 'art-fndbrush-sixplus-flat-top-kabuki-brush', keyword: 'SIXPLUS ファンデーションブラシ', label: '圧倒的人気のカブキブラシ！超濃密毛先で筋ムラを一切残さず均一密着' },
      { id: 'art-fndbrush-rosyrosa-multi-foundation-brush', keyword: 'ロージーローザ ファンデーションブラシ', label: 'プチプラ界の超実力派！全ファンデーション対応の柔らか極細毛' },
      { id: 'art-fndbrush-fillimilli-v-cut-foundation-brush', keyword: 'フィリミリ ファンデーションブラシ', label: '韓国オリーブヤング1位！Vカット設計で小鼻や目元までピタッとフィット' },
      { id: 'art-fndbrush-du-care-oval-seamless-base-brush', keyword: 'ファンデーションブラシ フラット', label: 'プロ仕様フラットトップ！ごく少量のファンデで陶器のようなツヤ肌を完成' }
    ]
  },
  {
    featureId: 'feature-5-silicone-scalp-massage-brush-cleanse',
    title: '【2026年最新・楽天最安値】【シリコンスカルプブラシ＆頭皮毛穴クレンジング】皮脂詰まり一掃＆リフトアップを叶える「神ケンザンブラシ」5選',
    category: 'skincare',
    categoryLabel: '🌿 【神スカルプブラシ5選】頭皮毛穴ディープクレンジング＆リフトアップ特集',
    introText: '「シャンプーしても夕方になると頭皮のベタつきやニオイが気になる」「デスクワークで頭皮がガチガチに凝り固まっている」…人間工学グリップ、絶妙な硬さのシリコン突起、インバス＆アウトバス両用設計で毛穴汚れを掻き出しサロン級ヘッドスパを叶える楽天売れ筋スカルプブラシ5選を徹底解説！',
    items: [
      { id: 'art-scalpbr-uka-scalp-brush-kenzan-black', keyword: 'uka スカルプブラシ ケンザン', label: 'スカルプブラシの絶対的王者！美容賢者絶賛の心地よい刺激で頭皮スッキリ' },
      { id: 'art-scalpbr-etvos-relaxing-scalp-brush-matte', keyword: 'エトヴォス スカルプブラシ', label: '大人気リラクシングブラシ！女性の手にフィットする握りやすさと程よい弾力' },
      { id: 'art-scalpbr-refa-heart-brush-for-scalp', keyword: 'リファ ハートブラシ スカルプ', label: 'Refa発の本格頭皮ケア！指圧のような心地よさでコリをほぐし血行促進' },
      { id: 'art-scalpbr-vemor-silicone-scalp-massager', keyword: 'スカルプブラシ シリコン 頭皮', label: '高耐久＆抗菌シリコン！毛穴の奥の皮脂汚れまでしっかり洗浄' },
      { id: 'art-scalpbr-shampoo-brush-deep-cleansing-spa', keyword: 'シャンプーブラシ 頭皮マッサージ', label: 'インバスで極上スパ体験！ネイルを傷めずサロン帰りのサラサラ美髪へ' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第45弾【純粋コスメ＆メイク・スカルプケア特化】）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V45_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐにファンデーションの毛穴レス極薄密着やスカルプブラシによる頭皮皮脂汚れの一掃・リフトアップ感を実感できる高機能設計`,
          `毎朝のベースメイクやバスタイムルーティンに無理なく組み込める快適な使用感・高い満足度`,
...
2. **肌や頭皮への優しさと持続性**: デリケートな肌でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'ベースメイクブラシ＆スカルプケアアナリスト',
        summaryKeyPoints: [
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアベースメイク＆スカルプケアアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第45弾【純粋コスメ＆メイク・スカルプケア特化】特集記事および個別商品記事の完全追加が完了しました！`);
}
