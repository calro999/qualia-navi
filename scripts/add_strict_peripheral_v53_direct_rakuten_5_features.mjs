...
// ① クエリ：まつげパーマ セルフ キット まつ毛パーマ ロッド サロン級 立ち上げ, まつげパーマ セット（毎朝のビューラー不要で、サロン級の根元立ち上げ＆綺麗な上向きカールを自宅で長期間キープするセルフまつ毛パーマキット）
// ② クエリ：ウォーターピーリング 超音波美顔器 毛穴洗浄 黒ずみ イオン導入 EMS, ウォーターピーリング（水と毎秒数万回の超音波振動の力で、肌に負担をかけずに古い角質や毛穴の皮脂汚れをミスト化して吹き飛ばす専用ウォーターピーラー美顔器）
const NEW_PERIPHERAL_V53_FEATURES = [
  {
    featureId: 'feature-5-self-eyelash-perm-kit-lift-curling',
    title: '【2026年最新・楽天最安値】【セルフまつげパーマキット＆サロン級カール】毎朝のビューラー不要で上向き持続する「神セルフまつパ」5選',
    category: 'makeup',
    categoryLabel: '👁️ 【神まつげパーマキット5選】セルフで簡単！根元立ち上げ特集',
    introText: '「毎朝ビューラーでまつ毛を上げても夕方には下がってしまう」「サロンに通う時間やコストを抑えたい」…シリコン製立体ロッド、ケラチントリートメント配合、初心者でも失敗しにくい低刺激・高密着グルー設計でパッチリ上向き目元を叶える楽天売れ筋まつげパーマキット5選を徹底検証！',
    items: [
      { id: 'art-lashperm-silky-rolls-eyelash-perm-kit-complete', keyword: 'まつげパーマ キット', label: 'セルフまつパの絶対的人気！サロンクオリティの上向きカールが1ヶ月持続' },
      { id: 'art-lashperm-keratin-lash-lift-diy-set-pro', keyword: 'まつ毛パーマ セルフ', label: 'ケラチン補修成分配合！まつ毛を傷めずふんわりナチュラルカール' },
      { id: 'art-lashperm-doll-lash-curl-silicone-pads-pack', keyword: 'まつげパーマ ロッド', label: 'サイズ豊富立体ロッド！まぶたの形や理想のカール感に合わせて選べる' },
      { id: 'art-lashperm-clear-glue-lash-lift-adhesive-water', keyword: 'まつげパーマ グルー', label: '水溶性クリアグルー！ロッドにまつ毛を1本1本綺麗に固定できる' },
      { id: 'art-lashperm-all-in-one-speed-lash-lift-box', keyword: 'まつげパーマ セット', label: '必要なツールが全揃い！届いてすぐに始められる初心者安心スターターキット' }
    ]
  },
  {
    featureId: 'feature-5-ultrasonic-water-peeling-facial-device',
    title: '【2026年最新・楽天最安値】【ウォーターピーリング美顔器＆超音波毛穴洗浄】水だけで角質・黒ずみを吹き飛ばす「神ピーラー美顔器」5選',
    category: 'skincare',
    categoryLabel: '✨ 【神ウォーターピーリング5選】超音波振動＆毛穴レスつるん肌特集',
    introText: '「鼻や顎のザラつきが気になるけれどスクラブは肌に負担」「化粧水の浸透が悪い」…毎秒約24,000〜30,000回の超音波振動、イオン導出入、EMSリフトケア搭載で水を吹きかけるだけで汚れをミスト化して弾き飛ばす楽天売れ筋ウォーターピーリング美顔器5選を徹底解説！',
    items: [
      { id: 'art-waterpeel-cosbeauty-aquapeeling-pro-ultrasonic', keyword: 'ウォーターピーリング', label: '超音波美顔器の絶対的定番！毎秒高周波振動で頑固な汚れをミスト化' },
      { id: 'art-waterpeel-yaman-circle-peeling-pro-water-lift', keyword: 'ヤーマン ピーリング', label: '美顔器のトップブランド！円形ヘッドで小鼻のキワまでしっかり密着' },
      { id: 'art-waterpeel-belulu-aquarufa-water-peeling-ems', keyword: '美ルル ウォーターピーリング', label: '大人気プチプラ多機能！イオン導入とEMSで引き締めケアまでこれ1台' },
      { id: 'art-waterpeel-water-peeling-ultrasonic-ion-cleanser', keyword: 'ウォーターピーリング 美顔器', label: 'IPX5防水仕様！お風呂で使えて毛穴の奥の皮脂汚れを一掃' },
      { id: 'art-waterpeel-pore-scrubber-microcurrent-facial-spatula', keyword: '超音波 ピーリング 美顔器', label: '高精度ステンレススパチュラ！肌を痛めず撫でるだけでツルツル陶器肌' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第53弾【純粋コスメ＆まつパキット・ウォーターピーラー特化】）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V53_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐにサロン級のまつ毛立ち上がり・上向き持続やウォーターピーリングによる水と超音波でのザラつき・黒ずみ一掃を実感できる高機能設計`,
          `月1回のセルフまつ毛お手入れや毎日のスキンケア前の毛穴洗浄に無理なく組み込める快適な使用感・高い満足度`,
...
2. **目元や肌への優しさと持続性**: デリケートな部位でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'アイラッシュ＆ポアデバイスアナリスト',
        summaryKeyPoints: [
        ...
        faqs: [
          {
            ...
            answer: `はい、毎日の習慣または推奨された周期（まつパは月1回等）で安心してお使いいただける安全性の高い設計となっております。`
          }
        ]
      };
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアアイラッシュ＆ポアトリートメントアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第53弾【純粋コスメ＆まつパキット・ウォーターピーラー特化】特集記事および個別商品記事の完全追加が完了しました！`);
}
