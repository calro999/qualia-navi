...
const queries = {
  t1: 'まつ毛美容液 色素沈着なし 伸びる',
  t2: 'CICA シートマスク 大容量 デイリー',
  t3: 'マグネット ネイル 微粒子 ジェル',
  t4: '電動 爪削り 足の爪 高齢者'
};
...
async function main() {
  ...
  fs.writeFileSync('scratch/batch162_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 162 products saved successfully to scratch/batch162_fetched.json!');
}
