...
// ① クエリ：つけまつげ のり 超強力 アイラッシュフィクサー ウォータープルーフ 剥がれない, つけまのり D-UP（まぶたの皮脂や汗・涙でも端から浮かない、1日中しっかり密着キープする超強力つけまつげ接着剤）
// ② クエリ：炭酸パック 毛穴 くすみ 炭酸ガスパック エステ級 透明感, 炭酸パック ジェル（自宅でエステ級の血行促進・毛穴引き締め・透明感アップを叶える高濃度炭酸ガスジェルパック）
const NEW_PERIPHERAL_V48_FEATURES = [
  {
    featureId: 'feature-5-false-eyelash-glue-adhesive-waterproof',
    title: '【2026年最新・楽天最安値】【超強力つけまつげのり＆絶対浮かない】汗・涙・皮脂に強い「神アイラッシュフィクサー」5選',
    category: 'makeup',
    categoryLabel: '👁️ 【神つけまつげのり5選】1日中剥がれない＆強力密着特集',
    introText: '「目頭や目尻からつけまつげが浮いてきて恥ずかしい」「汗や涙で接着剤が白くなって剥がれる」…医療用テープ処方、強力ウォータープルーフ、乾くと透明になる速乾設計で朝から夜まで鉄壁キープする楽天売れ筋つけまつげ接着剤5選を徹底検証！',
    items: [
      { id: 'art-lashglue-dup-eyelashes-fixer-ex-552', keyword: 'ディーアップ アイラッシュフィクサー', label: 'つけまのりの絶対王者！引っ張ってもびくともしない超強力ホールド力' },
      { id: 'art-lashglue-koji-spring-heart-eyelash-fix', keyword: 'コージー スプリングハート アイラッシュフィックス', label: 'プチプラ界のロングセラー！ラテックスフリー処方で肌に優しく高密着' },
      { id: 'art-lashglue-miche-bloomin-eyelash-glue-clear', keyword: 'ミッシュブルーミン アイラッシュグルー', label: 'コスメ賞多数受賞！目立たない極細筆と24時間強力キープ設計' },
      { id: 'art-lashglue-diamond-lash-eyelash-fixer', keyword: 'つけまつげ のり 強力', label: 'ウォータープルーフ最高峰！夏のレジャーや長時間のイベントでも安心' },
      { id: 'art-lashglue-dolly-wink-eyelash-fix-black', keyword: 'アイラッシュフィクサー つけまのり', label: '速乾クリアタイプ！初心者でも簡単に狙った位置に塗れる高精度ブラシ' }
    ]
  },
  {
    featureId: 'feature-5-carbonated-co2-bubble-gel-mask-spa',
    title: '【2026年最新・楽天最安値】【高濃度炭酸ガスパック＆毛穴・くすみ一掃】おうちでエステ級の生ツヤ肌を作る「神炭酸ジェルパック」5選',
    category: 'skincare',
    categoryLabel: '✨ 【神炭酸パック5選】エステ級！毛穴引き締め＆高濃度炭酸ガス特集',
    introText: '「肌のゴワつきやくすみが取れず化粧ノリが最悪」「毛穴の開きが目立ってファンデが落ちる」…ボーア効果による酸素供給、濃密炭酸マイクロバブル、美容液成分高配合で剥がした瞬間に陶器のような透明感とハリをもたらす楽天売れ筋炭酸パック5選を徹底解説！',
    items: [
      { id: 'art-co2mask-medicare-carbonated-gel-pack', keyword: 'メディオン 炭酸パック', label: '炭酸パックのパイオニア！皮膚科医開発の特許処方で圧倒的なキメと透明感' },
      { id: 'art-co2mask-dr-select-co2-gel-pack-pro', keyword: '炭酸パック 毛穴', label: '高濃度炭酸ガス発生！毛穴の奥の汚れを浮かせてキュッと引き締める' },
      { id: 'art-co2mask-ekato-precious-gel-pack-botanical', keyword: 'EKATO 炭酸パック', label: '持続型炭酸60分！洗い流し不要でぷるんと剥がせる極上エステ体験' },
      { id: 'art-co2mask-favorina-nano-aqua-carbonated-gel', keyword: 'フェヴリナ 炭酸パック', label: '累計販売数トップクラス！生の炭酸をその場で作る即効ツヤ肌ジェル' },
      { id: 'art-co2mask-bubble-clay-carbonic-peeling-mask', keyword: '炭酸ガスパック ジェル', label: '贅沢エイジングケア！血行を促しワントーン明るいふっくらハリ肌へ' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第48弾【純粋コスメ＆アイラッシュグルー・炭酸パック特化】）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V48_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐにつけまつげの浮き完全防止や炭酸ガスパックによる毛穴引き締め・エステ級の生ツヤ透明感を実感できる高機能設計`,
          `毎日のアイメイクや週に1〜2回のスペシャルスキンケアルーティンに無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'アイラッシュグルー＆炭酸スパアナリスト',
        summaryKeyPoints: [
        ...
        faqs: [
          {
            ...
            answer: `はい、毎日の習慣または推奨された頻度で安心してお使いいただける安全性の高い設計となっております。`
          }
        ]
      };
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアアイラッシュ＆スキンケアスパアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第48弾【純粋コスメ＆アイラッシュ・炭酸スパ特化】特集記事および個別商品記事の完全追加が完了しました！`);
}
