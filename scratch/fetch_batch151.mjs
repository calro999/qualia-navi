...
const queries = {
  t1: 'ヘアアイロン 耐熱 シリコン マット ホルダー ケース',
  t2: 'ホワイトニング led 歯 ホームホワイトニング 自宅',
  t3: 'ネイルライト ミニ コンパクト uv led ハンディ',
  t4: 'かかと クッション シリコン 踵 衝撃吸収 サポーター'
};
...
async function main() {
  ...
  fs.writeFileSync('scratch/batch151_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 151 products saved successfully to scratch/batch151_fetched.json!');
}
