...
// ① クエリ：アイメイクリムーバー ポイントメイクリムーバー 落ちないマスカラ, 二層式 リムーバー 目元（ティントやウォータープルーフマスカラを摩擦レスに落とすポイントメイクリムーバー）
// ② クエリ：シルク 枕カバー 美肌 髪 摩擦レス 絹, シルク枕カバー 洗える ファスナー（就寝中の顔の摩擦シワ・髪の摩擦ダメージをゼロにするシルク100%枕カバー）
const NEW_PERIPHERAL_V5_FEATURES = [
  {
    featureId: 'feature-5-point-makeup-remover-gentle',
    title: '【2026年最新・楽天最安値】【ポイントメイクリムーバー＆摩擦レス目元オフ】強力マスカラ・落ちないティントをつるんと浮かせる「神リムーバー」5選',
    category: 'skincare',
    categoryLabel: '👁️ 【神ポイントリムーバー5選】落ちないマスカラ＆ティント摩擦レスオフ特集',
    introText: '「強力ウォータープルーフマスカラやティントが落ちずにゴシゴシ擦ってしまい、目元のシワやまぶたのたるみが心配」「目に染みずに濃いアイメイクだけを瞬時に落としたい」…二層式オイル＆ウォーター、ヒアルロン酸・ビタミンB/E配合で皮膚の薄い目元・口元を保護しながらスルンと落とす楽天売れ筋ポイントメイクリムーバー5選を徹底検証！',
    items: [
      { id: 'art-remover-bifesta-eye-makeup-remover', keyword: 'ビフェスタ アイメイクアップリムーバー', label: 'こすらずスル落ち！ヒアルロン酸配合で目に染みずまつ毛を保護する国民的殿堂入りリムーバー' },
      { id: 'art-remover-chanel-demaquillant-yeux', keyword: 'シャネル デマキヤン ユー アンタンス', label: '落ちにくいアイメイクも瞬時にオフ！敏感な目元を優しく鎮静する最高峰デパコスリムーバー' },
      { id: 'art-remover-heroinemake-speedy-mascara', keyword: 'ヒロインメイク スピーディーマスカラリムーバー', label: 'まつ毛に直塗りコーム型！擦らず強力ウォータープルーフマスカラを溶かし落とす神アイテム' },
      { id: 'art-remover-clinique-take-the-day-off', keyword: 'クリニーク テイク ザ デイ オフ リムーバー', label: 'オイルと水の二層式でデリケートな目元・口元の落ちにくいメイクを瞬時に浮かせる名品' },
      { id: 'art-remover-etude-lip-eye-remover', keyword: 'エチュード リップ アイ リムーバー', label: '韓国コスメの濃密ティントも残さずオフする高コスパ二層式リムーバー' }
    ]
  },
  {
    featureId: 'feature-5-silk-pillowcase-hair-skin-care',
    title: '【2026年最新・楽天最安値】【最高級シルク100%枕カバー＆睡眠美容】寝返り摩擦による寝癖・アホ毛・肌の寝跡シワを防ぐ「神シルク枕カバー」5選',
    category: 'goods',
    categoryLabel: '🌙 【神シルク枕カバー5選】髪質改善・摩擦シワ防止＆睡眠美容特集',
    introText: '「朝起きると枕との摩擦で髪がパサパサ・爆発している」「横向き寝で顔に枕の跡やシワがついて消えない」…天然シルク100%（25匁・19匁最高峰生糸）、両面シルク、吸湿放湿性・抗菌性に優れた極上の滑らかさで睡眠中の美髪＆美肌を守り抜く楽天大人気シルク枕カバー5選を徹底解説！',
    items: [
      { id: 'art-pillow-cocoonist-silk-pillowcase', keyword: 'シルク 枕カバー 25匁 洗える 片面', label: '最高級25匁シルク採用！摩擦を極限まで抑えて翌朝の髪がつるんとなめらかにまとまる大ヒット' },
      { id: 'art-pillow-itawari-silk-pillow-cover', keyword: 'シルク 枕カバー ファスナー 美髪', label: 'ファスナー式でズレない！髪と素肌の水分量を保ち寝癖・枝毛・肌荒れを防止する人気カバー' },
      { id: 'art-pillow-silk-pillowcase-washable', keyword: 'シルク 枕カバー 洗える 封筒型', label: '自宅で手軽に洗えるウォッシャブルシルク！毎日の睡眠時間をエステ時間に変える高コスパ品' },
      { id: 'art-pillow-mulberry-silk-pillow-cover', keyword: 'シルク 枕カバー 19匁 両面', label: '天然桑絹100%の極上肌触りで顔の摩擦シワや寝跡を防ぐスキンケア枕カバー' },
      { id: 'art-pillow-premium-silk-pillowcase', keyword: 'シルク 枕カバー 紐留め 美容', label: 'どんな枕サイズにもフィットする紐留めタイプ！通気性抜群で敏感肌にも優しい' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第5弾）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V5_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに摩擦レスなメイク落ちや翌朝の髪のツヤ・まとまりを実感できる高機能設計`,
          `毎日のナイトケアや睡眠環境に無理なく組み込める快適な使用感・高い満足度`,
          `楽天市場のポイント高還元を活用することで実質最安値での継続が可能`
        ],
        cons: [
          `大人気アイテムのためセール期やキャンペーン時には一時的に欠品する場合がある`,
          `効果を最大化するために推奨された正しい使用手順やお洗濯方法を守ることが推奨される`
        ],
...
2. **肌や髪への優しさと持続性**: デリケートな目元や睡眠中の摩擦を防ぎ毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: '目元ケア＆ナイトビューティーアナリスト',
        summaryKeyPoints: [
        ...
        faqs: [
          {
            ...
            answer: `はい、毎日のナイトケアルーティンまたは睡眠環境として安心してお使いいただける安全性の高い設計となっております。`
          }
        ]
      };
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアナイトビューティーアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第5弾特集記事および個別商品記事の完全追加が完了しました！`);
}
