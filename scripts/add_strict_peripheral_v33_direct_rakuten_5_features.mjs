...
// ① クエリ：リップスクラブ 角質ケア 唇 ケア レブロン リップスクラブ, リップ ゴマージュ（唇のガサガサ皮剥け・縦ジワ・くすみを洗い流し不要のシュガースクラブで即座にぷるんと滑らかにするリップ専用スクラブ）
// ② クエリ：ホットビューラー 充電式 まつ毛カーラー まつげ 上向きキープ, ホットカーラー まつげ（雨の日や湿気でもまつ毛が下がらない！熱の力で1日中くるんと上向き美カールを固定する最新型充電式ホットビューラー）
const NEW_PERIPHERAL_V33_FEATURES = [
  {
    featureId: 'feature-5-lip-scrub-exfoliating-sugar-balm',
    title: '【2026年最新・楽天最安値】【リップスクラブ＆唇のガサガサ角質オフ】洗い流し不要シュガーバームでぷるツヤ唇に導く「神リップゴマージュ」5選',
    category: 'skincare',
    categoryLabel: '💋 【神リップスクラブ5選】唇の皮剥け・くすみ角質オフ特集',
    introText: '「口紅を塗ると唇の皮剥けが目立って綺麗に乗らない」「唇のくすみや縦ジワをケアして血色感を取り戻したい」…微細シュガースクラブ、高保湿フルーツオイル、洗い流し不要のスティック処方で角質ケアとプランプ保湿を同時に叶える楽天売れ筋リップスクラブ5選を徹底検証！',
    items: [
      { id: 'art-lipscrub-revlon-kiss-sugar-scrub', keyword: 'レブロン キス シュガースクラブ', label: 'リップスクラブの絶対的大定番！洗い流さないシュガースクラブでぷるんとした赤ちゃん唇へ' },
      { id: 'art-lipscrub-lush-lip-scrub-bubblegum', keyword: 'LUSH リップスクラブ', label: '天然シュガー＆ホホバオイル！美味しそうなフレーバーで角質を優しくオフする大人気ジャー' },
      { id: 'art-lipscrub-canmake-plump-lip-care-scrub', keyword: 'キャンメイク リップスクラブ', label: 'プチプラ界の神コスパ！プランパー効果も備えた繰り出し式シュガーケアスクラブ' },
      { id: 'art-lipscrub-dior-lip-sugar-scrub-glow', keyword: 'ディオール アディクト スクラブ', label: 'デパコスの最高峰！体温でとろけてほんのりピンクに色づく贅沢トリートメント' },
      { id: 'art-lipscrub-innisfree-lip-sleeping-mask', keyword: 'リップスクラブ スティック 保湿', label: '寝ている間に集中ケア！ガサガサ唇の皮剥けを即座にリセットする高保湿バーム' }
    ]
  },
  {
    featureId: 'feature-5-heated-eyelash-curler-rechargeable',
    title: '【2026年最新・楽天最安値】【充電式ホットビューラー＆まつ毛上向き24時間キープ】雨・マスクの湿気でも絶対に下がらない「神まつ毛カーラー」5選',
    category: 'device',
    categoryLabel: '👁️ 【神ホットビューラー5選】湿気耐久＆上向き24H美カール特集',
    introText: '「朝ビューラーで上げてもマスクの湿気や雨で夕方にはまつ毛が下がる」「普通のビューラーだとまつ毛が抜けたり切れたりする」…Type-C急速充電、10秒瞬間余熱、まつ毛を挟むコーム＆挟み型両対応、まぶたの火傷防止セーフティガード設計で夕方まで完璧な上向きCカールを維持する楽天売れ筋ホットビューラー5選を徹底解説！',
    items: [
      { id: 'art-hotlash-panasonic-matsuge-kurun', keyword: 'パナソニック まつげくるん', label: 'ホットビューラーの代名詞！ダブルヒーター搭載で根元から立ち上げる王道名品' },
      { id: 'art-hotlash-type-c-fast-heated-curler', keyword: 'ホットビューラー 充電式 まつ毛', label: 'Type-C急速充電＆10秒予熱！忙しい朝でも待たずに使える最新デジタル温度表示モデル' },
      { id: 'art-hotlash-clamp-heated-eyelash-curler', keyword: 'ホットビューラー 挟むタイプ', label: '挟むだけで根本からグッと立ち上げ！初心者でも一発で扇形美まつ毛が作れる挟み型' },
      { id: 'art-hotlash-compact-comb-lash-lifter', keyword: 'ホットビューラー コーム型', label: 'マスカラ後のダマ取りにも最適！下まつ毛や目頭・目尻の短いまつ毛も逃さない極細コーム' },
      { id: 'art-hotlash-multi-temp-eyelash-perm-iron', keyword: 'まつ毛カーラー ホット', label: '3段階温度調節で自まつ毛・マツエク・つけまにも対応する万能カールアイロン' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第33弾【純粋コスメ＆美容ツール特化】）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V33_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに唇の皮剥け角質オフやホットビューラーによる24時間上向きカールの持続を実感できる高機能設計`,
          `毎日のリップケアやアイメイクルーティンに無理なく組み込める快適な使用感・高い満足度`,
...
2. **唇や目元への優しさと持続性**: デリケートな部位でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'リップケア＆アイラッシュツールアナリスト',
        summaryKeyPoints: [
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアリップケア＆アイラッシュツールアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第33弾【純粋コスメ＆メイクツール特化】特集記事および個別商品記事の完全追加が完了しました！`);
}
