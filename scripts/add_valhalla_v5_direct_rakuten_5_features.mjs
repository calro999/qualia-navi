...
const NEW_VALHALLA_V5_FEATURES = [
  // 特集①：【美肌クレンジングミルク＆低刺激うるおいオフ】超乾燥肌・敏感肌でもつっぱらない！「神クレンジングミルク」5選
  {
    featureId: 'feature-5-cleansing-milk-gentle-moisture',
    title: '【2026年最新・楽天最安値】【美肌クレンジングミルク＆低刺激うるおいオフ】超乾燥肌・敏感肌でもつっぱらない！「神クレンジングミルク」5選',
    category: 'skincare',
    categoryLabel: '🫧 【神クレンジングミルク5選】低刺激うるおいオフ特集',
    introText: '「洗顔後の肌がつっぱってヒリつく」「肌のバリア機能を守りながらメイクだけを優しく浮かせたい」…乳液のような滑らかなミルク、天然由来セラミド、アミノ酸系保湿成分配合で洗い上がりもしっとりモチモチ肌を保つ楽天売れ筋クレンジングミルク5選を徹底検証！',
    items: [
      { id: 'art-milk-covermark-treatment-cleansing', keyword: 'カバーマーク トリートメント クレンジング ミルク', label: '美容液成分89%配合！圧倒的保湿力とメイク落ちを両立する国民的ミルクの絶対女王' },
      { id: 'art-milk-chant-a-charm-cleansing', keyword: 'チャントアチャーム クレンジングミルク', label: 'ミルクからオイルへテクスチャー変化！オーガニック自社農場ハーブの優しさ' },
      { id: 'art-milk-minon-amino-moist-milky', keyword: 'ミノン アミノモイスト ミルキィ クレンジング', label: '9種の保潤アミノ酸配合で肌バリアを守りながら優しく落とす敏感肌用名品' },
      { id: 'art-milk-weleda-gentle-cleansing', keyword: 'ヴェレダ モイスチャークレンジングミルク', label: 'オーガニックホホバオイル配合でキメを整えながら洗うスイス老舗コスメ' },
      { id: 'art-milk-muji-mild-cleansing-milk', keyword: '無印良品 マイルドクレンジングミルク', label: 'アンズ果汁・モモ葉エキス配合で肌への負担を最小限に抑えた高コスパミルク' }
    ]
  },
  // 特集②：【極上まつ毛パーマセット＆セルフ美カール】サロンに行かずに自宅でサロン級の立ち上げカールを作る「神セルフまつ毛パーマキット」5選
  {
    featureId: 'feature-5-self-eyelash-perm-kit',
    title: '【2026年最新・楽天最安値】【極上まつ毛パーマセット＆セルフ美カール】サロンに行かずに自宅でサロン級の立ち上げカールを作る「神セルフまつ毛パーマキット」5選',
    category: 'device',
    categoryLabel: '👁️ 【神セルフまつパキット5選】自宅でサロン級美カール特集',
    introText: '「毎月のまつ毛サロン代を節約したい」「自分の理想の立ち上げ角度でセルフパーマをかけたい」…低刺激処方カール剤、密着シリコンロッド各種サイズ、初心者向け専用グルー完備で1回あたり数百円でサロン級カールを再現する楽天大人気まつパキット5選を徹底解説！',
    items: [
      { id: 'art-perm-silky-rolls-lash-lift-kit', keyword: 'まつ毛パーマ セルフ キット', label: '初心者でも失敗しない！豊富なシリコンロッドと低刺激グルー完備の爆売れキット' },
      { id: 'art-perm-aroma-lash-perm-set', keyword: 'セルフまつ毛パーマ ロッド', label: '立ち上げ用からナチュラルカールまで目元に合わせて選べるプロ仕様ロッド' },
      { id: 'art-perm-korea-lash-lift-glue', keyword: 'まつ毛パーマ グルー', label: '速乾高密着でロッドへのまつ毛固定が驚くほど簡単になるプロ愛用グルー' },
      { id: 'art-perm-lash-combing-y-brush', keyword: 'まつ毛パーマ Y字ブラシ', label: 'まつ毛を一本一本セパレートして均一に巻き上げる必須神ツール' },
      { id: 'art-perm-keratin-lash-coating-essence', keyword: 'まつ毛 ケラチン トリートメント', label: 'パーマ後のまつ毛にケラチンを補給しツヤとカールの持ちを倍増させる美容液' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による「84大達成・最新5選まとめ特集記事」作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_VALHALLA_V5_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐにしっとり潤う極上ミルクオフやサロン級の立ち上げ美カールを実感できる高機能設計`,
          `毎日のスキンケアやセルフ美容習慣に無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'クレンジングミルク＆アイラッシュアナリスト',
        summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得による「84大達成・最新5選まとめ特集記事」および個別商品記事の完全追加が完了しました！`);
}
