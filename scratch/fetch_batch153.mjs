...
async function main() {
  ...
  fs.writeFileSync('scratch/batch153_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 153 products saved successfully to scratch/batch153_fetched.json!');
}
