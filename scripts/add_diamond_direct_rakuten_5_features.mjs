...
// 祝！【全60大メガ特集・超絶大台突破記念】
const NEW_DIAMOND_FEATURES = [
  // 特集①：【美肌トナーパッド＆角質ふき取り】朝の洗顔代わり＆毛穴引き締めに最適な「神トナーパッド」5選
  {
    featureId: 'feature-5-toner-pad-skin-smoothing',
    title: '【2026年最新・楽天最安値】【美肌トナーパッド＆角質ふき取り】朝の洗顔代わり＆毛穴引き締めに最適な「神トナーパッド」5選',
    category: 'skincare',
    categoryLabel: '🫧 【神トナーパッド5選】時短角質ケア＆部分パック特集',
    introText: '「忙しい朝の洗顔と角質ケアをサッと1枚で終わらせたい」「メイク前に部分パックして毛穴を引き締め化粧ノリを爆上げしたい」…CICA、ドクダミ、ティーツリー、ピーリング成分配合で楽天市場売上上位を独占する神トナーパッド5選を徹底検証！',
    items: [
      { id: 'art-pad-anua-heartleaf-toner-pad', keyword: 'Anua ドクダミ 77 トナーパッド', label: 'ドクダミエキス77%配合で赤みや肌荒れを瞬時に落ち着かせる大人気パッド' },
      { id: 'art-pad-medicube-zero-pore-pad', keyword: 'メディキューブ ゼロ毛穴パッド', label: '特許取得の毛穴引き締め成分とエンボス面で頑固な皮脂と角栓を一拭きオフ' },
      { id: 'art-pad-vt-cica-mild-toner-pad', keyword: 'VT CICA マイルド トナーパッド', label: '弱酸性処方とシカヒアルロン配合で敏感肌にも優しい国民的シカパッド' },
      { id: 'art-pad-skin-food-carrot-pad', keyword: 'スキンフード キャロット パッド', label: '厚手のワッフルコットンとニンジン種子油でしっとり潤い鎮静パック' },
      { id: 'art-pad-torriden-dive-in-pad', keyword: 'トリデン ダイブイン トナーパッド', label: '5重複合ヒアルロン酸配合で角層深くまで水分チャージする超保湿パッド' }
    ]
  },
  // 特集②：【極上まつ毛パーマ級ホットビューラー】夕方まで下がらない！くるんと上向きカールをキープする「神ホットビューラー」5選
  {
    featureId: 'feature-5-heated-eyelash-curler',
    title: '【2026年最新・楽天最安値】【極上まつ毛パーマ級ホットビューラー】夕方まで下がらない！くるんと上向きカールをキープする「神ホットビューラー」5選',
    category: 'device',
    categoryLabel: '👁️ 【神ホットビューラー5選】上向き美カール持続特集',
    introText: '「ビューラーで上げても時間が経つとまつ毛が下がってしまう」「マスカラのダマを取りながら綺麗なセパレートを作りたい」…温熱コーム、適温マーク、USB充電式でまつ毛パーマ級の美カールを一日中持続させる楽天大人気ホットビューラー5選を徹底解説！',
    items: [
      { id: 'art-curler-panasonic-matsuge-kurun', keyword: 'パナソニック まつげくるん セパレートロング', label: 'ダブルヒーター搭載で根元から毛先まで扇状の美セパレートロングを叶える' },
      { id: 'art-curler-anlan-heated-curler', keyword: 'ANLAN ホットビューラー', label: '10秒急速予熱×3段階温度調節で頑固な下向きまつ毛も一瞬で立ち上げる' },
      { id: 'art-curler-salonia-lash-curler', keyword: 'ホットビューラー 充電式', label: 'USB-C急速充電対応で持ち運びにも便利なスタイリッシュホットビューラー' },
      { id: 'art-curler-kai-push-up-curler', keyword: '貝印 ホットビューラー', label: '折りたたみ式でポーチにすっきり収まる手軽な人気ビューラー' },
      { id: 'art-curler-koizumi-heated-curler', keyword: 'コイズミ アイラッシュカーラー', label: 'ボリュームコームでマスカラ後の束感まつ毛メイクも美しく整える' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による【祝！全60大メガ特集・超絶大台突破記念記事】作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_DIAMOND_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに肌のキメ滑らかさや夕方まで下がらない美カールを実感できる高機能設計`,
          `朝の時短ルーティンやアイメイク習慣に無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'トナーパッド＆アイラッシュアナリスト',
        summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得による【祝！全60大メガ特集・超絶大台突破記念記事】および個別商品記事の完全追加が完了しました！`);
}
