...
// ① クエリ：アイシャドウブラシセット 熊野筆 アイメイクブラシ ぼかし グラデーション, メイクブラシ アイシャドウ（単色塗りから繊細な締め色・涙袋・クリースぼかしまでプロ級のグラデーションアイを完成させる専用アイシャドウブラシセット）
// ② クエリ：あほ毛止め スティック アホ毛 マスカラ ヘアスティック まとめ髪 前髪キープ, ポイントリペア（飛び出るアホ毛や乱れた前髪・おくれ毛をベタつかず固めずにサッと撫でるだけで瞬時に整えるマスカラ型ヘアスティック）
const NEW_PERIPHERAL_V42_FEATURES = [
  {
    featureId: 'feature-5-eyeshadow-brush-set-gradation-blending',
    title: '【2026年最新・楽天最安値】【アイシャドウブラシセット＆プロ級ぼかしグラデ】誰でも境目ゼロの美発色アイを作る「神アイメイクブラシ」5選',
    category: 'makeup',
    categoryLabel: '👁️ 【神アイシャドウブラシセット5選】境目ゼロぼかし＆グラデーション特集',
    introText: '「指やチップだとアイシャドウの境目がクッキリして不自然」「濃い色のグラデーションが上手くぼかせない」…高級極細人工毛、斜めアングルカット、クリース用ブレンディングブラシ設計で粉含み抜群＆ひと塗りでプロ級の濡れツヤぼかしを作る楽天売れ筋アイシャドウブラシ5選を徹底検証！',
    items: [
      { id: 'art-eyebrush-sixplus-eyeshadow-brush-set-coffee', keyword: 'SIXPLUS アイシャドウブラシ', label: 'メイクブラシの絶対王者！ふわふわの肌触りと絶妙なコシでグラデーション自在' },
      { id: 'art-eyebrush-ducato-blending-eyeshadow-brush', keyword: 'ロージーローザ アイシャドウブラシ', label: 'プチプラ界の神ツール！適度な粉含みと柔らか毛先で境目を綺麗にぼかす' },
      { id: 'art-eyebrush-kumano-fude-natural-hair-eye-set', keyword: '熊野筆 アイシャドウブラシ', label: '伝統工芸の最高峰！職人手作りの極上毛先で繊細な目元にも摩擦レス' },
      { id: 'art-eyebrush-du care-professional-eye-makeup-brushes', keyword: 'アイシャドウ ブラシ セット', label: 'ベース・ミディアム・締め色・涙袋まで全て揃う高コスパ完全セット' },
      { id: 'art-eyebrush-fillimilli-eye-brush-pro-collection', keyword: 'フィリミリ アイシャドウブラシ', label: '韓国オリーブヤング大ヒット！K-POPアイドルのような繊細アイを叶える' }
    ]
  },
  {
    featureId: 'feature-5-hair-mascara-stick-flyaway-tamer',
    title: '【2026年最新・楽天最安値】【アホ毛スティック＆前髪キープマスカラ】ピタッと抑えて白くならない「神ポイントヘアリペア」5選',
    category: 'skincare',
    categoryLabel: '✨ 【神アホ毛マスカラ5選】飛び出るアホ毛・前髪キープ特集',
    introText: '「頭頂部のぴょんぴょん飛び出るアホ毛で髪がボサボサに見える」「前髪の束感を固めずにキープしたい」…大型スパイラルマスカラブラシ、ベタつかないノンシリコンジュレ、速乾高密着キープ処方で手を汚さずサッと撫でるだけで清潔感あふれる美髪に整える楽天売れ筋ポイントヘアスティック5選を徹底解説！',
    items: [
      { id: 'art-hairstick-plus-eau-point-repair-brush', keyword: 'プリュスオー ポイントリペア', label: 'アホ毛マスカラの絶対王者！大きめブラシでひと撫でアホ毛を消し去る大ヒット品' },
      { id: 'art-hairstick-matomage-hair-styling-stick-super-hold', keyword: 'マトメージュ 前髪スティック', label: 'まとめ髪の大定番！バリバリに固めず前髪の毛流れとアホ毛をしっかりキープ' },
      { id: 'art-hairstick-cezanne-hair-mascara-tamer', keyword: 'セザンヌ ヘアケアマスカラ', label: 'プチプラ高機能！頭頂部のアホ毛やおくれ毛をベタつかず整えるクリア処方' },
      { id: 'art-hairstick-dian-perfect-beauty-maegami-stick', keyword: 'ダイアン 前髪スティック', label: 'オーガニックアルガンオイル配合！ツヤを与えながら雨の日の湿気崩れを防止' },
      { id: 'art-hairstick-milbon-elujuda-point-care-stick', keyword: 'ミルボン ポイントケアスティック', label: 'サロン専売の最高品質！飛び出る細かい毛を包み込みサラサラにキープ' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第42弾【純粋コスメ＆メイク・ヘアケアツール特化】）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V42_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐにアイシャドウの境目ゼロぼかしグラデーションやアホ毛スティックによる飛び出る浮き毛の瞬間密着補修を実感できる高機能設計`,
          `毎朝のアイメイクやヘアスタイリングルーティンに無理なく組み込める快適な使用感・高い満足度`,
...
2. **目元や髪への優しさと持続性**: デリケートな部位でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'アイメイクブラシ＆ポイントヘアケアアナリスト',
        summaryKeyPoints: [
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアアイメイク＆ヘアスタイリングアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第42弾【純粋コスメ＆メイク・ヘアケア特化】特集記事および個別商品記事の完全追加が完了しました！`);
}
