...
// カニバリズムを完全に回避した「高CVR周辺ロングテール検索クエリ特化」の新規5選特集（2テーマ・計10商品）
const NEW_LONGTAIL_FEATURES = [
  // 新規特集①：【首・デコルテ年齢線＆ネッククリーム】スマホ首や加齢による横ジワ・たるみを引き締める「神ネックケア」5選
  // （クエリ：首のシワ クリーム、デコルテ たるみ 保湿、ネッククリーム ナイアシンアミド）
  {
    featureId: 'feature-5-neck-cream-decollete-firming',
    title: '【2026年最新・楽天最安値】【首・デコルテ年齢線＆ネッククリーム】スマホ首や加齢による横ジワ・たるみを集中リフトする「神ネックケアクリーム」5選',
    category: 'skincare',
    categoryLabel: '✨ 【神ネッククリーム5選】首の横ジワ＆デコルテ引き締め特集',
    introText: '「スマホの見過ぎで首に深い横ジワがくっきり刻まれてしまった」「首元やデコルテの皮膚が薄くたるんで老けて見える」…首元専用のペプチド複合体、ナイアシンアミド、レチノール誘導体、高純度植物オイル配合でピンと張った若々しいネックラインを育む楽天売れ筋ネッククリーム5選を徹底検証！',
    items: [
      { id: 'art-neck-clarins-extra-firming-neck', keyword: 'クラランス ファーミング EX ネック デコルテ', label: 'ひまわりの有用成分とシアバターで首元の肌にしなやかなハリを与えるネックケアの金字塔' },
      { id: 'art-neck-polaba-neck-cream', keyword: 'ネッククリーム シワ改善 ナイアシンアミド', label: '有効成分ナイアシンアミド配合で真皮からシワ改善と美白を同時に叶える医薬部外品' },
      { id: 'art-neck-sisley-creme-pour-le-cou', keyword: 'ネッククリーム エイジングケア', label: '首元の特殊な皮膚構造に着目しシャープですっきりとしたネックラインへ整える' },
      { id: 'art-neck-meditherapy-neck-patch', keyword: '首 シワ パック パッチ', label: '寝ている間に首の横ジワを密着ラッピングして集中浸透させる大ヒットネックパッチ' },
      { id: 'art-neck-hanyul-yuja-neck-cream', keyword: 'ネック デコルテ クリーム 保湿', label: 'ベタつかないシルキーな質感で洋服や寝具につかず朝晩快適にケアできる高コスパクリーム' }
    ]
  },
  // 新規特集②：【手指のシワ・浮き出た血管＆老け手ハンドセラム】年齢が出やすい手の甲をふっくら透明白肌へ導く「神ハンド美容液」5選
  // （クエリ：手の甲 シワ 美容液、老け手 ハンドクリーム、手の血管 保湿 ナイアシンアミド）
  {
    featureId: 'feature-5-hand-serum-aging-vein-care',
    title: '【2026年最新・楽天最安値】【手指のシワ・浮き出た血管＆老け手ハンドセラム】年齢が出やすい手の甲をふっくら透明白肌へ導く「神ハンド美容液」5選',
    category: 'bodycare',
    categoryLabel: '💅 【神ハンド美容液5選】老け手シワ改善＆血管カバー特集',
    introText: '「手の甲の血管が浮き出てゴツゴツして見える」「水仕事や紫外線で手の甲がシワシワになり実年齢より老けて見える」…手肌専用の高保水ヒアルロン酸、ナイアシンアミド、真珠エキス、ヒト型セラミド配合でベタつかず内側からふっくらハリ肌を再生する楽天大人気ハンド美容液5選を徹底解説！',
    items: [
      { id: 'art-hand-sirojam-hand-serum', keyword: 'シロジャム ハンドセラム', label: '水分量たっぷりのジェルが手の甲に潤いを閉じ込めシワ改善とシミ予防を両立する大ヒット美容液' },
      { id: 'art-hand-shiro-hand-serum-white', keyword: 'SHIRO ハンド美容液', label: 'アロエや酒かすエキス配合で手肌にスッとなじみ上品な香りと透明感を与える名品' },
      { id: 'art-hand-loccitane-immortelle-hand', keyword: 'ロクシタン イモーテル ハンドセラム', label: '永久花イモーテルの生命力で手の甲のキメを整えふっくら若々しい手元へ導く' },
      { id: 'art-hand-atrix-beauty-charge-night', keyword: 'アトリックス ビューティーチャージ ナイトスペリア', label: 'ローヤルゼリーエキス配合のカプセルが寝ている間に手肌深層まで浸透する国民的夜美容' },
      { id: 'art-hand-hands-a-pro-serum', keyword: 'ハンドセラム シワ改善 医薬部外品', label: '水仕事でも落ちにくいプロ仕様の皮膜バリア技術で一日中しっとり手肌をガード' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による「86大達成・周辺クエリ＆カニバリズム回避5選特集記事」作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_LONGTAIL_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに首元の引き締まり感や手の甲のふっくら透明感を実感できる高機能設計`,
          `毎日のスキンケアやハンドケアルーティンに無理なく組み込める快適な使用感・高い満足度`,
...
2. **デリケートな皮膚への優しさと持続性**: デリケートな状態でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
  ...
  console.log(`\n🎉 楽天API直接取得による「86大達成・周辺クエリ＆カニバリズム回避5選特集記事」および個別商品記事の完全追加が完了しました！`);
}
