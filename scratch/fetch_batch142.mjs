...
const queries = {
  t1: 'バスピロー お風呂 枕 吸盤 防水',
  t2: 'かかと 角質 ガラス ヤスリ ナノ',
  t3: '足湯 バケツ 折りたたみ フットバス 保温',
  t4: 'ホットビューラー 挟む クリップ 充電式'
};
...
async function main() {
  ...
  fs.writeFileSync('scratch/batch142_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 142 products saved successfully to scratch/batch142_fetched.json!');
}
