...
const queries = {
  t1: 'ドライヤー ディフューザー カール パーマ',
  t2: 'LED コンパクトミラー 拡大鏡 充電式 女優ミラー',
  t3: 'ドライヤーホルダー 壁掛け 穴あけ不要 マグネット',
  t4: 'ネイル 集塵機 ダストコレクター 静音 ジェルネイル'
};
...
async function main() {
  ...
  fs.writeFileSync('scratch/batch140_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 140 products saved successfully to scratch/batch140_fetched.json!');
}
