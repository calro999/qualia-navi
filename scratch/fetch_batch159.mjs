...
const queries = {
  t1: '電動頭皮ブラシ ヘッドスパ EMS',
  t2: 'スカルプブラシ ケンザン シャンプー',
  t3: 'ナイトブラ 育乳 補正 脇高',
  t4: 'メイクスポンジ パフ 水で膨らむ'
};
...
async function main() {
  ...
  fs.writeFileSync('scratch/batch159_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 159 products saved successfully to scratch/batch159_fetched.json!');
}
