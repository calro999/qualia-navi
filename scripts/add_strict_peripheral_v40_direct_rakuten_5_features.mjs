...
// ① クエリ：ポイントコンシーラー シミ隠し ニキビ跡 クマ カバー ペンシルコンシーラー, スティックコンシーラー（気になるピンポイントの濃いシミ・ニキビ跡・小鼻の赤みを厚塗り感ゼロで狙い撃ちカバーする高密着ポイントコンシーラー）
// ② クエリ：あぶらとり紙 麻 天然 和紙 皮脂吸着 化粧直し サラサラ, 京都 あぶらとり紙（ファンデーションを崩さずに過剰な皮脂テカリだけを瞬間吸収し、外出先でも瞬時に陶器肌へリセットする高級天然和紙あぶらとり紙）
const NEW_PERIPHERAL_V40_FEATURES = [
  {
    featureId: 'feature-5-spot-concealer-pencil-stick-cover',
    title: '【2026年最新・楽天最安値】【ポイントコンシーラー＆シミ・ニキビ跡狙い撃ち】厚塗り感ゼロで消し去る「神スポットカバーペンシル」5選',
    category: 'makeup',
    categoryLabel: '✨ 【神ポイントコンシーラー5選】シミ・ニキビ跡ピンポイント消去特集',
    introText: '「リキッドコンシーラーだとシミが透けて隠れない」「広範囲に塗ると厚塗り感が出てシワに溜まる」…極細ペンシル＆クレヨン芯、高濃度ピグメント、ウォータープルーフ高密着密閉技術でピンポイントの頑固なシミ・ニキビ跡・赤みを瞬時にカバーする楽天売れ筋ポイントコンシーラー5選を徹底検証！',
    items: [
      { id: 'art-spotcon-thesaem-cover-perfection-pot-concealer', keyword: 'ザセム ポットコンシーラー', label: 'カバー力の神！濃いシミやニキビ跡をピタッと高密着で隠す大ヒットポット' },
      { id: 'art-spotcon-canmake-color-stick-concealer', keyword: 'キャンメイク コンシーラー スティック', label: 'プチプラ界のカバー王！滑らかな伸びと高いカバー力で肌悩みをリセット' },
      { id: 'art-spotcon-kate-stick-concealer-smooth-cover', keyword: 'ケイト スティックコンシーラー', label: '密着ハイカバー！肌と一体化して浮かないロングセラーコンシーラー' },
      { id: 'art-spotcon-shiseido-spotscover-foundation', keyword: '資生堂 スポッツカバー ファウンデイション', label: '伝説のシミ隠し名品！ごく少量で頑固なアザや濃いシミを完璧にカバー' },
      { id: 'art-spotcon-daisy-doll-color-correcting-concealer', keyword: 'コンシーラー ペンシル シミ隠し', label: '極細芯で狙い通り！ピンポイントでホクロやニキビ跡を消し去る専用ペンシル' }
    ]
  },
  {
    featureId: 'feature-5-oil-blotting-paper-natural-linen-matte',
    title: '【2026年最新・楽天最安値】【高級天然和紙あぶらとり紙＆皮脂テカリ瞬間吸収】メイクを崩さずサラサラ陶器肌にする「神あぶらとり紙」5選',
    category: 'skincare',
    categoryLabel: '🌿 【神あぶらとり紙5選】メイク崩さず皮脂吸着＆陶器肌リセット特集',
    introText: '「午後になるとTゾーンや小鼻がギトギトにテカる」「パウダーを重ねると毛穴落ちして厚塗りになる」…天然麻100%、京都金箔打紙製法、パウダー付き和紙処方で必要な水分を残しながら過剰皮脂だけを吸着する楽天売れ筋あぶらとり紙5選を徹底解説！',
    items: [
      { id: 'art-blotpaper-yojiya-oil-blotting-paper-kyoto', keyword: 'よーじや あぶらとり紙', label: '京都発祥の絶対的レジェンド！金箔打紙製法による驚異の皮脂吸収力' },
      { id: 'art-blotpaper-gatsby-oil-clear-film-powder-sheet', keyword: 'あぶらとり紙 パウダー', label: '皮脂吸収パウダー入り！取った瞬間からサラサラの陶器肌にリセット' },
      { id: 'art-blotpaper-shiseido-oil-blotting-paper-linen', keyword: '資生堂 あぶらとり紙', label: '天然麻100%の上質な肌触り！肌に必要な潤いを奪わずテカリだけをオフ' },
      { id: 'art-blotpaper-dinto-natural-oil-control-paper', keyword: 'あぶらとり紙 大容量 天然', label: '大容量で毎日惜しみなく使える！メイク直しを格上げする高機能和紙' },
      { id: 'art-blotpaper-koji-charcoal-oil-absorbing-sheets', keyword: 'あぶらとり紙 竹炭', label: '竹炭微粒子練り込み！毛穴の奥の酸化皮脂までスッキリ吸着するブラックシート' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第40弾【純粋コスメ＆メイク・皮脂ケア特化】）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V40_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに頑固なシミ・ニキビ跡の厚塗り感ゼロ消去や高級あぶらとり紙による過剰皮脂の瞬間吸着・陶器肌リセットを実感できる高機能設計`,
          `毎朝のベースメイクや日中の化粧直しルーティンに無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'ベースメイク補正＆皮脂コントロールアナリスト',
        summaryKeyPoints: [
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアベースメイク＆スキンケアアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第40弾【純粋コスメ＆メイク・皮脂ケア特化】特集記事および個別商品記事の完全追加が完了しました！`);
}
