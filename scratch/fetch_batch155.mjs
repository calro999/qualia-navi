...
async function main() {
  ...
  fs.writeFileSync('scratch/batch155_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 155 products saved successfully to scratch/batch155_fetched.json!');
}
