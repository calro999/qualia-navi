...
const NEW_OLYMPUS_FEATURES = [
  // 特集①：【美髪スカルプエッセンス＆頭皮育毛ローション】薄毛・抜け毛・頭皮の乾燥を防ぎ根元からふんわり立ち上げる「神頭皮美容液」5選
  {
    featureId: 'feature-5-scalp-essence-hair-growth',
    title: '【2026年最新・楽天最安値】【美髪スカルプエッセンス＆頭皮育毛ローション】薄毛・抜け毛・頭皮の乾燥を防ぎ根元からふんわり立ち上げる「神頭皮美容液」5選',
    category: 'haircare',
    categoryLabel: '🫧 【神頭皮美容液5選】スカルプ育毛＆根元ボリューム特集',
    introText: '「分け目が目立ってきた」「頭皮の乾燥やフケ・かゆみを防ぎながら根本からコシのある豊かな髪を育てたい」…生薬抽出エキス、センブリエキス、グリチルリチン酸2K、キャピキシル配合で頭皮環境を根本改善する楽天売れ筋スカルプエッセンス5選を徹底検証！',
    items: [
      { id: 'art-scalp-chap-up-scalp-lotion', keyword: 'チャップアップ 育毛ローション', label: '天然成分と有効成分を高濃度配合し男女問わず圧倒的支持を集める育毛剤の王者' },
      { id: 'art-scalp-scalp-d-beaute-medicated', keyword: 'スカルプD ボーテ 薬用スカルプセラム', label: '女性特有の頭皮環境に着目しソイセラム配合でふんわり豊かな美髪へ導く' },
      { id: 'art-scalp-wakasugi-scalp-essence', keyword: 'ニューモ 育毛剤', label: '独自成分HGP配合でSNSや口コミで爆発的ヒットを記録した国民的スカルプケア' },
      { id: 'art-scalp-john-masters-scalp-serum', keyword: 'ジョンマスターオーガニック スカルプセラム', label: 'オーガニックハーブと清涼感で頭皮を引き締め健やかな髪を育てる名品' },
      { id: 'art-scalp-shiseido-adenovital-advanced', keyword: 'アデノバイタル スカルプエッセンス', label: '資生堂独自の生体関連成分アデノシン配合で根本から毛髪を太く強くする' }
    ]
  },
  // 特集②：【極上リップスリーピングマスク＆ぷるぷる夜パック】寝ている間に濃密ラッピング！翌朝生まれたての唇を作る「神リップスリーピングマスク」5選
  {
    featureId: 'feature-5-lip-sleeping-mask-overnight',
    title: '【2026年最新・楽天最安値】【極上リップスリーピングマスク＆ぷるぷる夜パック】寝ている間に濃密ラッピング！翌朝生まれたての唇を作る「神リップスリーピングマスク」5選',
    category: 'skincare',
    categoryLabel: '💋 【神リップ夜マスク5選】オーバーナイト濃密密閉特集',
    introText: '「朝起きると唇がカサカサで皮が剥けている」「口紅を塗る前にリップ下地が必要ないくらいぷるんとした土台を作りたい」…ベリーフルーツコンプレックス、ビタミンC、シアバター配合で寝ている間に古い角質を溶かしふっくら唇へ導く楽天大人気リップスリーピングマスク5選を徹底解説！',
    items: [
      { id: 'art-lipmask-laneige-lip-sleeping-mask', keyword: 'ラネージュ リップスリーピングマスク ベリー', label: '世界中で大バズ！寝ている間に角質を優しくケアし翌朝ぷるぷるにする絶対女王' },
      { id: 'art-lipmask-cnp-laboratory-lipcerin', keyword: 'CNP リップセリン', label: '密閉型エアレス容器でいつでも衛生的！高保湿プロポリス配合の話題作' },
      { id: 'art-lipmask-torriden-solid-in-lip', keyword: 'トリデン ソリッドイン リップエッセンス', label: '5D複合セラミド配合でひび割れた唇を集中保湿する韓国オリーブヤング1位' },
      { id: 'art-lipmask-tatcha-kissu-lip-mask', keyword: 'リップ マスク 保湿', label: '贅沢な植物エキスとシルク成分でふっくら滑らかな唇に整える高級ケア' },
      { id: 'art-lipmask-vaseline-lip-therapy-rosy', keyword: 'ヴァセリン リップ セラピー', label: '高純度ワセリンが唇を包み込み乾燥ダメージから徹底防御する王道ケア' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による「74大達成・最新5選まとめ特集記事」作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_OLYMPUS_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに根元からのふんわり立ち上がりや翌朝のふっくら唇を実感できる高機能設計`,
          `毎日のスカルプケアやナイトリップ習慣に無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
  ...
  console.log(`\n🎉 楽天API直接取得による「74大達成・最新5選まとめ特集記事」および個別商品記事の完全追加が完了しました！`);
}
