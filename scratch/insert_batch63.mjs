...
const batch63 = [
  JSON.parse(fs.readFileSync('scratch/batch63_art1.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch63_art2.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch63_art3.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch63_art4.json', 'utf8'))
];

for (const art of batch63) {
