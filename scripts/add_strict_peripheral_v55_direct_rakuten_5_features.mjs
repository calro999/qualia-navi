...
// ① クエリ：涙袋アイシャドウ スティック ぷっくり 涙袋ペン ハイライト 韓国コスメ, グリッター スティック（パウダーの粉飛びやラメ落ちを防ぎ、しっとり高密着な繰り出しスティックでひと塗りで自然な立体感とぷっくり涙袋を作る涙袋専用シャドウスティック）
// ② クエリ：頭皮用美容液 スカルプエッセンス 頭皮 保湿 フケ かゆみ スカルプセラム, 頭皮 美容液（頭皮の乾燥・フケ・かゆみ・加齢による頭皮の硬直を防ぎ、潤いを与えて根元からふんわり立ち上がる健康な美髪環境を育てるスカルプ専用保湿美容液）
const NEW_PERIPHERAL_V55_FEATURES = [
  {
    featureId: 'feature-5-aegyo-sal-shadow-stick-plump-shimmer',
    title: '【2026年最新・楽天最安値】【涙袋スティックアイシャドウ＆ぷっくり中顔面短縮】粉飛びゼロで一日中うるツヤ続く「神涙袋ペン」5選',
    category: 'makeup',
    categoryLabel: '✨ 【神涙袋シャドウスティック5選】ひと塗りでぷっくり立体感特集',
    introText: '「パウダーシャドウだと夕方にラメが落ちてシワっぽくなる」「涙袋の影色とのバランスが難しい」…クリーミースティック処方、高密着ウォータープルーフ、繊細パール＆シマーラメ配合でひと塗りで自然なぷっくり涙袋と中顔面短縮を叶える楽天売れ筋涙袋スティック5選を徹底検証！',
    items: [
      { id: 'art-aegyostick-twotoned-plump-shadow-pen', keyword: '涙袋 スティック', label: '涙袋メイクの絶対的人気！クリーミーな密着感で粉飛びせず一日中うるツヤ' },
      { id: 'art-aegyostick-etude-bliss-shimmer-stick-star', keyword: 'エチュード キラキラ アイシャドウ', label: '韓国コスメのロングセラー！繊細なパール感で自然な立体涙袋を演出' },
      { id: 'art-aegyostick-bbia-last-auto-gel-liner-shadow', keyword: 'ピアー 涙袋', label: '絶妙なコンシーラー＆ハイライトカラー！元から涙袋があるような仕上がり' },
      { id: 'art-aegyostick-canmake-plump-glitter-stick-shine', keyword: '涙袋 アイシャドウ スティック', label: 'プチプラ界の神アイテム！微細ラメが目元に濡れたようなツヤをプラス' },
      { id: 'art-aegyostick-clio-prism-highlighter-shadow-stick', keyword: '涙袋 スティック ハイライト', label: '高発色＆高密着！汗・皮脂にも負けずヨレない密着スティック' }
    ]
  },
  {
    featureId: 'feature-5-scalp-essence-serum-moisture-soothing',
    title: '【2026年最新・楽天最安値】【頭皮用美容液＆スカルプ保湿セラム】フケ・かゆみ・乾燥を防ぎ根本ふんわり美髪を育む「神スカルプローション」5選',
    category: 'haircare',
    categoryLabel: '🌿 【神スカルプ美容液5選】頭皮乾燥・フケかゆみ防止＆根本ふんわり特集',
    introText: '「頭皮の乾燥やかゆみ、季節の変わり目のフケが気になる」「分け目のボリュームが出なくなってきた」…ヒアルロン酸・セラミド高保湿処方、植物性抗炎症エキス、ベタつかず頭皮にスーッと馴染むノズル設計で健やかな頭皮環境を育てる楽天売れ筋スカルプエッセンス5選を徹底解説！',
    items: [
      { id: 'art-scalpserum-etvos-scalp-care-serum-botanical', keyword: 'エトヴォス 頭皮 美容液', label: 'スカルプセラムの絶対的人気！植物エキスとセラミドで頭皮の潤いバリアを整える' },
      { id: 'art-scalpserum-wacosme-medicated-scalp-lotion', keyword: '頭皮用美容液 スカルプ', label: '薬用有効成分配合！フケやかゆみを抑えて清潔で健やかな頭皮環境へ' },
      { id: 'art-scalpserum-botanist-botanical-scalp-essence', keyword: 'ボタニスト スカルプエッセンス', label: '爽やかなハーブの香り！硬くなった頭皮をほぐして潤いチャージ' },
      { id: 'art-scalpserum-curel-scalp-moisture-lotion-ceramide', keyword: 'キュレル 頭皮保湿ローション', label: '敏感肌用セラミドケア！ダイレクトタッチノズルで乾燥頭皮をしっとり保湿' },
      { id: 'art-scalpserum-aveda-pramasana-scalp-concentrate', keyword: '頭皮 美容液 保湿', label: 'サロンクオリティ！根本から立ち上がるハリ・コシのある美髪をサポート' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第55弾【純粋コスメ＆涙袋スティック・頭皮美容液特化】）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V55_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに涙袋スティックによるぷっくり立体感・中顔面短縮や頭皮美容液によるフケ・かゆみ防止としっとり保湿を実感できる高機能設計`,
          `毎朝のアイメイクや毎晩のドライヤー前スカルプケアルーティンに無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアアイゾーン＆スカルプケアアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第55弾【純粋コスメ＆涙袋スティック・頭皮美容液特化】特集記事および個別商品記事の完全追加が完了しました！`);
}
