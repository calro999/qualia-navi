...
async function main() {
  await fetchG("g1", "飲む日焼け止め サプリ UV", "scratch/rakuten_batch118_g1_verified.json");
  await sleep(1500);
  await fetchG("g2", "ジオーディナリー カフェイン アイセラム 目元 美容液", "scratch/rakuten_batch118_g2_verified.json");
}
