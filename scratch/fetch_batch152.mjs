...
async function main() {
  ...
  fs.writeFileSync('scratch/batch152_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 152 products saved successfully to scratch/batch152_fetched.json!');
}
