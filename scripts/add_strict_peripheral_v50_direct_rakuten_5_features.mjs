...
// ① クエリ：部分用ビューラー ミニアイラッシュカーラー 目尻用 ビューラー 下まつ毛, 資生堂 ミニアイラッシュカーラー（通常のビューラーでは挟めない目尻・目頭の短いまつ毛や下まつ毛をピンポイントで直角カールアップさせる専用部分用ビューラー）
// ② クエリ：CICA パッチ ニキビパッチ 鎮静 目立たない スキンケア パッチ, VT CICA スポットパッチ（突然できた赤みポツポツやニキビの悪化・摩擦を防ぎ、CICAツボクサエキスで密着鎮静しながら上からメイクもできる透明スポットパッチ）
const NEW_PERIPHERAL_V50_FEATURES = [
  {
    featureId: 'feature-5-mini-point-eyelash-curler-detail',
    title: '【2026年最新・楽天最安値】【部分用ミニビューラー＆目尻・下まつ毛直角上げ】短いまつ毛も逃さずキャッチする「神ポイントカーラー」5選',
    category: 'makeup',
    categoryLabel: '👁️ 【神部分用ビューラー5選】目尻・目頭＆下まつ毛ピンポイント特集',
    introText: '「通常のビューラーやまぶたのカーブが合わず目尻のまつ毛が上がらない」「下まつ毛を綺麗に下向きカールさせたい」…幅狭フラットフレーム、高弾力シリコンゴム、目頭・目尻・下まつ毛を1ミリ単位で狙い撃ちできる楽天売れ筋部分用ビューラー5選を徹底検証！',
    items: [
      { id: 'art-pointcurler-shiseido-mini-eyelash-curler-215', keyword: '資生堂 ミニアイラッシュカーラー 215', label: '部分用カーラーの絶対王者！目尻の流し目カールや下まつ毛も自在' },
      { id: 'art-pointcurler-shu-uemura-s-curler-point', keyword: 'シュウウエムラ Sカーラー', label: 'サイドバーフリー構造！まぶたを挟まずどんな目の形にもフィットする名品' },
      { id: 'art-pointcurler-chasty-nature-point-lash-curler', keyword: 'チャスティ 部分用カーラー', label: 'プチプラ界の実力派！小回りが利くコンパクト設計で下まつ毛に最適' },
      { id: 'art-pointcurler-koji-curving-eyelash-curler-point', keyword: '部分用 ビューラー 下まつ毛', label: '弾力シリコンゴム採用！根元から折れずに自然な立ち上がりを実現' },
      { id: 'art-pointcurler-eyelash-curler-mini-narrow-frame', keyword: 'ミニ アイラッシュカーラー', label: '携帯性抜群！ポーチに入れてメイク直しでも目尻の毛先を即時復活' }
    ]
  },
  {
    featureId: 'feature-5-cica-acne-spot-patch-invisible',
    title: '【2026年最新・楽天最安値】【CICAスポットパッチ＆ポツポツ集中鎮静】貼ったままメイクできる「神ニキビ・肌荒れパッチ」5選',
    category: 'skincare',
    categoryLabel: '🌿 【神CICAスポットパッチ5選】密着鎮静＆目立たない透明パッチ特集',
    introText: '「大事な日の前に突然赤みポツポツができてしまった」「メイクやマスクの摩擦でニキビを悪化させたくない」…ハイドロコロイド素材、高純度CICAツボクサエキス、極薄ベベル加工で上からファンデを塗ってもバレない楽天売れ筋スポットパッチ5選を徹底解説！',
    items: [
      { id: 'art-cicapatch-vt-cica-spot-patch-clear', keyword: 'VT CICA スポットパッチ', label: 'CICAパッチの絶対的人気！ハイドロコロイドで外部刺激を遮断し集中鎮静' },
      { id: 'art-cicapatch-cosrx-ac-collection-acne-pimple-master', keyword: 'COSRX ニキビパッチ', label: '韓国オリーブヤング殿堂入り！滲出物をしっかり吸着して速攻ケア' },
      { id: 'art-cicapatch-acropass-trouble-cure-micro-needle', keyword: 'ニキビパッチ マイクロニードル', label: '微細ニードル技術！ヒアルロン酸と鎮静成分を直接角質層へ届ける' },
      { id: 'art-cicapatch-some-by-mi-clear-spot-patch-tea-tree', keyword: 'ティーツリー ニキビパッチ', label: 'ティーツリー×CICA配合！赤みを抑えて目立たせず清潔に保護' },
      { id: 'art-cicapatch-invisible-hydrocolloid-blemish-cover', keyword: 'CICA パッチ ニキビ', label: '極薄0.1ミリ設計！上からファンデを重ねても境目が目立たない' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第50弾【純粋コスメ＆部分用ビューラー・CICAパッチ特化】）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V50_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに目尻・下まつ毛の直角カールアップやCICAスポットパッチによるポツポツの密着鎮静・メイク併用を実感できる高機能設計`,
          `毎朝のアイメイクや突然の肌トラブル時のお手入れに無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'アイカーラー＆スポットケアアナリスト',
        summaryKeyPoints: [
        ...
        faqs: [
          {
            ...
            answer: `はい、毎日の習慣または肌トラブル時に安心してお使いいただける安全性の高い設計となっております。`
          }
        ]
      };
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアアイツール＆スキントラブルアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第50弾【純粋コスメ＆部分用ビューラー・CICAパッチ特化】特集記事および個別商品記事の完全追加が完了しました！`);
}
