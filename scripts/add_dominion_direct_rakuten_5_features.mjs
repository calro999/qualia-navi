...
const NEW_DOMINION_FEATURES = [
  // 特集①：【美肌シェーバー＆産毛・眉毛トリマー】メイクノリ劇的向上！肌を傷つけず透明感を底上げする「神フェイスシェーバー」5選
  {
    featureId: 'feature-5-facial-shave-trimmer-skin-radiance',
    title: '【2026年最新・楽天最安値】【美肌シェーバー＆産毛・眉毛トリマー】メイクノリ劇的向上！肌を傷つけず透明感を底上げする「神フェイスシェーバー」5選',
    category: 'device',
    categoryLabel: '⚡ 【神フェイスシェーバー5選】顔の産毛＆眉毛処理特集',
    introText: '「ファンデーションが均一に密着しない」「顔の産毛やくすみをケアしてワントーン明るい肌を作りたい」…肌に優しい丸い刃先、眉用コーム付き、USB充電式で安全にサロン級のシェービングができる楽天売れ筋フェイスシェーバー5選を徹底検証！',
    items: [
      { id: 'art-trim-panasonic-ferie-face', keyword: 'パナソニック フェリエ フェイス用', label: '丸い刃先で肌を傷つけずに産毛を根元からカットする国民的大定番' },
      { id: 'art-trim-panasonic-ferie-body', keyword: 'パナソニック フェリエ ボディ用', label: '全身の太い毛から細かい産毛まで滑らかに剃れる防水ボディシェーバー' },
      { id: 'art-trim-salonia-facial-shaver', keyword: 'サロニア フェイスシェーバー', label: 'コンパクトなスティック型で外出先でもサッと産毛ケアができるスタイリッシュ機' },
      { id: 'art-trim-tescom-face-trimmer', keyword: 'テスコム フェイスシェーバー', label: '眉メイク用コーム付属で眉の長さ調節まで完璧に仕上がる高コスパシェーバー' },
      { id: 'art-trim-koizumi-face-shaver', keyword: 'コイズミ フェイスシェーバー', label: 'LEDライト付きで見えにくい細かい産毛まで逃さずキャッチ' }
    ]
  },
  // 特集②：【極上ナイトリペアヘアキャップ＆シルク枕カバー】摩擦ダメージ・寝癖・アホ毛を防ぐ「美髪シルクヘアケア」5選
  {
    featureId: 'feature-5-silk-night-cap-hair-protection',
    title: '【2026年最新・楽天最安値】【極上ナイトリペアヘアキャップ＆シルク枕カバー】摩擦ダメージ・寝癖・アホ毛を防ぐ「美髪シルクヘアケア」5選',
    category: 'haircare',
    categoryLabel: '🌙 【美髪シルクケア5選】摩擦レス睡眠美髪特集',
    introText: '「朝起きると髪がボサボサに広がってアホ毛が目立つ」「睡眠中の枕との摩擦ダメージから髪を守りたい」…天然シルク100%、6Aランク高密度シルクで寝ている間の髪の水分蒸発と摩擦をゼロにする楽天大人気シルクナイトケア5選を徹底解説！',
    items: [
      { id: 'art-silk-itawari-night-cap', keyword: 'シルク ナイトキャップ 絹', label: '天然シルク100%で朝起きた時の髪のパサつきと寝癖を根本リセット' },
      { id: 'art-silk-pillow-case-mulberry', keyword: 'シルク 枕カバー 100%', label: '髪と肌の両方を摩擦レスで優しく包み込む最高級6Aランクシルク枕カバー' },
      { id: 'art-silk-hair-towel-quick-dry', keyword: 'ヘアドライタオル マイクロファイバー', label: '摩擦を極限まで減らし吸水スピードを5倍に高める神ヘアドライタオル' },
      { id: 'art-silk-hair-scrunchie-silk', keyword: 'シルク シュシュ 跡がつかない', label: 'シルク100%素材で結び跡がつかず摩擦による切れ毛を防ぐ美髪シュシュ' },
      { id: 'art-silk-honoka-silk-turban', keyword: 'シルク ヘアバンド', label: 'スキンケア時やリラックス時に髪に負担をかけずふんわりホールドするターバン' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による「54大達成・最新5選まとめ特集記事」作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_DOMINION_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに肌の透明感向上や朝のシルクのような指通りを実感できる高機能設計`,
          `毎日の身だしなみやヘアケア習慣に無理なく組み込める快適な使用感・高い満足度`,
...
2. **肌や髪への優しさと持続性**: デリケートな状態でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'フェイスシェーバー＆ヘアケアアナリスト',
        summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得による「54大達成・最新5選まとめ特集記事」および個別商品記事の完全追加が完了しました！`);
}
