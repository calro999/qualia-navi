...
// ① クエリ：マスカラリムーバー まつ毛リムーバー ヒロインメイク スル落ち, マスカラ専用リムーバー（ウォータープルーフの強力マスカラを擦らず塗るだけで10秒で溶かしてまつ毛抜けを防ぐマスカラ専用リムーバー）
// ② クエリ：眉毛美容液 まゆげ美容液 眉毛 育毛 薄眉 まゆ育, 眉毛 伸ばす（抜きすぎ・剃りすぎで生えてこなくなった薄眉や眉尻をキャピキシルやペプチドで濃密ケアする眉毛専用育毛セラム）
const NEW_PERIPHERAL_V36_FEATURES = [
  {
    featureId: 'feature-5-mascara-remover-gentle-melt',
    title: '【2026年最新・楽天最安値】【マスカラ専用リムーバー＆まつ毛抜け防止】WP強力マスカラも擦らず10秒で溶かす「神まつ毛リムーバー」5選',
    category: 'skincare',
    categoryLabel: '👁️ 【神マスカラリムーバー5選】WPマスカラ秒速オフ＆まつ毛保護特集',
    introText: '「強力なウォータープルーフマスカラを落とす時にまつ毛が抜ける・切れる」「目の周りを擦ってシワや色素沈着になるのが怖い」…コーム型アプリケーター、植物性クレンジングオイル、まつ毛トリートメント成分配合で塗って10秒置くだけでスルリと落ちる楽天売れ筋マスカラ専用リムーバー5選を徹底検証！',
    items: [
      { id: 'art-mascrem-heroine-make-speedy-mascara-remover', keyword: 'ヒロインメイク マスカラリムーバー', label: 'マスカラリムーバーの絶対王者！どんな強力マスカラも塗るだけで瞬時に溶かす名品' },
      { id: 'art-mascrem-canmake-quick-lash-curler-remover', keyword: 'キャンメイク クイックラッシュカーラーリムーバー', label: 'プチプラ界の神アイテム！落ちにくい強力カールマスカラも綺麗にオフ' },
      { id: 'art-mascrem-fasio-easy-mascara-remover', keyword: 'ファシオ マスカラ リムーバー', label: '耐久コスメのファシオ発！目にしみずまつ毛をいたわりながら落とすコーム設計' },
      { id: 'art-mascrem-cezanne-mascara-remover', keyword: 'セザンヌ マスカラリムーバー', label: '高コスパ＆美容液成分配合！まつ毛の潤いを守りながらスルリとオフ' },
      { id: 'art-mascrem-kissme-speedy-mascara-cleaner', keyword: 'まつげ リムーバー コーム', label: '頑固なフィルムタイプも油性マスカラも一掃！根元から毛先まで均一に塗れる専用コーム' }
    ]
  },
  {
    featureId: 'feature-5-eyebrow-growth-serum-thickening',
    title: '【2026年最新・楽天最安値】【眉毛専用美容液＆薄眉・すっぴん美眉育成】抜きすぎ・剃りすぎ眉を濃密フサフサに導く「神まゆ育セラム」5選',
    category: 'skincare',
    categoryLabel: '✨ 【神眉毛美容液5選】薄眉フサフサ育成＆すっぴん美眉特集',
    introText: '「昔抜きすぎて眉尻が生えてこなくなった」「すっぴんだと眉毛が薄くて恥ずかしい」…キャピキシル、ワイドラッシュ、ペプチド複合体、パンテノール配合で眉毛の毛根環境を整えハリ・コシ・密度のある自眉を育てる楽天売れ筋眉毛専用美容液5選を徹底解説！',
    items: [
      { id: 'art-browserum-rapidbrow-eyebrow-enhancing-serum', keyword: 'ラピッドブロウ 眉毛美容液', label: '世界基準の眉毛専用美容液！独自のヘクサテイン複合体でハリ・密度の自眉を育てる' },
      { id: 'art-browserum-scalp-d-beaute-pure-eyebrow-serum', keyword: 'スカルプD 眉毛美容液', label: '頭髪研究の結晶！薄眉・まばら眉の毛周期を整えて濃密美眉へ導く大定番' },
      { id: 'art-browserum-gr-brow-mayu-care-essence', keyword: '眉毛 美容液 育毛', label: 'チップとブラシの2WAY！眉肌と毛根へピンポイントに栄養を届ける高浸透処方' },
      { id: 'art-browserum-organic-botanical-eyebrow-oil', keyword: 'まゆげ美容液 キャピキシル', label: '高濃度キャピキシル配合！抜け毛を防ぎながら太く強い眉毛をサポート' },
      { id: 'art-browserum-night-intensive-eyebrow-care', keyword: '眉毛 伸ばす 美容液', label: '就寝前の集中ケア！毛根の休止期を短縮し自眉のボリュームアップを叶える' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信（フォールバック一切禁止・周辺クエリ第36弾【純粋コスメ＆メイク・スキンケア限定】）を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_PERIPHERAL_V36_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに強力マスカラの擦らず秒速オフや眉毛美容液による自眉のハリ・コシ・密度アップを実感できる高機能設計`,
          `毎日のクレンジングルーティンや就寝前スキンケアに無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'アイメイクオフ＆アイブロウ育成アナリスト',
        summaryKeyPoints: [
    ...
    const featureArticle = {
      ...
      reviewerRole: 'シニアアイラッシュ＆アイブロウケアアナリスト',
      summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得（フォールバック一切禁止）による周辺クエリ第36弾【純粋コスメ＆美容液特化】特集記事および個別商品記事の完全追加が完了しました！`);
}
