...
const queries = {
  t1: 'コメドプッシャー ニキビ 針 角栓 ピンセット 毛穴',
  t2: 'メイクブラシスタンド ポーチ 自立 立てて使える',
  t3: 'シリコンマスク パック ラップ シートマスク カバー',
  t4: 'ネイル オフ クリップ ソークオフ リムーバー'
};
...
async function main() {
  ...
  fs.writeFileSync('scratch/batch141_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 141 products saved successfully to scratch/batch141_fetched.json!');
}
