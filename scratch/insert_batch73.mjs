...
const art1 = JSON.parse(fs.readFileSync('scratch/batch73_art1.json'));
const art2 = JSON.parse(fs.readFileSync('scratch/batch73_art2.json'));
const art3 = JSON.parse(fs.readFileSync('scratch/batch73_art3.json'));
const art4 = JSON.parse(fs.readFileSync('scratch/batch73_art4.json'));
...
console.log(`articles.json and all.txt updated successfully with Batch 73!`);
