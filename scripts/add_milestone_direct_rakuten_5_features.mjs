...
const NEW_MILESTONE_FEATURES = [
  // 特集①：【香水＆モテフレグランス】すれ違いざまに褒められる！清潔感と大人の色気をまとう「至高のモテ香水」5選
  {
    featureId: 'feature-5-perfume-fragrance-love',
    title: '【2026年最新・楽天最安値】【香水＆モテフレグランス】すれ違いざまに褒められる！清潔感と大人の色気をまとう「至高のモテ香水」5選',
    category: 'bodycare',
    categoryLabel: '🌸 【至高のモテ香水5選】フレグランス特集',
    introText: '「嫌味のない万人ウケする石鹸や紅茶の香りをまといたい」「すれ違った瞬間に『良い香り』と絶対に褒められるモテ香水が欲しい」…清潔感、透明感、大人の上品さを兼ね備え、楽天市場で爆発的人気を誇る殿堂入りフレグランス5選を徹底検証！',
    items: [
      { id: 'art-perfume-shiro-savon', keyword: 'SHIRO サボン オードパルファン', label: 'みずみずしいフルーツと清潔な石けんが香る万人ウケの王道' },
      { id: 'art-perfume-jomalone-english-pear', keyword: 'ジョーマローン イングリッシュペアー', label: '熟した洋梨と白いフリージアの上品でラグジュアリーな英国アロマ' },
      { id: 'art-perfume-maison-margiela-lazy', keyword: 'メゾンマルジェラ レイジーサンデーモーニング', label: '洗い立てのやわらかなリネンシーツに包まれる清潔感フレグランス' },
      { id: 'art-perfume-chanel-chance-eau-tendre', keyword: 'シャネル チャンス オータンドゥル', label: '優美で華やかなフローラルフルーティーの気品あるモテ香水' },
      { id: 'art-perfume-dior-miss-dior-blooming', keyword: 'ミスディオール ブルーミングブーケ', label: 'ピオニーとローズの花束を抱きしめたような可憐でエレガントな香り' }
    ]
  },
  // 特集②：【ネイル＆ハンド集中ケア】ガサガサ指先・二枚爪・甘皮の乾燥を一撃リセットする「極上ネイル＆ハンドケア」5選
  {
    featureId: 'feature-5-nail-hand-intensive-care',
    title: '【2026年最新・楽天最安値】【ネイル＆ハンド集中ケア】ガサガサ指先・二枚爪・甘皮の乾燥を一撃リセットする「極上ネイル＆ハンドケア」5選',
    category: 'bodycare',
    categoryLabel: '💅 【ネイル＆ハンド5選】指先集中ケア特集',
    introText: '「手洗いやアルコール消毒で指先がカサカサになる」「二枚爪や甘皮のささくれをキレイに整えたい」…高保湿ネイルオイル、シアバター高配合ハンドクリーム、爪補修セラムで、サロン帰りのような美しい手元を作る楽天売れ筋ネイル＆ハンドケア5選を徹底解説！',
    items: [
      { id: 'art-nail-uka-nail-oil', keyword: 'uka ネイルオイル', label: 'ロールオンタイプで手軽にツボ押し＆濃厚保湿できる神オイル' },
      { id: 'art-nail-loccitane-shea-hand', keyword: 'ロクシタン シア ハンドクリーム 150ml', label: 'シアバター20%配合で手肌をしっとり保護する世界的大ベストセラー' },
      { id: 'art-nail-dr-nail-deep-serum', keyword: 'ドクターネイル ディープセラム', label: '爪の内部まで直接浸透し割れ爪・二枚爪を根本補修する浸透美容液' },
      { id: 'art-nail-opi-pro-spa-oil', keyword: 'OPI プロスパ ネイル&キューティクルオイル', label: 'プロのネイリスト愛用率NO.1！甘皮とハイポニキウムに潤い補給' },
      { id: 'art-nail-aesop-resurrection-hand', keyword: 'イソップ レスレクション ハンドバーム', label: 'マンダリンやハーブの極上アロマでべたつかず手肌を包み込むバーム' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による「30大達成記念・最新5選まとめ特集記事」作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_MILESTONE_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに上質な香りや美しい手元の変化を実感できる高機能設計`,
          `毎日の身だしなみやセルフケア習慣に無理なく組み込める快適な使用感・高い満足度`,
          `楽天市場のポイント高還元を活用することで実質最安値での継続が可能`
        ],
        cons: [
          `大人気アイテムのためセール期やキャンペーン時には一時的に欠品する場合がある`,
          `効果を最大化するために推奨された正しい使用・保管手順を守ることが推奨される`
        ],
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'フレグランス＆ネイルケアアナリスト',
        summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得による「30大達成記念・最新5選まとめ特集記事」および個別商品記事の完全追加が完了しました！`);
}
