...
const batch65 = [
  JSON.parse(fs.readFileSync('scratch/batch65_art1.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch65_art2.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch65_art3.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch65_art4.json', 'utf8'))
];

for (const art of batch65) {
