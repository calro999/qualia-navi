...
const NEW_RAGNAROK_FEATURES = [
  // 特集①：【美肌クレンジングウォーター＆ふき取りメイク落とし】帰宅後サッとひと拭き！保湿＆毛穴オフを両立する「神クレンジングウォーター」5選
  {
    featureId: 'feature-5-cleansing-water-micellar',
    title: '【2026年最新・楽天最安値】【美肌クレンジングウォーター＆ふき取りメイク落とし】帰宅後サッとひと拭き！保湿＆毛穴オフを両立する「神クレンジングウォーター」5選',
    category: 'skincare',
    categoryLabel: '🫧 【神クレンジングウォーター5選】ミセラーふき取り特集',
    introText: '「疲れて帰ってきた夜、洗面所に行かずにベッドの上でメイクを落としたい」「朝の洗顔代わりに使って古い角質と皮脂を優しくオフしたい」…ミセラテクノロジー、高純度アミノ酸、保湿美容液成分配合で擦らずスッキリ落とす楽天売れ筋クレンジングウォーター5選を徹底検証！',
    items: [
      { id: 'art-water-bioderma-sensibio-h2o', keyword: 'ビオデルマ サンシビオ H2O', label: '世界中で愛される低刺激ミセラーウォーター！敏感肌でも潤いを守る絶対王者' },
      { id: 'art-water-bifesta-micellar-water', keyword: 'ビフェスタ ミセラークレンジングウォーター', label: 'メイク落としから化粧水までこれ1本！うる落ち水クレンジングの大定番' },
      { id: 'art-water-garnier-micellar-cleansing', keyword: 'ガルニエ ミセラー クレンジングウォーター', label: '皮脂やウォータープルーフも磁石のように吸着オフする大容量神コスパ' },
      { id: 'art-water-la-roche-posay-micellar', keyword: 'ラロッシュポゼ ミセラークレンジングウォーター', label: 'ターマルウォーター配合で肌のバリア機能を整えながら優しくメイクオフ' },
      { id: 'art-water-d-program-micellar-cleanse', keyword: 'dプログラム エッセンスイン クレンジングウォーター', label: '薬用有効成分配合で肌荒れを防ぎながら毛穴汚れをオフする敏感肌用' }
    ]
  },
  // 特集②：【極上まつ毛コーティング＆束感マスカラ下地】サロン級の韓国風アイドル束感まつ毛を作る「神マスカラ下地＆コーティング美容液」5選
  {
    featureId: 'feature-5-mascara-base-lash-coating',
    title: '【2026年最新・楽天最安値】【極上まつ毛コーティング＆束感マスカラ下地】サロン級の韓国風アイドル束感まつ毛を作る「神マスカラ下地＆コーティング美容液」5選',
    category: 'makeup',
    categoryLabel: '👁️ 【神束感まつ毛下地5選】アイドル級束感カール特集',
    introText: '「韓国アイドルのようなピンセットで作ったような束感まつ毛を簡単に再現したい」「雨の日でも絶対にカールが落ちない下地が欲しい」…強力カールキープワックス、束感用コーム、まつ毛補修ペプチド配合で一日中上向き束感をロックする楽天大人気マスカラ下地5選を徹底解説！',
    items: [
      { id: 'art-base-ettusais-eye-edition-base', keyword: 'エテュセ アイエディション マスカラベース', label: '黒い繊維入りで自然にロング＆カールキープする国民的バズ下地' },
      { id: 'art-base-cezanne-durable-curl', keyword: 'セザンヌ 耐久カールマスカラ', label: '強力マルチプルーフ処方で夕方まで下がらない神コスパカール下地' },
      { id: 'art-base-canmake-quick-lash-curler', keyword: 'キャンメイク クイックラッシュカーラー', label: '下地・トップコート・マスカラの1本3役！圧倒的カール持続力' },
      { id: 'art-base-elegance-curling-lash-fixer', keyword: 'エレガンス カールラッシュ フィクサー', label: 'まつ毛パーマ級の美カールを一日中カチッと固定するデパコス最高峰下地' },
      { id: 'art-base-pdc-pika-pika-lash-coating', keyword: 'うそつきマスカラ ピメル', label: '透け感ブラックと絶妙な繊維量で自まつ毛が伸びたような自然な束感' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による「68大達成・最新5選まとめ特集記事」作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_RAGNAROK_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに極上のふき取り素肌感やアイドル級の束感美カールを実感できる高機能設計`,
          `毎日の時短クレンジングやアイメイク習慣に無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'クレンジングウォーター＆マスカラ下地アナリスト',
        summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得による「68大達成・最新5選まとめ特集記事」および個別商品記事の完全追加が完了しました！`);
}
