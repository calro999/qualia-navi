...
const NEW_ETERNITY_FEATURES = [
  // 特集①：【アイシャドウ＆多色パレット】捨て色なし！上品ラメ・高発色・粉飛びゼロ「神アイシャドウパレット」5選
  {
    featureId: 'feature-5-eyeshadow-palette-glamour',
    title: '【2026年最新・楽天最安値】【アイシャドウ＆多色パレット】捨て色なし！上品ラメ・高発色・粉飛びゼロ「神アイシャドウパレット」5選',
    category: 'makeup',
    categoryLabel: '✨ 【神アイシャドウ5選】多色パレット＆上品ラメ特集',
    introText: '「毎日のメイクで迷わない捨て色なしパレットが欲しい」「大人でも使いやすい上品な繊細ラメと高密着グラデーションを叶えたい」…しっとりシルキーパウダー、宝石級シマー、パーソナルカラー対応で楽天市場で大人気の神アイシャドウ5選を徹底検証！',
    items: [
      { id: 'art-shadow-suqqu-signature-color', keyword: 'SUQQU シグニチャー カラー アイズ', label: '贅沢な絹のような粉質と洗練された大人の陰影を作る最高峰パレット' },
      { id: 'art-shadow-excel-skinny-rich', keyword: 'エクセル スキニーリッチシャドウ', label: 'デパコス級のしっとり感！肌なじみ抜群のブラウン系王道プチプラ' },
      { id: 'art-shadow-clio-pro-eye-palette', keyword: 'クリオ プロアイパレット', label: 'マット・シマー・グリッターが詰まった韓国コスメの絶対的ロングセラー' },
      { id: 'art-shadow-dasique-shadow-palette', keyword: 'デイジーク シャドウパレット', label: 'ふんわりミルキーな発色と透明感あふれるグリッターが可愛いバズパレット' },
      { id: 'art-shadow-canmake-silky-souffle', keyword: 'キャンメイク シルキースフレアイズ', label: '透けるようなツヤ感とスフレのようなやわらかパウダーの神コスパシャドウ' }
    ]
  },
  // 特集②：【神シェービング＆メンズ髭剃り】カミソリ負け・青ヒゲ・肌荒れをゼロにする「極上電気シェーバー＆アフターシェーブ」5選
  {
    featureId: 'feature-5-mens-shaving-smooth-skin',
    title: '【2026年最新・楽天最安値】【神シェービング＆メンズ髭剃り】カミソリ負け・青ヒゲ・肌荒れをゼロにする「極上電気シェーバー＆アフターシェーブ」5選',
    category: 'device',
    categoryLabel: '⚡ 【神シェービング5選】メンズ美肌＆深剃り特集',
    introText: '「毎朝の髭剃りで肌が赤くヒリヒリ荒れてしまう」「濃い青ヒゲを肌に優しく根本から深剃りしたい」…音波振動テクノロジー、人工知能密着ヘッド、薬用鎮静ローションで痛みのない滑らか美肌を叶える楽天売れ筋メンズシェービング5選を徹底解説！',
    items: [
      { id: 'art-shave-braun-series-9-pro', keyword: 'ブラウン シリーズ9 Pro', label: '極限0.05mmの深剃り！音波振動と人工知能で肌を守る最高峰シェーバー' },
      { id: 'art-shave-panasonic-lamdash-pro', keyword: 'パナソニック ラムダッシュ PRO 6枚刃', label: 'リニアモーター高速駆動で濃いヒゲも一網打尽にする国産フラッグシップ' },
      { id: 'art-shave-philips-shaving-s9000', keyword: 'フィリップス シェーバー s9000', label: '回転式3眼ヘッドが肌の凹凸に追従しカミソリ負けを極限まで抑える' },
      { id: 'art-shave-gillette-proglide-power', keyword: 'ジレット プログライド エアー 電動', label: 'マイクロコーム×W潤滑ジェルスムーサーで摩擦レスな深剃りを実現' },
      { id: 'art-shave-nivea-men-after-shave', keyword: 'ニベアメン エクストラモイスチャーバーム', label: '髭剃り後のヒリつき・乾燥を防ぎうるおいを与える薬用アフターシェーブ' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による「46大達成記念・最新5選まとめ特集記事」作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_ETERNITY_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに美しいグラデーションやツルスベな肌感を実感できる高機能設計`,
          `毎日のメイクやメンズシェービング習慣に無理なく組み込める快適な使用感・高い満足度`,
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
        ...
        reviewerRole: 'アイカラー＆メンズシェービングアナリスト',
        summaryKeyPoints: [
  ...
  console.log(`\n🎉 楽天API直接取得による「46大達成記念・最新5選まとめ特集記事」および個別商品記事の完全追加が完了しました！`);
}
