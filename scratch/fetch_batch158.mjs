...
const queries = {
  t1: 'マイクロバブル シャワーヘッド 節水',
  t2: 'ウォーターピーリング 超音波 美顔器',
  t3: 'あぶらとり紙 テカリ',
  t4: 'ヘアブラシ 豚毛 天然毛'
};
...
async function main() {
  ...
  fs.writeFileSync('scratch/batch158_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 158 products saved successfully to scratch/batch158_fetched.json!');
}
