...
const batch60 = [
  JSON.parse(fs.readFileSync('scratch/batch60_art1.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch60_art2.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch60_art3.json', 'utf8')),
  JSON.parse(fs.readFileSync('scratch/batch60_art4.json', 'utf8'))
];

for (const art of batch60) {
