...
async function main() {
  await fetchG("g2", "キャビテーション 美容器 EMS ラジオ波 セルライト", "scratch/rakuten_batch115_g2_verified.json");
  await sleep(1500);
  await fetchG("g4", "PHA 美容液 ピーリング 水分 角質", "scratch/rakuten_batch115_g4_verified.json");
}
