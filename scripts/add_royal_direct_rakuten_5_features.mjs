...
const NEW_ROYAL_FEATURES = [
  // 特集①：【美白＆オーラルケア】着色汚れ・黄ばみ・口臭を撃退して清潔な白い歯を作る「ホワイトニングケア」5選
  {
    featureId: 'feature-5-oral-care-whitening',
    title: '【2026年最新・楽天最安値】【美白＆オーラルケア】着色汚れ・黄ばみ・口臭を撃退して清潔な白い歯を作る「ホワイトニングケア」5選',
    category: 'oralcare',
    categoryLabel: '🦷 【ホワイトニング5選】美白オーラルケア特集',
    introText: '「コーヒーや紅茶による歯の黄ばみが気になる」「笑顔に自信が持てる清潔感あふれる白い歯を手に入れたい」…ポリリン酸、ハイドロキシアパタイト、薬用殺菌成分で、自宅でサロン級の輝く白い歯と口臭予防を叶える楽天売れ筋ホワイトニングオーラルケア5選を徹底検証！',
    items: [
      { id: 'art-oral-apagard-premio', keyword: 'アパガード プレミオ', label: '薬用ハイドロキシアパタイトで歯のキズを修復＆白く' },
      { id: 'art-oral-nonio-plus-white', keyword: 'NONIO プラス ホワイトニング', label: '高濃度フッ素×着色汚れ浮かせて落とす美白処方' },
      { id: 'art-oral-ora2-premium', keyword: 'オーラツー プレミアム ステインクリア', label: 'ステイン（着色汚れ）をシャリッとしたシャリ感微粒子で除去' },
      { id: 'art-oral-concool-gel-coat', keyword: 'コンクール ジェルコートF', label: 'フッ素高配合＆高い殺菌力で歯周病・虫歯を徹底予防' },
      { id: 'art-oral-crest-3d-white', keyword: 'ホワイトニング 歯磨き粉', label: '頑固な着色汚れを浮かせて落とす薬用美白ハミガキ' }
    ]
  },
  // 特集②：【ボディ保湿＆フレグランス】カサつき・粉吹き・黒ずみを防ぎ上質な香りをまとう「極上ボディクリーム＆オイル」5選
  {
    featureId: 'feature-5-body-care-fragrance-moisture',
    title: '【2026年最新・楽天最安値】【ボディ保湿＆フレグランス】カサつき・粉吹き・黒ずみを防ぎ上質な香りをまとう「極上ボディクリーム＆オイル」5選',
    category: 'bodycare',
    categoryLabel: '🌸 【ボディ保湿＆香り5選】全身もっちりケア特集',
    introText: '「ひじ・ひざ・かかとのガサガサや黒ずみをケアしたい」「お風呂上がりに上質な香りに包まれながら全身もっちり潤したい」…シアバター、セラミド、ホホバオイルなど高機能保湿成分と極上のアロマフレグランスを兼ね備えた楽天大人気ボディケア5選を徹底解説！',
    items: [
      { id: 'art-body-loccitane-shea-body', keyword: 'ロクシタン スノーシア ボディクリーム', label: '雪のようにとろける高濃度シアバター濃厚保湿' },
      { id: 'art-body-sabon-body-lotion', keyword: 'サボン ボディローション デッドシー', label: '死海のミネラル×植物オイルでシルクのようなツルスベ肌' },
      { id: 'art-body-nivea-premium-body', keyword: 'ニベア プレミアムボディミルク モイスチャー', label: '高保水ヒアルロン酸配合で夕方までツヤ肌キープ' },
      { id: 'art-body-shiro-white-tea-body', keyword: 'SHIRO ホワイトティー ボディミルク', label: '上品なシトラス＆ティーの香りでみずみずしく潤う' },
      { id: 'art-body-curel-moisture-milk', keyword: 'キュレル ローション', label: 'セラミド機能成分が全身のバリア機能を高め乾燥肌を保護' }
    ]
  }
];

async function main() {
  console.log('🚀 楽天公式OpenAPI直接通信による「最新5選まとめ特集記事」作成を開始します...');

  const articlesJsonPath = path.resolve(process.cwd(), 'src/data/articles.json');
  let articles = JSON.parse(fs.readFileSync(articlesJsonPath, 'utf-8'));

  for (const feat of NEW_ROYAL_FEATURES) {
    console.log(`\n==================================================`);
    ...
    for (let i = 0; i < feat.items.length; i++) {
      ...
      const singleArticle = {
        ...
        pros: [
          `使用後すぐに口元や全身の肌に確かな変化・清潔感・潤いを実感できる高機能設計`,
          `毎日のケアや習慣に無理なく組み込める快適な使用感・心地よい香り`,
          `楽天市場のポイント高還元を活用することで実質最安値での継続が可能`
        ],
        cons: [
          `大人気アイテムのためセール期やキャンペーン時には一時的に欠品する場合がある`,
          `効果を最大化するために推奨された正しいケア手順を守ることが推奨される`
        ],
...
2. **肌や歯への優しさと持続性**: デリケートな部位でも毎日心地よく使える安心の品質管理。
...
- **安心の正規品保証**: 信頼できる認証ショップからの購入で偽物リスクを完全回避。`,
  ...
  console.log(`\n🎉 楽天API直接取得による「最新5選まとめ特集記事」および個別商品記事の完全追加が完了しました！`);
}
