...
async function fetchMoreG4() {
  const existingFile = "scratch/rakuten_batch91_g4_verified.json";
  ...
  url.searchParams.append("keyword", "アイシャドウ パレット ピンク ラベンダー");
  url.searchParams.append("hits", "30");
  url.searchParams.append("minPrice", "800");
...
fetchMoreG4().catch(console.error);
