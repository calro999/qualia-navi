...
const queries = {
  t1: '口腔洗浄器 ジェットウォッシャー 防水',
  t2: 'デンタルフロス 糸ピックス 歯間ブラシ',
  t3: 'アイメイク テンプレート アイライン',
  t4: 'シャワーキャップ 防水 使い捨て'
};
...
async function main() {
  ...
  fs.writeFileSync('scratch/batch166_fetched.json', JSON.stringify(allResults, null, 2), 'utf-8');
  console.log('Batch 166 products saved successfully to scratch/batch166_fetched.json!');
}
